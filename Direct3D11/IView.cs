...
/// <summary>
/// INTERFACE <b>ID3D11View</b> : ID3D11DeviceChild<br/>
/// D3D11.h
/// </summary>
unsafe public interface IView : IDeviceChild {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11View::GetResource (ID3D11Resource** ppResource)</b><br/>
	/// </summary>
	/// <param name="ppResource">_Outptr_ <b>ID3D11Resource** ppResource</b></param>
	void GetResource<T0> (T0** ppResource) where T0 : unmanaged, IResource;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11View::GetResource (ID3D11Resource** ppResource)</b><br/>
	/// </summary>
	/// <param name="ppResource">_Outptr_ <b>ID3D11Resource** ppResource</b></param>
	void GetResource<T0> (out T0* ppResource) where T0 : unmanaged, IResource;
}

/// <summary>
/// Instance of <b>ID3D11View</b><br/>
/// D3D11.h
/// </summary>
unsafe public readonly struct View : IView {
//unsafe public readonly struct IViewObj : IView {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly View* GetCurrentPointer () => (View*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IViewObj* GetCurrentPointer () => (IViewObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x839d1216, 0xbb2e, 0x412b, 0xb7, 0xf4, 0xa9, 0xdb, 0xeb, 0xe0, 0x8e, 0xd1);
