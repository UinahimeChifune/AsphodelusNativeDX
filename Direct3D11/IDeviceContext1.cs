...
/// <summary>
/// INTERFACE <b>ID3D11DeviceContext1</b> : ID3D11DeviceContext<br/>
/// D3D11_1.h
/// </summary>
unsafe public interface IDeviceContext1 : IDeviceContext {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::CopySubresourceRegion1 (ID3D11Resource* pDstResource, UINT DstSubresource, UINT DstX, UINT DstY, UINT DstZ, ID3D11Resource* pSrcResource, UINT SrcSubresource, D3D11_BOX* pSrcBox, UINT CopyFlags)</b><br/>
	/// </summary>
	...
	/// <param name="copyFlags">_In_ <b>UINT CopyFlags</b></param>
	void CopySubresourceRegion1<T0, T1> (T0* pDstResource, uint dstSubresource, uint dstX, uint dstY, uint dstZ, T1* pSrcResource, uint srcSubresource, Box* pSrcBox, uint copyFlags) where T0 : unmanaged, IResource where T1 : unmanaged, IResource;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::UpdateSubresource1 (ID3D11Resource* pDstResource, UINT DstSubresource, D3D11_BOX* pDstBox, void* pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch, UINT CopyFlags)</b><br/>
	/// </summary>
	/// <param name="pDstResource">_In_ <b>ID3D11Resource* pDstResource</b></param>
	/// <param name="dstSubresource">_In_ <b>UINT DstSubresource</b></param>
	...
	/// <param name="copyFlags">_In_ <b>UINT CopyFlags</b></param>
	void UpdateSubresource1<T0> (T0* pDstResource, uint dstSubresource, Box* pDstBox, void* pSrcData, uint srcRowPitch, uint srcDepthPitch, uint copyFlags) where T0 : unmanaged, IResource;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::DiscardResource (ID3D11Resource* pResource)</b><br/>
	/// </summary>
	/// <param name="pResource">_In_ <b>ID3D11Resource* pResource</b></param>
	void DiscardResource<T0> (T0* pResource) where T0 : unmanaged, IResource;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::DiscardView (ID3D11View* pResourceView)</b><br/>
	/// </summary>
	/// <param name="pResourceView">_In_ <b>ID3D11View* pResourceView</b></param>
	void DiscardView<T0> (T0* pResourceView) where T0 : unmanaged, IView;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::VSSetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer* ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	...
	/// <param name="pFirstConstant">_In_reads_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_In_reads_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void VSSetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::HSSetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer* ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_In_reads_opt_(NumBuffers) <b>ID3D11Buffer* ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_In_reads_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_In_reads_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void HSSetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::DSSetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer* ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_In_reads_opt_(NumBuffers) <b>ID3D11Buffer* ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_In_reads_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_In_reads_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void DSSetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::GSSetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer* ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_In_reads_opt_(NumBuffers) <b>ID3D11Buffer* ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_In_reads_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_In_reads_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void GSSetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::PSSetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer* ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_In_reads_opt_(NumBuffers) <b>ID3D11Buffer* ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_In_reads_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_In_reads_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void PSSetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::CSSetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer* ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_In_reads_opt_(NumBuffers) <b>ID3D11Buffer* ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_In_reads_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_In_reads_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void CSSetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::VSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_Out_writes_opt_(NumBuffers) <b>ID3D11Buffer** ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void VSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0** ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::VSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	...
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void VSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, out T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::HSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_Out_writes_opt_(NumBuffers) <b>ID3D11Buffer** ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void HSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0** ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::HSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	...
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void HSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, out T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::DSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_Out_writes_opt_(NumBuffers) <b>ID3D11Buffer** ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void DSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0** ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::DSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	...
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void DSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, out T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::GSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_Out_writes_opt_(NumBuffers) <b>ID3D11Buffer** ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void GSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0** ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::GSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	...
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void GSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, out T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::PSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_Out_writes_opt_(NumBuffers) <b>ID3D11Buffer** ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void PSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0** ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::PSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	...
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void PSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, out T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::CSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	/// <param name="numBuffers">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - StartSlot ) <b>UINT NumBuffers</b></param>
	/// <param name="ppConstantBuffers">_Out_writes_opt_(NumBuffers) <b>ID3D11Buffer** ppConstantBuffers</b></param>
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void CSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, T0** ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::CSGetConstantBuffers1 (UINT StartSlot, UINT NumBuffers, ID3D11Buffer** ppConstantBuffers, UINT* pFirstConstant, UINT* pNumConstants)</b><br/>
	/// </summary>
	/// <param name="startSlot">_In_range_( 0, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1 ) <b>UINT StartSlot</b></param>
	...
	/// <param name="pFirstConstant">_Out_writes_opt_(NumBuffers) <b>UINT* pFirstConstant</b></param>
	/// <param name="pNumConstants">_Out_writes_opt_(NumBuffers) <b>UINT* pNumConstants</b></param>
	void CSGetConstantBuffers1<T0> (uint startSlot, uint numBuffers, out T0* ppConstantBuffers, uint* pFirstConstant, uint* pNumConstants) where T0 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::SwapDeviceContextState (ID3DDeviceContextState* pState, ID3DDeviceContextState** ppPreviousState)</b><br/>
	/// </summary>
	/// <param name="pState">_In_ <b>ID3DDeviceContextState* pState</b></param>
	/// <param name="ppPreviousState">_Outptr_opt_ <b>ID3DDeviceContextState** ppPreviousState</b></param>
	void SwapDeviceContextState<T0, T1> (T0* pState, T1** ppPreviousState) where T0 : unmanaged, Direct3D.IDeviceContextState where T1 : unmanaged, Direct3D.IDeviceContextState;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::SwapDeviceContextState (ID3DDeviceContextState* pState, ID3DDeviceContextState** ppPreviousState)</b><br/>
	/// </summary>
	/// <param name="pState">_In_ <b>ID3DDeviceContextState* pState</b></param>
	/// <param name="ppPreviousState">_Outptr_opt_ <b>ID3DDeviceContextState** ppPreviousState</b></param>
	void SwapDeviceContextState<T0, T1> (T0* pState, out T1* ppPreviousState) where T0 : unmanaged, Direct3D.IDeviceContextState where T1 : unmanaged, Direct3D.IDeviceContextState;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::ClearView (ID3D11View* pView, FLOAT [4] Color, D3D11_RECT* pRect, UINT NumRects)</b><br/>
	/// </summary>
	/// <param name="pView">_In_ <b>ID3D11View* pView</b></param>
	/// <param name="color">_In_ <b>FLOAT [4] Color</b></param>
	/// <param name="pRect">_In_reads_opt_(NumRects) <b>D3D11_RECT* pRect</b></param>
	/// <param name="numRects"><b>UINT NumRects</b></param>
	void ClearView<T0> (T0* pView, Vector4F* color, Vector4I* pRect, uint numRects) where T0 : unmanaged, IView;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext1::DiscardView1 (ID3D11View* pResourceView, D3D11_RECT* pRects, UINT NumRects)</b><br/>
	/// </summary>
	/// <param name="pResourceView">_In_ <b>ID3D11View* pResourceView</b></param>
	/// <param name="pRects">_In_reads_opt_(NumRects) <b>D3D11_RECT* pRects</b></param>
	/// <param name="numRects"><b>UINT NumRects</b></param>
	void DiscardView1<T0> (T0* pResourceView, Vector4I* pRects, uint numRects) where T0 : unmanaged, IView;
}

/// <summary>
/// Instance of <b>ID3D11DeviceContext1</b><br/>
/// D3D11_1.h
/// </summary>
...
//unsafe public readonly struct IDeviceContext1Obj : IDeviceContext1 {
	...
	static readonly Guid _guid = new (0xbb2c6faa, 0xb5fb, 0x4082, 0x8e, 0x6b, 0x38, 0x8b, 0x8c, 0xfa, 0x90, 0xe1);
