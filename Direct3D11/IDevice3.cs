...
/// <summary>
/// INTERFACE <b>ID3D11Device3</b> : ID3D11Device2<br/>
/// D3D11_3.h
/// </summary>
unsafe public interface IDevice3 : IDevice2 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateTexture2D1 (D3D11_TEXTURE2D_DESC1* pDesc1, D3D11_SUBRESOURCE_DATA* pInitialData, ID3D11Texture2D1** ppTexture2D)</b><br/>
	/// </summary>
	/// <param name="pDesc1">_In_ <b>D3D11_TEXTURE2D_DESC1* pDesc1</b></param>
	/// <param name="pInitialData">_In_reads_opt_(_Inexpressible_(pDesc1->MipLevels * pDesc1->ArraySize)) <b>D3D11_SUBRESOURCE_DATA* pInitialData</b></param>
	/// <param name="ppTexture2D">_COM_Outptr_opt_ <b>ID3D11Texture2D1** ppTexture2D</b></param>
	int CreateTexture2D1<T0> (Texture2dDesc1* pDesc1, SubresourceData* pInitialData, T0** ppTexture2D) where T0 : unmanaged, ITexture2D1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateTexture2D1 (D3D11_TEXTURE2D_DESC1* pDesc1, D3D11_SUBRESOURCE_DATA* pInitialData, ID3D11Texture2D1** ppTexture2D)</b><br/>
	/// </summary>
	/// <param name="pDesc1">_In_ <b>D3D11_TEXTURE2D_DESC1* pDesc1</b></param>
	/// <param name="pInitialData">_In_reads_opt_(_Inexpressible_(pDesc1->MipLevels * pDesc1->ArraySize)) <b>D3D11_SUBRESOURCE_DATA* pInitialData</b></param>
	/// <param name="ppTexture2D">_COM_Outptr_opt_ <b>ID3D11Texture2D1** ppTexture2D</b></param>
	int CreateTexture2D1<T0> (Texture2dDesc1* pDesc1, SubresourceData* pInitialData, out T0* ppTexture2D) where T0 : unmanaged, ITexture2D1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateTexture3D1 (D3D11_TEXTURE3D_DESC1* pDesc1, D3D11_SUBRESOURCE_DATA* pInitialData, ID3D11Texture3D1** ppTexture3D)</b><br/>
	/// </summary>
	/// <param name="pDesc1">_In_ <b>D3D11_TEXTURE3D_DESC1* pDesc1</b></param>
	/// <param name="pInitialData">_In_reads_opt_(_Inexpressible_(pDesc1->MipLevels)) <b>D3D11_SUBRESOURCE_DATA* pInitialData</b></param>
	/// <param name="ppTexture3D">_COM_Outptr_opt_ <b>ID3D11Texture3D1** ppTexture3D</b></param>
	int CreateTexture3D1<T0> (Texture3dDesc1* pDesc1, SubresourceData* pInitialData, T0** ppTexture3D) where T0 : unmanaged, ITexture3D1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateTexture3D1 (D3D11_TEXTURE3D_DESC1* pDesc1, D3D11_SUBRESOURCE_DATA* pInitialData, ID3D11Texture3D1** ppTexture3D)</b><br/>
	/// </summary>
	/// <param name="pDesc1">_In_ <b>D3D11_TEXTURE3D_DESC1* pDesc1</b></param>
	/// <param name="pInitialData">_In_reads_opt_(_Inexpressible_(pDesc1->MipLevels)) <b>D3D11_SUBRESOURCE_DATA* pInitialData</b></param>
	/// <param name="ppTexture3D">_COM_Outptr_opt_ <b>ID3D11Texture3D1** ppTexture3D</b></param>
	int CreateTexture3D1<T0> (Texture3dDesc1* pDesc1, SubresourceData* pInitialData, out T0* ppTexture3D) where T0 : unmanaged, ITexture3D1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateRasterizerState2 (D3D11_RASTERIZER_DESC2* pRasterizerDesc, ID3D11RasterizerState2** ppRasterizerState)</b><br/>
	/// </summary>
	/// <param name="pRasterizerDesc">_In_ <b>D3D11_RASTERIZER_DESC2* pRasterizerDesc</b></param>
	/// <param name="ppRasterizerState">_COM_Outptr_opt_ <b>ID3D11RasterizerState2** ppRasterizerState</b></param>
	int CreateRasterizerState2<T0> (RasterizerDesc2* pRasterizerDesc, T0** ppRasterizerState) where T0 : unmanaged, IRasterizerState2;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateRasterizerState2 (D3D11_RASTERIZER_DESC2* pRasterizerDesc, ID3D11RasterizerState2** ppRasterizerState)</b><br/>
	/// </summary>
	/// <param name="pRasterizerDesc">_In_ <b>D3D11_RASTERIZER_DESC2* pRasterizerDesc</b></param>
	/// <param name="ppRasterizerState">_COM_Outptr_opt_ <b>ID3D11RasterizerState2** ppRasterizerState</b></param>
	int CreateRasterizerState2<T0> (RasterizerDesc2* pRasterizerDesc, out T0* ppRasterizerState) where T0 : unmanaged, IRasterizerState2;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateShaderResourceView1 (ID3D11Resource* pResource, D3D11_SHADER_RESOURCE_VIEW_DESC1* pDesc1, ID3D11ShaderResourceView1** ppSRView1)</b><br/>
	/// </summary>
	/// <param name="pResource">_In_ <b>ID3D11Resource* pResource</b></param>
	/// <param name="pDesc1">_In_opt_ <b>D3D11_SHADER_RESOURCE_VIEW_DESC1* pDesc1</b></param>
	/// <param name="ppSRView1">_COM_Outptr_opt_ <b>ID3D11ShaderResourceView1** ppSRView1</b></param>
	int CreateShaderResourceView1<T0, T1> (T0* pResource, ShaderResourceViewDesc1* pDesc1, T1** ppSRView1) where T0 : unmanaged, IResource where T1 : unmanaged, IShaderResourceView1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateShaderResourceView1 (ID3D11Resource* pResource, D3D11_SHADER_RESOURCE_VIEW_DESC1* pDesc1, ID3D11ShaderResourceView1** ppSRView1)</b><br/>
	/// </summary>
	/// <param name="pResource">_In_ <b>ID3D11Resource* pResource</b></param>
	/// <param name="pDesc1">_In_opt_ <b>D3D11_SHADER_RESOURCE_VIEW_DESC1* pDesc1</b></param>
	/// <param name="ppSRView1">_COM_Outptr_opt_ <b>ID3D11ShaderResourceView1** ppSRView1</b></param>
	int CreateShaderResourceView1<T0, T1> (T0* pResource, ShaderResourceViewDesc1* pDesc1, out T1* ppSRView1) where T0 : unmanaged, IResource where T1 : unmanaged, IShaderResourceView1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateUnorderedAccessView1 (ID3D11Resource* pResource, D3D11_UNORDERED_ACCESS_VIEW_DESC1* pDesc1, ID3D11UnorderedAccessView1** ppUAView1)</b><br/>
	/// </summary>
	/// <param name="pResource">_In_ <b>ID3D11Resource* pResource</b></param>
	/// <param name="pDesc1">_In_opt_ <b>D3D11_UNORDERED_ACCESS_VIEW_DESC1* pDesc1</b></param>
	/// <param name="ppUAView1">_COM_Outptr_opt_ <b>ID3D11UnorderedAccessView1** ppUAView1</b></param>
	int CreateUnorderedAccessView1<T0, T1> (T0* pResource, UnorderedAccessViewDesc1* pDesc1, T1** ppUAView1) where T0 : unmanaged, IResource where T1 : unmanaged, IUnorderedAccessView1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateUnorderedAccessView1 (ID3D11Resource* pResource, D3D11_UNORDERED_ACCESS_VIEW_DESC1* pDesc1, ID3D11UnorderedAccessView1** ppUAView1)</b><br/>
	/// </summary>
	/// <param name="pResource">_In_ <b>ID3D11Resource* pResource</b></param>
	/// <param name="pDesc1">_In_opt_ <b>D3D11_UNORDERED_ACCESS_VIEW_DESC1* pDesc1</b></param>
	/// <param name="ppUAView1">_COM_Outptr_opt_ <b>ID3D11UnorderedAccessView1** ppUAView1</b></param>
	int CreateUnorderedAccessView1<T0, T1> (T0* pResource, UnorderedAccessViewDesc1* pDesc1, out T1* ppUAView1) where T0 : unmanaged, IResource where T1 : unmanaged, IUnorderedAccessView1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateRenderTargetView1 (ID3D11Resource* pResource, D3D11_RENDER_TARGET_VIEW_DESC1* pDesc1, ID3D11RenderTargetView1** ppRTView1)</b><br/>
	/// </summary>
	/// <param name="pResource">_In_ <b>ID3D11Resource* pResource</b></param>
	/// <param name="pDesc1">_In_opt_ <b>D3D11_RENDER_TARGET_VIEW_DESC1* pDesc1</b></param>
	/// <param name="ppRTView1">_COM_Outptr_opt_ <b>ID3D11RenderTargetView1** ppRTView1</b></param>
	int CreateRenderTargetView1<T0, T1> (T0* pResource, RenderTargetViewDesc1* pDesc1, T1** ppRTView1) where T0 : unmanaged, IResource where T1 : unmanaged, IRenderTargetView1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateRenderTargetView1 (ID3D11Resource* pResource, D3D11_RENDER_TARGET_VIEW_DESC1* pDesc1, ID3D11RenderTargetView1** ppRTView1)</b><br/>
	/// </summary>
	/// <param name="pResource">_In_ <b>ID3D11Resource* pResource</b></param>
	/// <param name="pDesc1">_In_opt_ <b>D3D11_RENDER_TARGET_VIEW_DESC1* pDesc1</b></param>
	/// <param name="ppRTView1">_COM_Outptr_opt_ <b>ID3D11RenderTargetView1** ppRTView1</b></param>
	int CreateRenderTargetView1<T0, T1> (T0* pResource, RenderTargetViewDesc1* pDesc1, out T1* ppRTView1) where T0 : unmanaged, IResource where T1 : unmanaged, IRenderTargetView1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateQuery1 (D3D11_QUERY_DESC1* pQueryDesc1, ID3D11Query1** ppQuery1)</b><br/>
	/// </summary>
	/// <param name="pQueryDesc1">_In_ <b>D3D11_QUERY_DESC1* pQueryDesc1</b></param>
	/// <param name="ppQuery1">_COM_Outptr_opt_ <b>ID3D11Query1** ppQuery1</b></param>
	int CreateQuery1<T0> (QueryDesc1* pQueryDesc1, T0** ppQuery1) where T0 : unmanaged, IQuery1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateQuery1 (D3D11_QUERY_DESC1* pQueryDesc1, ID3D11Query1** ppQuery1)</b><br/>
	/// </summary>
	/// <param name="pQueryDesc1">_In_ <b>D3D11_QUERY_DESC1* pQueryDesc1</b></param>
	/// <param name="ppQuery1">_COM_Outptr_opt_ <b>ID3D11Query1** ppQuery1</b></param>
	int CreateQuery1<T0> (QueryDesc1* pQueryDesc1, out T0* ppQuery1) where T0 : unmanaged, IQuery1;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11Device3::GetImmediateContext3 (ID3D11DeviceContext3** ppImmediateContext)</b><br/>
	/// </summary>
	/// <param name="ppImmediateContext">_Outptr_ <b>ID3D11DeviceContext3** ppImmediateContext</b></param>
	void GetImmediateContext3<T0> (T0** ppImmediateContext) where T0 : unmanaged, IDeviceContext3;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11Device3::GetImmediateContext3 (ID3D11DeviceContext3** ppImmediateContext)</b><br/>
	/// </summary>
	/// <param name="ppImmediateContext">_Outptr_ <b>ID3D11DeviceContext3** ppImmediateContext</b></param>
	void GetImmediateContext3<T0> (out T0* ppImmediateContext) where T0 : unmanaged, IDeviceContext3;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateDeferredContext3 (UINT ContextFlags, ID3D11DeviceContext3** ppDeferredContext)</b><br/>
	/// </summary>
	/// <param name="contextFlags"><b>UINT ContextFlags</b></param>
	/// <param name="ppDeferredContext">_COM_Outptr_opt_ <b>ID3D11DeviceContext3** ppDeferredContext</b></param>
	int CreateDeferredContext3<T0> (uint contextFlags, T0** ppDeferredContext) where T0 : unmanaged, IDeviceContext3;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device3::CreateDeferredContext3 (UINT ContextFlags, ID3D11DeviceContext3** ppDeferredContext)</b><br/>
	/// </summary>
	/// <param name="contextFlags"><b>UINT ContextFlags</b></param>
	/// <param name="ppDeferredContext">_COM_Outptr_opt_ <b>ID3D11DeviceContext3** ppDeferredContext</b></param>
	int CreateDeferredContext3<T0> (uint contextFlags, out T0* ppDeferredContext) where T0 : unmanaged, IDeviceContext3;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11Device3::WriteToSubresource (ID3D11Resource* pDstResource, UINT DstSubresource, D3D11_BOX* pDstBox, void* pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch)</b><br/>
	/// </summary>
	...
	void WriteToSubresource<T0> (T0* pDstResource, uint dstSubresource, Box* pDstBox, void* pSrcData, uint srcRowPitch, uint srcDepthPitch) where T0 : unmanaged, IResource;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11Device3::ReadFromSubresource (void* pDstData, UINT DstRowPitch, UINT DstDepthPitch, ID3D11Resource* pSrcResource, UINT SrcSubresource, D3D11_BOX* pSrcBox)</b><br/>
	/// </summary>
	/// <param name="pDstData">_Out_ <b>void* pDstData</b></param>
	/// <param name="dstRowPitch">_In_ <b>UINT DstRowPitch</b></param>
	/// <param name="dstDepthPitch">_In_ <b>UINT DstDepthPitch</b></param>
	...
	void ReadFromSubresource<T0> (void* pDstData, uint dstRowPitch, uint dstDepthPitch, T0* pSrcResource, uint srcSubresource, Box* pSrcBox) where T0 : unmanaged, IResource;
}

/// <summary>
/// Instance of <b>ID3D11Device3</b><br/>
/// D3D11_3.h
/// </summary>
...
//unsafe public readonly struct IDevice3Obj : IDevice3 {
	...
	static readonly Guid _guid = new (0xa05c8c37, 0xd2c6, 0x4732, 0xb3, 0xa0, 0x9c, 0xe0, 0xb0, 0xdc, 0x9a, 0xe6);
