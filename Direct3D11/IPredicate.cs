...
/// <summary>
/// INTERFACE <b>ID3D11Predicate</b> : ID3D11Query<br/>
/// D3D11.h
/// </summary>
unsafe public interface IPredicate : IQuery {
}

/// <summary>
/// Instance of <b>ID3D11Predicate</b><br/>
/// D3D11.h
/// </summary>
unsafe public readonly struct Predicate : IPredicate {
//unsafe public readonly struct IPredicateObj : IPredicate {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly Predicate* GetCurrentPointer () => (Predicate*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IPredicateObj* GetCurrentPointer () => (IPredicateObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x9eb576dd, 0x9f77, 0x4d86, 0x81, 0xaa, 0x8b, 0xab, 0x5f, 0xe4, 0x90, 0xe2);
