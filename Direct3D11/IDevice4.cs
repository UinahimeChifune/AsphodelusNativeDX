...
/// <summary>
/// INTERFACE <b>ID3D11Device4</b> : ID3D11Device3<br/>
/// D3D11_4.h
/// </summary>
unsafe public interface IDevice4 : IDevice3 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device4::RegisterDeviceRemovedEvent (HANDLE hEvent, DWORD* pdwCookie)</b><br/>
	/// </summary>
	/// <param name="hEvent">_In_ <b>HANDLE hEvent</b></param>
	/// <param name="pdwCookie">_Out_ <b>DWORD* pdwCookie</b></param>
	int RegisterDeviceRemovedEvent (IntPtr hEvent, uint* pdwCookie);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11Device4::RegisterDeviceRemovedEvent (HANDLE hEvent, DWORD* pdwCookie)</b><br/>
	/// </summary>
	/// <param name="hEvent">_In_ <b>HANDLE hEvent</b></param>
	/// <param name="pdwCookie">_Out_ <b>DWORD* pdwCookie</b></param>
	int RegisterDeviceRemovedEvent (IntPtr hEvent, out uint pdwCookie);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11Device4::UnregisterDeviceRemoved (DWORD dwCookie)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>ID3D11Device4</b><br/>
/// D3D11_4.h
/// </summary>
...
//unsafe public readonly struct IDevice4Obj : IDevice4 {
	...
	static readonly Guid _guid = new (0x8992ab71, 0x02e6, 0x4b8d, 0xba, 0x48, 0xb0, 0x56, 0xdc, 0xda, 0x42, 0xc4);
