...
/// <summary>
/// INTERFACE <b>ID3D11InfoQueue</b> : IUnknown<br/>
/// D3D11SDKLAYERS.h
/// </summary>
unsafe public interface IInfoQueue : IUnknown {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::SetMessageCountLimit (UINT64 MessageCountLimit)</b><br/>
	/// </summary>
	/// <param name="messageCountLimit">_In_ <b>UINT64 MessageCountLimit</b></param>
	int SetMessageCountLimit (ulong messageCountLimit);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11InfoQueue::ClearStoredMessages ()</b><br/>
	/// </summary>
	void ClearStoredMessages ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::GetMessage (UINT64 MessageIndex, D3D11_MESSAGE* pMessage, SIZE_T* pMessageByteLength)</b><br/>
	/// </summary>
	/// <param name="messageIndex">_In_ <b>UINT64 MessageIndex</b></param>
	/// <param name="pMessage">_Out_writes_bytes_opt_(*pMessageByteLength) <b>D3D11_MESSAGE* pMessage</b></param>
	...
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT64 ID3D11InfoQueue::GetNumMessagesAllowedByStorageFilter ()</b><br/>
	/// </summary>
	ulong GetNumMessagesAllowedByStorageFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT64 ID3D11InfoQueue::GetNumMessagesDeniedByStorageFilter ()</b><br/>
	/// </summary>
	ulong GetNumMessagesDeniedByStorageFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT64 ID3D11InfoQueue::GetNumStoredMessages ()</b><br/>
	/// </summary>
	ulong GetNumStoredMessages ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT64 ID3D11InfoQueue::GetNumStoredMessagesAllowedByRetrievalFilter ()</b><br/>
	/// </summary>
	ulong GetNumStoredMessagesAllowedByRetrievalFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT64 ID3D11InfoQueue::GetNumMessagesDiscardedByMessageCountLimit ()</b><br/>
	/// </summary>
	ulong GetNumMessagesDiscardedByMessageCountLimit ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT64 ID3D11InfoQueue::GetMessageCountLimit ()</b><br/>
	/// </summary>
	ulong GetMessageCountLimit ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::AddStorageFilterEntries (D3D11_INFO_QUEUE_FILTER* pFilter)</b><br/>
	/// </summary>
	/// <param name="pFilter">_In_ <b>D3D11_INFO_QUEUE_FILTER* pFilter</b></param>
	int AddStorageFilterEntries (InfoQueueFilter* pFilter);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::GetStorageFilter (D3D11_INFO_QUEUE_FILTER* pFilter, SIZE_T* pFilterByteLength)</b><br/>
	/// </summary>
	/// <param name="pFilter">_Out_writes_bytes_opt_(*pFilterByteLength) <b>D3D11_INFO_QUEUE_FILTER* pFilter</b></param>
	...
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11InfoQueue::ClearStorageFilter ()</b><br/>
	/// </summary>
	void ClearStorageFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::PushEmptyStorageFilter ()</b><br/>
	/// </summary>
	int PushEmptyStorageFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::PushCopyOfStorageFilter ()</b><br/>
	/// </summary>
	int PushCopyOfStorageFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::PushStorageFilter (D3D11_INFO_QUEUE_FILTER* pFilter)</b><br/>
	/// </summary>
	/// <param name="pFilter">_In_ <b>D3D11_INFO_QUEUE_FILTER* pFilter</b></param>
	int PushStorageFilter (InfoQueueFilter* pFilter);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11InfoQueue::PopStorageFilter ()</b><br/>
	/// </summary>
	void PopStorageFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT ID3D11InfoQueue::GetStorageFilterStackSize ()</b><br/>
	/// </summary>
	uint GetStorageFilterStackSize ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::AddRetrievalFilterEntries (D3D11_INFO_QUEUE_FILTER* pFilter)</b><br/>
	/// </summary>
	/// <param name="pFilter">_In_ <b>D3D11_INFO_QUEUE_FILTER* pFilter</b></param>
	int AddRetrievalFilterEntries (InfoQueueFilter* pFilter);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::GetRetrievalFilter (D3D11_INFO_QUEUE_FILTER* pFilter, SIZE_T* pFilterByteLength)</b><br/>
	/// </summary>
	/// <param name="pFilter">_Out_writes_bytes_opt_(*pFilterByteLength) <b>D3D11_INFO_QUEUE_FILTER* pFilter</b></param>
	/// <param name="pFilterByteLength">_Inout_ <b>SIZE_T* pFilterByteLength</b></param>
	int GetRetrievalFilter (InfoQueueFilter* pFilter, nuint* pFilterByteLength);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11InfoQueue::ClearRetrievalFilter ()</b><br/>
	/// </summary>
	void ClearRetrievalFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::PushEmptyRetrievalFilter ()</b><br/>
	/// </summary>
	int PushEmptyRetrievalFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::PushCopyOfRetrievalFilter ()</b><br/>
	/// </summary>
	int PushCopyOfRetrievalFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::PushRetrievalFilter (D3D11_INFO_QUEUE_FILTER* pFilter)</b><br/>
	/// </summary>
	/// <param name="pFilter">_In_ <b>D3D11_INFO_QUEUE_FILTER* pFilter</b></param>
	int PushRetrievalFilter (InfoQueueFilter* pFilter);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11InfoQueue::PopRetrievalFilter ()</b><br/>
	/// </summary>
	void PopRetrievalFilter ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT ID3D11InfoQueue::GetRetrievalFilterStackSize ()</b><br/>
	/// </summary>
	uint GetRetrievalFilterStackSize ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::AddMessage (D3D11_MESSAGE_CATEGORY Category, D3D11_MESSAGE_SEVERITY Severity, D3D11_MESSAGE_ID ID, LPCSTR pDescription)</b><br/>
	/// </summary>
	/// <param name="category">_In_ <b>D3D11_MESSAGE_CATEGORY Category</b></param>
	/// <param name="severity">_In_ <b>D3D11_MESSAGE_SEVERITY Severity</b></param>
	/// <param name="iD">_In_ <b>D3D11_MESSAGE_ID ID</b></param>
	...
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::AddApplicationMessage (D3D11_MESSAGE_SEVERITY Severity, LPCSTR pDescription)</b><br/>
	/// </summary>
	/// <param name="severity">_In_ <b>D3D11_MESSAGE_SEVERITY Severity</b></param>
	/// <param name="pDescription">_In_ <b>LPCSTR pDescription</b></param>
	int AddApplicationMessage (MessageSeverity severity, char* pDescription);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::SetBreakOnCategory (D3D11_MESSAGE_CATEGORY Category, BOOL bEnable)</b><br/>
	/// </summary>
	/// <param name="category">_In_ <b>D3D11_MESSAGE_CATEGORY Category</b></param>
	/// <param name="bEnable">_In_ <b>BOOL bEnable</b></param>
	int SetBreakOnCategory (MessageCategory category, bool bEnable);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::SetBreakOnSeverity (D3D11_MESSAGE_SEVERITY Severity, BOOL bEnable)</b><br/>
	/// </summary>
	/// <param name="severity">_In_ <b>D3D11_MESSAGE_SEVERITY Severity</b></param>
	/// <param name="bEnable">_In_ <b>BOOL bEnable</b></param>
	int SetBreakOnSeverity (MessageSeverity severity, bool bEnable);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11InfoQueue::SetBreakOnID (D3D11_MESSAGE_ID ID, BOOL bEnable)</b><br/>
	/// </summary>
	/// <param name="iD">_In_ <b>D3D11_MESSAGE_ID ID</b></param>
	/// <param name="bEnable">_In_ <b>BOOL bEnable</b></param>
	int SetBreakOnID (MessageId iD, bool bEnable);
	/// <summary>
	/// STDMETHODCALLTYPE <b>BOOL ID3D11InfoQueue::GetBreakOnCategory (D3D11_MESSAGE_CATEGORY Category)</b><br/>
	/// </summary>
	/// <param name="category">_In_ <b>D3D11_MESSAGE_CATEGORY Category</b></param>
	bool GetBreakOnCategory (MessageCategory category);
	/// <summary>
	/// STDMETHODCALLTYPE <b>BOOL ID3D11InfoQueue::GetBreakOnSeverity (D3D11_MESSAGE_SEVERITY Severity)</b><br/>
	/// </summary>
	/// <param name="severity">_In_ <b>D3D11_MESSAGE_SEVERITY Severity</b></param>
	bool GetBreakOnSeverity (MessageSeverity severity);
	/// <summary>
	/// STDMETHODCALLTYPE <b>BOOL ID3D11InfoQueue::GetBreakOnID (D3D11_MESSAGE_ID ID)</b><br/>
	/// </summary>
	/// <param name="iD">_In_ <b>D3D11_MESSAGE_ID ID</b></param>
	bool GetBreakOnID (MessageId iD);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11InfoQueue::SetMuteDebugOutput (BOOL bMute)</b><br/>
	/// </summary>
	/// <param name="bMute">_In_ <b>BOOL bMute</b></param>
	void SetMuteDebugOutput (bool bMute);
	/// <summary>
	/// STDMETHODCALLTYPE <b>BOOL ID3D11InfoQueue::GetMuteDebugOutput ()</b><br/>
	/// </summary>
	bool GetMuteDebugOutput ();
}

/// <summary>
/// Instance of <b>ID3D11InfoQueue</b><br/>
/// D3D11SDKLAYERS.h
/// </summary>
...
//unsafe public readonly struct IInfoQueueObj : IInfoQueue {
	...
	static readonly Guid _guid = new (0x6543dbb6, 0x1b48, 0x42f5, 0xab, 0x82, 0xe9, 0x7e, 0xc7, 0x43, 0x26, 0xf6);
