...
/// <summary>
/// INTERFACE <b>ID3D11VideoContext3</b> : ID3D11VideoContext2<br/>
/// D3D11_4.h
/// </summary>
unsafe public interface IVideoContext3 : IVideoContext2 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext3::DecoderBeginFrame1 (ID3D11VideoDecoder* pDecoder, ID3D11VideoDecoderOutputView* pView, UINT ContentKeySize, void* pContentKey, UINT NumComponentHistograms, UINT* pHistogramOffsets, ID3D11Buffer* ppHistogramBuffers)</b><br/>
	/// </summary>
	...
	/// <param name="numComponentHistograms">_In_range_(0, D3D11_4_VIDEO_DECODER_MAX_HISTOGRAM_COMPONENTS) <b>UINT NumComponentHistograms</b></param>
	/// <param name="pHistogramOffsets">_In_reads_opt_(NumComponentHistograms) <b>UINT* pHistogramOffsets</b></param>
	/// <param name="ppHistogramBuffers">_In_reads_opt_(NumComponentHistograms) <b>ID3D11Buffer* ppHistogramBuffers</b></param>
	int DecoderBeginFrame1<T0, T1, T2> (T0* pDecoder, T1* pView, uint contentKeySize, void* pContentKey, uint numComponentHistograms, uint* pHistogramOffsets, T2* ppHistogramBuffers) where T0 : unmanaged, IVideoDecoder where T1 : unmanaged, IVideoDecoderOutputView where T2 : unmanaged, IBuffer;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext3::SubmitDecoderBuffers2 (ID3D11VideoDecoder* pDecoder, UINT NumBuffers, D3D11_VIDEO_DECODER_BUFFER_DESC2* pBufferDesc)</b><br/>
	/// </summary>
	/// <param name="pDecoder">_In_ <b>ID3D11VideoDecoder* pDecoder</b></param>
	/// <param name="numBuffers">_In_ <b>UINT NumBuffers</b></param>
	/// <param name="pBufferDesc">_In_reads_(NumBuffers) <b>D3D11_VIDEO_DECODER_BUFFER_DESC2* pBufferDesc</b></param>
	int SubmitDecoderBuffers2<T0> (T0* pDecoder, uint numBuffers, VideoDecoderBufferDesc2* pBufferDesc) where T0 : unmanaged, IVideoDecoder;
}

/// <summary>
/// Instance of <b>ID3D11VideoContext3</b><br/>
/// D3D11_4.h
/// </summary>
unsafe public readonly struct VideoContext3 : IVideoContext3 {
//unsafe public readonly struct IVideoContext3Obj : IVideoContext3 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly VideoContext3* GetCurrentPointer () => (VideoContext3*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IVideoContext3Obj* GetCurrentPointer () => (IVideoContext3Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xa9e2faa0, 0xcb39, 0x418f, 0xa0, 0xb7, 0xd8, 0xaa, 0xd4, 0xde, 0x67, 0x2e);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int DecoderBeginFrame1<T0, T1, T2> (T0* pDecoder, T1* pView, uint contentKeySize, void* pContentKey, uint numComponentHistograms, uint* pHistogramOffsets, T2* ppHistogramBuffers) where T0 : unmanaged, IVideoDecoder where T1 : unmanaged, IVideoDecoderOutputView where T2 : unmanaged, IBuffer {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->DecoderBeginFrame1 (ptr, pDecoder, pView, contentKeySize, pContentKey, numComponentHistograms, pHistogramOffsets, ppHistogramBuffers);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int SubmitDecoderBuffers2<T0> (T0* pDecoder, uint numBuffers, VideoDecoderBufferDesc2* pBufferDesc) where T0 : unmanaged, IVideoDecoder {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->SubmitDecoderBuffers2 (ptr, pDecoder, numBuffers, pBufferDesc);
		return hr;
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 83
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void*, uint, void*, uint, uint*, void*, int> DecoderBeginFrame1;
		/// <summary>
		/// OFFSET 84
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, uint, VideoDecoderBufferDesc2*, int> SubmitDecoderBuffers2;
	}
