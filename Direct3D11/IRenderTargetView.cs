...
/// <summary>
/// INTERFACE <b>ID3D11RenderTargetView</b> : ID3D11View<br/>
/// D3D11.h
/// </summary>
unsafe public interface IRenderTargetView : IView {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11RenderTargetView::GetDesc (D3D11_RENDER_TARGET_VIEW_DESC* pDesc)</b><br/>
	/// </summary>
	/// <param name="pDesc">_Out_ <b>D3D11_RENDER_TARGET_VIEW_DESC* pDesc</b></param>
	void GetDesc (RenderTargetViewDesc* pDesc);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11RenderTargetView::GetDesc (D3D11_RENDER_TARGET_VIEW_DESC* pDesc)</b><br/>
	/// </summary>
	/// <param name="pDesc">_Out_ <b>D3D11_RENDER_TARGET_VIEW_DESC* pDesc</b></param>
	void GetDesc (out RenderTargetViewDesc pDesc);
}

/// <summary>
/// Instance of <b>ID3D11RenderTargetView</b><br/>
/// D3D11.h
/// </summary>
unsafe public readonly struct RenderTargetView : IRenderTargetView {
//unsafe public readonly struct IRenderTargetViewObj : IRenderTargetView {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly RenderTargetView* GetCurrentPointer () => (RenderTargetView*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IRenderTargetViewObj* GetCurrentPointer () => (IRenderTargetViewObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xdfdba067, 0x0b8d, 0x4865, 0x87, 0x5b, 0xd7, 0xb4, 0x51, 0x6c, 0xc1, 0x64);
