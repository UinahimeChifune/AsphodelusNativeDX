...
/// <summary>
/// INTERFACE <b>ID3D11DeviceContext3</b> : ID3D11DeviceContext2<br/>
/// D3D11_3.h
/// </summary>
unsafe public interface IDeviceContext3 : IDeviceContext2 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext3::Flush1 (D3D11_CONTEXT_TYPE ContextType, HANDLE hEvent)</b><br/>
	/// </summary>
	/// <param name="contextType"><b>D3D11_CONTEXT_TYPE ContextType</b></param>
	/// <param name="hEvent">_In_opt_ <b>HANDLE hEvent</b></param>
	void Flush1 (ContextType contextType, IntPtr hEvent);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext3::SetHardwareProtectionState (BOOL HwProtectionEnable)</b><br/>
	/// </summary>
	/// <param name="hwProtectionEnable">_In_ <b>BOOL HwProtectionEnable</b></param>
	void SetHardwareProtectionState (bool hwProtectionEnable);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext3::GetHardwareProtectionState (BOOL* pHwProtectionEnable)</b><br/>
	/// </summary>
	/// <param name="pHwProtectionEnable">_Out_ <b>BOOL* pHwProtectionEnable</b></param>
	void GetHardwareProtectionState (uint* pHwProtectionEnable);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11DeviceContext3::GetHardwareProtectionState (BOOL* pHwProtectionEnable)</b><br/>
	/// </summary>
	/// <param name="pHwProtectionEnable">_Out_ <b>BOOL* pHwProtectionEnable</b></param>
...
/// <summary>
/// Instance of <b>ID3D11DeviceContext3</b><br/>
/// D3D11_3.h
/// </summary>
unsafe public readonly struct DeviceContext3 : IDeviceContext3 {
//unsafe public readonly struct IDeviceContext3Obj : IDeviceContext3 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly DeviceContext3* GetCurrentPointer () => (DeviceContext3*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IDeviceContext3Obj* GetCurrentPointer () => (IDeviceContext3Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xb4e3c01d, 0xe79e, 0x4637, 0x91, 0xb2, 0x51, 0x0e, 0x9f, 0x4c, 0x9b, 0x8f);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void Flush1 (ContextType contextType, IntPtr hEvent) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->Flush1 (ptr, contextType, hEvent);
		return;
	}
	...
	public readonly void SetHardwareProtectionState (bool hwProtectionEnable) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->SetHardwareProtectionState (ptr, hwProtectionEnable ? 1U : 0U);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetHardwareProtectionState (uint* pHwProtectionEnable) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->GetHardwareProtectionState (ptr, pHwProtectionEnable);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetHardwareProtectionState (out bool pHwProtectionEnable) {
		uint _pHwProtectionEnable;
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->GetHardwareProtectionState (ptr, &_pHwProtectionEnable);
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 144
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, ContextType, IntPtr, void> Flush1;
		/// <summary>
		/// OFFSET 145
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, uint, void> SetHardwareProtectionState;
		/// <summary>
		/// OFFSET 146
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, uint*, void> GetHardwareProtectionState;
	}
