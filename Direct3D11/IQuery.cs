...
/// <summary>
/// INTERFACE <b>ID3D11Query</b> : ID3D11Asynchronous<br/>
/// D3D11.h
/// </summary>
unsafe public interface IQuery : IAsynchronous {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11Query::GetDesc (D3D11_QUERY_DESC* pDesc)</b><br/>
	/// </summary>
	/// <param name="pDesc">_Out_ <b>D3D11_QUERY_DESC* pDesc</b></param>
	void GetDesc (QueryDesc* pDesc);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11Query::GetDesc (D3D11_QUERY_DESC* pDesc)</b><br/>
	/// </summary>
	/// <param name="pDesc">_Out_ <b>D3D11_QUERY_DESC* pDesc</b></param>
	void GetDesc (out QueryDesc pDesc);
}

/// <summary>
/// Instance of <b>ID3D11Query</b><br/>
/// D3D11.h
/// </summary>
unsafe public readonly struct Query : IQuery {
//unsafe public readonly struct IQueryObj : IQuery {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly Query* GetCurrentPointer () => (Query*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IQueryObj* GetCurrentPointer () => (IQueryObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xd6c00747, 0x87b7, 0x425e, 0xb8, 0x4d, 0x44, 0xd1, 0x08, 0x56, 0x0a, 0xfd);
