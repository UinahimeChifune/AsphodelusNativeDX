...
/// <summary>
/// INTERFACE <b>ID3D11DeviceContext4</b> : ID3D11DeviceContext3<br/>
/// D3D11_3.h
/// </summary>
unsafe public interface IDeviceContext4 : IDeviceContext3 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11DeviceContext4::Signal (ID3D11Fence* pFence, UINT64 Value)</b><br/>
	/// </summary>
	/// <param name="pFence">_In_ <b>ID3D11Fence* pFence</b></param>
	/// <param name="value">_In_ <b>UINT64 Value</b></param>
	int Signal<T0> (T0* pFence, ulong value) where T0 : unmanaged, IFence;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11DeviceContext4::Wait (ID3D11Fence* pFence, UINT64 Value)</b><br/>
	/// </summary>
	/// <param name="pFence">_In_ <b>ID3D11Fence* pFence</b></param>
	/// <param name="value">_In_ <b>UINT64 Value</b></param>
...
/// <summary>
/// Instance of <b>ID3D11DeviceContext4</b><br/>
/// D3D11_3.h
/// </summary>
...
//unsafe public readonly struct IDeviceContext4Obj : IDeviceContext4 {
	...
	static readonly Guid _guid = new (0x917600da, 0xf58c, 0x4c33, 0x98, 0xd8, 0x3e, 0x15, 0xb3, 0x90, 0xfa, 0x24);
