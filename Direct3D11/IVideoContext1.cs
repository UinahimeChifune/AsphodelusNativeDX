...
/// <summary>
/// INTERFACE <b>ID3D11VideoContext1</b> : ID3D11VideoContext<br/>
/// D3D11_1.h
/// </summary>
unsafe public interface IVideoContext1 : IVideoContext {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext1::SubmitDecoderBuffers1 (ID3D11VideoDecoder* pDecoder, UINT NumBuffers, D3D11_VIDEO_DECODER_BUFFER_DESC1* pBufferDesc)</b><br/>
	/// </summary>
	/// <param name="pDecoder">_In_ <b>ID3D11VideoDecoder* pDecoder</b></param>
	/// <param name="numBuffers">_In_ <b>UINT NumBuffers</b></param>
	/// <param name="pBufferDesc">_In_reads_(NumBuffers) <b>D3D11_VIDEO_DECODER_BUFFER_DESC1* pBufferDesc</b></param>
	int SubmitDecoderBuffers1<T0> (T0* pDecoder, uint numBuffers, VideoDecoderBufferDesc1* pBufferDesc) where T0 : unmanaged, IVideoDecoder;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext1::GetDataForNewHardwareKey (ID3D11CryptoSession* pCryptoSession, UINT PrivateInputSize, void* pPrivatInputData, UINT64* pPrivateOutputData)</b><br/>
	/// </summary>
	/// <param name="pCryptoSession">_In_ <b>ID3D11CryptoSession* pCryptoSession</b></param>
	/// <param name="privateInputSize">_In_ <b>UINT PrivateInputSize</b></param>
	/// <param name="pPrivatInputData">_In_reads_(PrivateInputSize) <b>void* pPrivatInputData</b></param>
	/// <param name="pPrivateOutputData">_Out_ <b>UINT64* pPrivateOutputData</b></param>
	int GetDataForNewHardwareKey<T0> (T0* pCryptoSession, uint privateInputSize, void* pPrivatInputData, ulong* pPrivateOutputData) where T0 : unmanaged, ICryptoSession;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext1::GetDataForNewHardwareKey (ID3D11CryptoSession* pCryptoSession, UINT PrivateInputSize, void* pPrivatInputData, UINT64* pPrivateOutputData)</b><br/>
	/// </summary>
	/// <param name="pCryptoSession">_In_ <b>ID3D11CryptoSession* pCryptoSession</b></param>
	...
	/// <param name="pPrivatInputData">_In_reads_(PrivateInputSize) <b>void* pPrivatInputData</b></param>
	/// <param name="pPrivateOutputData">_Out_ <b>UINT64* pPrivateOutputData</b></param>
	int GetDataForNewHardwareKey<T0> (T0* pCryptoSession, uint privateInputSize, void* pPrivatInputData, out ulong pPrivateOutputData) where T0 : unmanaged, ICryptoSession;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext1::CheckCryptoSessionStatus (ID3D11CryptoSession* pCryptoSession, D3D11_CRYPTO_SESSION_STATUS* pStatus)</b><br/>
	/// </summary>
	/// <param name="pCryptoSession">_In_ <b>ID3D11CryptoSession* pCryptoSession</b></param>
	/// <param name="pStatus">_Out_ <b>D3D11_CRYPTO_SESSION_STATUS* pStatus</b></param>
	int CheckCryptoSessionStatus<T0> (T0* pCryptoSession, CryptoSessionStatus* pStatus) where T0 : unmanaged, ICryptoSession;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext1::CheckCryptoSessionStatus (ID3D11CryptoSession* pCryptoSession, D3D11_CRYPTO_SESSION_STATUS* pStatus)</b><br/>
	/// </summary>
	/// <param name="pCryptoSession">_In_ <b>ID3D11CryptoSession* pCryptoSession</b></param>
	/// <param name="pStatus">_Out_ <b>D3D11_CRYPTO_SESSION_STATUS* pStatus</b></param>
	int CheckCryptoSessionStatus<T0> (T0* pCryptoSession, out CryptoSessionStatus pStatus) where T0 : unmanaged, ICryptoSession;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext1::DecoderEnableDownsampling (ID3D11VideoDecoder* pDecoder, DXGI_COLOR_SPACE_TYPE InputColorSpace, D3D11_VIDEO_SAMPLE_DESC* pOutputDesc, UINT ReferenceFrameCount)</b><br/>
	/// </summary>
	/// <param name="pDecoder">_In_ <b>ID3D11VideoDecoder* pDecoder</b></param>
	...
	/// <param name="referenceFrameCount">_In_ <b>UINT ReferenceFrameCount</b></param>
	int DecoderEnableDownsampling<T0> (T0* pDecoder, DXGI.ColorSpaceType inputColorSpace, VideoSampleDesc* pOutputDesc, uint referenceFrameCount) where T0 : unmanaged, IVideoDecoder;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext1::DecoderUpdateDownsampling (ID3D11VideoDecoder* pDecoder, D3D11_VIDEO_SAMPLE_DESC* pOutputDesc)</b><br/>
	/// </summary>
	/// <param name="pDecoder">_In_ <b>ID3D11VideoDecoder* pDecoder</b></param>
	/// <param name="pOutputDesc">_In_ <b>D3D11_VIDEO_SAMPLE_DESC* pOutputDesc</b></param>
	int DecoderUpdateDownsampling<T0> (T0* pDecoder, VideoSampleDesc* pOutputDesc) where T0 : unmanaged, IVideoDecoder;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorSetOutputColorSpace1 (ID3D11VideoProcessor* pVideoProcessor, DXGI_COLOR_SPACE_TYPE ColorSpace)</b><br/>
	/// </summary>
	...
	void VideoProcessorSetOutputColorSpace1<T0> (T0* pVideoProcessor, DXGI.ColorSpaceType colorSpace) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorSetOutputShaderUsage (ID3D11VideoProcessor* pVideoProcessor, BOOL ShaderUsage)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="shaderUsage">_In_ <b>BOOL ShaderUsage</b></param>
	void VideoProcessorSetOutputShaderUsage<T0> (T0* pVideoProcessor, bool shaderUsage) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorGetOutputColorSpace1 (ID3D11VideoProcessor* pVideoProcessor, DXGI_COLOR_SPACE_TYPE* pColorSpace)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="pColorSpace">_Out_ <b>DXGI_COLOR_SPACE_TYPE* pColorSpace</b></param>
	void VideoProcessorGetOutputColorSpace1<T0> (T0* pVideoProcessor, DXGI.ColorSpaceType* pColorSpace) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorGetOutputColorSpace1 (ID3D11VideoProcessor* pVideoProcessor, DXGI_COLOR_SPACE_TYPE* pColorSpace)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="pColorSpace">_Out_ <b>DXGI_COLOR_SPACE_TYPE* pColorSpace</b></param>
	void VideoProcessorGetOutputColorSpace1<T0> (T0* pVideoProcessor, out DXGI.ColorSpaceType pColorSpace) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorGetOutputShaderUsage (ID3D11VideoProcessor* pVideoProcessor, BOOL* pShaderUsage)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="pShaderUsage">_Out_ <b>BOOL* pShaderUsage</b></param>
	void VideoProcessorGetOutputShaderUsage<T0> (T0* pVideoProcessor, uint* pShaderUsage) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorGetOutputShaderUsage (ID3D11VideoProcessor* pVideoProcessor, BOOL* pShaderUsage)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="pShaderUsage">_Out_ <b>BOOL* pShaderUsage</b></param>
	void VideoProcessorGetOutputShaderUsage<T0> (T0* pVideoProcessor, out bool pShaderUsage) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorSetStreamColorSpace1 (ID3D11VideoProcessor* pVideoProcessor, UINT StreamIndex, DXGI_COLOR_SPACE_TYPE ColorSpace)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="streamIndex">_In_ <b>UINT StreamIndex</b></param>
	/// <param name="colorSpace">_In_ <b>DXGI_COLOR_SPACE_TYPE ColorSpace</b></param>
	void VideoProcessorSetStreamColorSpace1<T0> (T0* pVideoProcessor, uint streamIndex, DXGI.ColorSpaceType colorSpace) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorSetStreamMirror (ID3D11VideoProcessor* pVideoProcessor, UINT StreamIndex, BOOL Enable, BOOL FlipHorizontal, BOOL FlipVertical)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="streamIndex">_In_ <b>UINT StreamIndex</b></param>
	/// <param name="enable">_In_ <b>BOOL Enable</b></param>
	/// <param name="flipHorizontal">_In_ <b>BOOL FlipHorizontal</b></param>
	/// <param name="flipVertical">_In_ <b>BOOL FlipVertical</b></param>
	void VideoProcessorSetStreamMirror<T0> (T0* pVideoProcessor, uint streamIndex, bool enable, bool flipHorizontal, bool flipVertical) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorGetStreamColorSpace1 (ID3D11VideoProcessor* pVideoProcessor, UINT StreamIndex, DXGI_COLOR_SPACE_TYPE* pColorSpace)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="streamIndex">_In_ <b>UINT StreamIndex</b></param>
	/// <param name="pColorSpace">_Out_ <b>DXGI_COLOR_SPACE_TYPE* pColorSpace</b></param>
	void VideoProcessorGetStreamColorSpace1<T0> (T0* pVideoProcessor, uint streamIndex, DXGI.ColorSpaceType* pColorSpace) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorGetStreamColorSpace1 (ID3D11VideoProcessor* pVideoProcessor, UINT StreamIndex, DXGI_COLOR_SPACE_TYPE* pColorSpace)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="streamIndex">_In_ <b>UINT StreamIndex</b></param>
	/// <param name="pColorSpace">_Out_ <b>DXGI_COLOR_SPACE_TYPE* pColorSpace</b></param>
	void VideoProcessorGetStreamColorSpace1<T0> (T0* pVideoProcessor, uint streamIndex, out DXGI.ColorSpaceType pColorSpace) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorGetStreamMirror (ID3D11VideoProcessor* pVideoProcessor, UINT StreamIndex, BOOL* pEnable, BOOL* pFlipHorizontal, BOOL* pFlipVertical)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="streamIndex">_In_ <b>UINT StreamIndex</b></param>
	/// <param name="pEnable">_Out_ <b>BOOL* pEnable</b></param>
	/// <param name="pFlipHorizontal">_Out_ <b>BOOL* pFlipHorizontal</b></param>
	/// <param name="pFlipVertical">_Out_ <b>BOOL* pFlipVertical</b></param>
	void VideoProcessorGetStreamMirror<T0> (T0* pVideoProcessor, uint streamIndex, uint* pEnable, uint* pFlipHorizontal, uint* pFlipVertical) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D11VideoContext1::VideoProcessorGetStreamMirror (ID3D11VideoProcessor* pVideoProcessor, UINT StreamIndex, BOOL* pEnable, BOOL* pFlipHorizontal, BOOL* pFlipVertical)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	...
	/// <param name="pFlipHorizontal">_Out_ <b>BOOL* pFlipHorizontal</b></param>
	/// <param name="pFlipVertical">_Out_ <b>BOOL* pFlipVertical</b></param>
	void VideoProcessorGetStreamMirror<T0> (T0* pVideoProcessor, uint streamIndex, out bool pEnable, out bool pFlipHorizontal, out bool pFlipVertical) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext1::VideoProcessorGetBehaviorHints (ID3D11VideoProcessor* pVideoProcessor, UINT OutputWidth, UINT OutputHeight, DXGI_FORMAT OutputFormat, UINT StreamCount, D3D11_VIDEO_PROCESSOR_STREAM_BEHAVIOR_HINT* pStreams, UINT* pBehaviorHints)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	/// <param name="outputWidth">_In_ <b>UINT OutputWidth</b></param>
	/// <param name="outputHeight">_In_ <b>UINT OutputHeight</b></param>
	/// <param name="outputFormat">_In_ <b>DXGI_FORMAT OutputFormat</b></param>
	/// <param name="streamCount">_In_ <b>UINT StreamCount</b></param>
	/// <param name="pStreams">_In_reads_(StreamCount) <b>D3D11_VIDEO_PROCESSOR_STREAM_BEHAVIOR_HINT* pStreams</b></param>
	/// <param name="pBehaviorHints">_Out_ <b>UINT* pBehaviorHints</b></param>
	int VideoProcessorGetBehaviorHints<T0> (T0* pVideoProcessor, uint outputWidth, uint outputHeight, DXGI.Format outputFormat, uint streamCount, VideoProcessorStreamBehaviorHint* pStreams, uint* pBehaviorHints) where T0 : unmanaged, IVideoProcessor;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D11VideoContext1::VideoProcessorGetBehaviorHints (ID3D11VideoProcessor* pVideoProcessor, UINT OutputWidth, UINT OutputHeight, DXGI_FORMAT OutputFormat, UINT StreamCount, D3D11_VIDEO_PROCESSOR_STREAM_BEHAVIOR_HINT* pStreams, UINT* pBehaviorHints)</b><br/>
	/// </summary>
	/// <param name="pVideoProcessor">_In_ <b>ID3D11VideoProcessor* pVideoProcessor</b></param>
	...
	/// <param name="pStreams">_In_reads_(StreamCount) <b>D3D11_VIDEO_PROCESSOR_STREAM_BEHAVIOR_HINT* pStreams</b></param>
	/// <param name="pBehaviorHints">_Out_ <b>UINT* pBehaviorHints</b></param>
	int VideoProcessorGetBehaviorHints<T0> (T0* pVideoProcessor, uint outputWidth, uint outputHeight, DXGI.Format outputFormat, uint streamCount, VideoProcessorStreamBehaviorHint* pStreams, out uint pBehaviorHints) where T0 : unmanaged, IVideoProcessor;
}

/// <summary>
/// Instance of <b>ID3D11VideoContext1</b><br/>
/// D3D11_1.h
/// </summary>
unsafe public readonly struct VideoContext1 : IVideoContext1 {
//unsafe public readonly struct IVideoContext1Obj : IVideoContext1 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly VideoContext1* GetCurrentPointer () => (VideoContext1*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IVideoContext1Obj* GetCurrentPointer () => (IVideoContext1Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xa7f026da, 0xa5f8, 0x4487, 0xa5, 0x64, 0x15, 0xe3, 0x43, 0x57, 0x65, 0x1e);
