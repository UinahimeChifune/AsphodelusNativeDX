...
/// <summary>
/// INTERFACE <b>ID2D1DrawTransform</b> : ID2D1Transform<br/>
/// D2D1EFFECTAUTHOR.h
/// </summary>
unsafe public interface IDrawTransform : ITransform {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DrawTransform::SetDrawInfo (ID2D1DrawInfo* drawInfo)</b><br/>
	/// </summary>
	/// <param name="drawInfo">_In_ <b>ID2D1DrawInfo* drawInfo</b></param>
	int SetDrawInfo<T0> (T0* drawInfo) where T0 : unmanaged, IDrawInfo;
}

/// <summary>
/// Instance of <b>ID2D1DrawTransform</b><br/>
/// D2D1EFFECTAUTHOR.h
/// </summary>
unsafe public readonly struct DrawTransform : IDrawTransform {
//unsafe public readonly struct IDrawTransformObj : IDrawTransform {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly DrawTransform* GetCurrentPointer () => (DrawTransform*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IDrawTransformObj* GetCurrentPointer () => (IDrawTransformObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x36bfdcb6, 0x9739, 0x435d, 0xa3, 0x0d, 0xa6, 0x53, 0xbe, 0xff, 0x6a, 0x6f);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int SetDrawInfo<T0> (T0* drawInfo) where T0 : unmanaged, IDrawInfo {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->SetDrawInfo (ptr, drawInfo);
		return hr;
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 7
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, int> SetDrawInfo;
	}
