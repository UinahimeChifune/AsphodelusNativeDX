...
/// <summary>
/// INTERFACE <b>ID2D1RectangleGeometry</b> : ID2D1Geometry<br/>
/// D2D1.h
/// </summary>
unsafe public interface IRectangleGeometry : IGeometry {
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1RectangleGeometry::GetRect (D2D1_RECT_F* rect)</b><br/>
	/// </summary>
	/// <param name="rect">_Out_ <b>D2D1_RECT_F* rect</b></param>
	void GetRect (Vector4F* rect);
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1RectangleGeometry::GetRect (D2D1_RECT_F* rect)</b><br/>
	/// </summary>
	/// <param name="rect">_Out_ <b>D2D1_RECT_F* rect</b></param>
	void GetRect (out Vector4F rect);
}

/// <summary>
/// Instance of <b>ID2D1RectangleGeometry</b><br/>
/// D2D1.h
/// </summary>
unsafe public readonly struct RectangleGeometry : IRectangleGeometry {
//unsafe public readonly struct IRectangleGeometryObj : IRectangleGeometry {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly RectangleGeometry* GetCurrentPointer () => (RectangleGeometry*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IRectangleGeometryObj* GetCurrentPointer () => (IRectangleGeometryObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x2cd906a2, 0x12e2, 0x11dc, 0x9f, 0xed, 0x00, 0x11, 0x43, 0xa0, 0x55, 0xf9);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetRect (Vector4F* rect) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->GetRect (ptr, rect);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetRect (out Vector4F rect) {
		fixed (Vector4F* _rect = &rect) {
			var ptr = GetCurrentPointer ();
			((FunctionPointer*) ptr->_pointer)->GetRect (ptr, _rect);
			return;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 17
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, Vector4F*, void> GetRect;
	}
