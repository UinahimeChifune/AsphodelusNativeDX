...
/// <summary>
/// INTERFACE <b>ID2D1BitmapRenderTarget</b> : ID2D1RenderTarget<br/>
/// D2D1.h
/// </summary>
unsafe public interface IBitmapRenderTarget : IRenderTarget {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1BitmapRenderTarget::GetBitmap (ID2D1Bitmap** bitmap)</b><br/>
	/// </summary>
	/// <param name="bitmap">_COM_Outptr_ <b>ID2D1Bitmap** bitmap</b></param>
	int GetBitmap<T0> (T0** bitmap) where T0 : unmanaged, IBitmap;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1BitmapRenderTarget::GetBitmap (ID2D1Bitmap** bitmap)</b><br/>
	/// </summary>
	/// <param name="bitmap">_COM_Outptr_ <b>ID2D1Bitmap** bitmap</b></param>
	int GetBitmap<T0> (out T0* bitmap) where T0 : unmanaged, IBitmap;
}

/// <summary>
/// Instance of <b>ID2D1BitmapRenderTarget</b><br/>
/// D2D1.h
/// </summary>
...
//unsafe public readonly struct IBitmapRenderTargetObj : IBitmapRenderTarget {
	...
	static readonly Guid _guid = new (0x2cd90695, 0x12e2, 0x11dc, 0x9f, 0xed, 0x00, 0x11, 0x43, 0xa0, 0x55, 0xf9);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetBitmap<T0> (T0** bitmap) where T0 : unmanaged, IBitmap {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->GetBitmap (ptr, (void**) bitmap);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetBitmap<T0> (out T0* bitmap) where T0 : unmanaged, IBitmap {
		fixed (T0** _bitmap = &bitmap) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->GetBitmap (ptr, (void**) _bitmap);
			return hr;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 57
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void**, int> GetBitmap;
	}
