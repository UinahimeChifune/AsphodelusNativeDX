...
/// <summary>
/// INTERFACE <b>ID2D1Device3</b> : ID2D1Device2<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IDevice3 : IDevice2 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Device3::CreateDeviceContext (D2D1_DEVICE_CONTEXT_OPTIONS options, ID2D1DeviceContext3** deviceContext3)</b><br/>
	/// </summary>
	/// <param name="options"><b>D2D1_DEVICE_CONTEXT_OPTIONS options</b></param>
	/// <param name="deviceContext3">_COM_Outptr_ <b>ID2D1DeviceContext3** deviceContext3</b></param>
	int CreateDeviceContext3<T0> (DeviceContextOptions options, T0** deviceContext3) where T0 : unmanaged, IDeviceContext3;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Device3::CreateDeviceContext (D2D1_DEVICE_CONTEXT_OPTIONS options, ID2D1DeviceContext3** deviceContext3)</b><br/>
	/// </summary>
	/// <param name="options"><b>D2D1_DEVICE_CONTEXT_OPTIONS options</b></param>
	/// <param name="deviceContext3">_COM_Outptr_ <b>ID2D1DeviceContext3** deviceContext3</b></param>
	int CreateDeviceContext3<T0> (DeviceContextOptions options, out T0* deviceContext3) where T0 : unmanaged, IDeviceContext3;
}

/// <summary>
/// Instance of <b>ID2D1Device3</b><br/>
/// D2D1_3.h
/// </summary>
...
//unsafe public readonly struct IDevice3Obj : IDevice3 {
	...
	static readonly Guid _guid = new (0x852f2087, 0x802c, 0x4037, 0xab, 0x60, 0xff, 0x2e, 0x7e, 0xe6, 0xfc, 0x01);
