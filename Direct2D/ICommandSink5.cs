...
/// <summary>
/// INTERFACE <b>ID2D1CommandSink5</b> : ID2D1CommandSink4<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface ICommandSink5 : ICommandSink4 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1CommandSink5::BlendImage (ID2D1Image* image, D2D1_BLEND_MODE blendMode, D2D1_POINT_2F* targetOffset, D2D1_RECT_F* imageRectangle, D2D1_INTERPOLATION_MODE interpolationMode)</b><br/>
	/// </summary>
	...
	int BlendImage<T0> (T0* image, BlendMode blendMode, Vector2F* targetOffset, Vector4F* imageRectangle, InterpolationMode interpolationMode) where T0 : unmanaged, IImage;
}

/// <summary>
/// Instance of <b>ID2D1CommandSink5</b><br/>
/// D2D1_3.h
/// </summary>
unsafe public readonly struct CommandSink5 : ICommandSink5 {
//unsafe public readonly struct ICommandSink5Obj : ICommandSink5 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly CommandSink5* GetCurrentPointer () => (CommandSink5*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly ICommandSink5Obj* GetCurrentPointer () => (ICommandSink5Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x7047dd26, 0xb1e7, 0x44a7, 0x95, 0x9a, 0x83, 0x49, 0xe2, 0x14, 0x4f, 0xa8);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int BlendImage<T0> (T0* image, BlendMode blendMode, Vector2F* targetOffset, Vector4F* imageRectangle, InterpolationMode interpolationMode) where T0 : unmanaged, IImage {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->BlendImage (ptr, image, blendMode, targetOffset, imageRectangle, interpolationMode);
		return hr;
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 34
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, BlendMode, Vector2F*, Vector4F*, InterpolationMode, int> BlendImage;
	}
