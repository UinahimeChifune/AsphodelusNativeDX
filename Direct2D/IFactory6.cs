...
/// <summary>
/// INTERFACE <b>ID2D1Factory6</b> : ID2D1Factory5<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IFactory6 : IFactory5 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory6::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device5** d2dDevice5)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice5">_COM_Outptr_ <b>ID2D1Device5** d2dDevice5</b></param>
	int CreateDevice5<T0, T1> (T0* dxgiDevice, T1** d2dDevice5) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice5;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory6::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device5** d2dDevice5)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice5">_COM_Outptr_ <b>ID2D1Device5** d2dDevice5</b></param>
	int CreateDevice5<T0, T1> (T0* dxgiDevice, out T1* d2dDevice5) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice5;
}

/// <summary>
/// Instance of <b>ID2D1Factory6</b><br/>
/// D2D1_3.h
/// </summary>
...
//unsafe public readonly struct IFactory6Obj : IFactory6 {
	...
	static readonly Guid _guid = new (0xf9976f46, 0xf642, 0x44c1, 0x97, 0xca, 0xda, 0x32, 0xea, 0x2a, 0x26, 0x35);
