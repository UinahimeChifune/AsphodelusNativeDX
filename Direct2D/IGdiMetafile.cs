...
/// <summary>
/// INTERFACE <b>ID2D1GdiMetafile</b> : ID2D1Resource<br/>
/// D2D1_1.h
/// </summary>
unsafe public interface IGdiMetafile : IResource {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1GdiMetafile::Stream (ID2D1GdiMetafileSink* sink)</b><br/>
	/// </summary>
	/// <param name="sink">_In_ <b>ID2D1GdiMetafileSink* sink</b></param>
	int Stream<T0> (T0* sink) where T0 : unmanaged, IGdiMetafileSink;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1GdiMetafile::GetBounds (D2D1_RECT_F* bounds)</b><br/>
	/// </summary>
	/// <param name="bounds">_Out_ <b>D2D1_RECT_F* bounds</b></param>
	int GetBounds (Vector4F* bounds);
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1GdiMetafile::GetBounds (D2D1_RECT_F* bounds)</b><br/>
	/// </summary>
	/// <param name="bounds">_Out_ <b>D2D1_RECT_F* bounds</b></param>
	int GetBounds (out Vector4F bounds);
}

/// <summary>
/// Instance of <b>ID2D1GdiMetafile</b><br/>
/// D2D1_1.h
/// </summary>
unsafe public readonly struct GdiMetafile : IGdiMetafile {
//unsafe public readonly struct IGdiMetafileObj : IGdiMetafile {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly GdiMetafile* GetCurrentPointer () => (GdiMetafile*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IGdiMetafileObj* GetCurrentPointer () => (IGdiMetafileObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x2f543dc3, 0xcfc1, 0x4211, 0x86, 0x4f, 0xcf, 0xd9, 0x1c, 0x6f, 0x33, 0x95);
