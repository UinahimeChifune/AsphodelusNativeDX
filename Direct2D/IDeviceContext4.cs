...
/// <summary>
/// INTERFACE <b>ID2D1DeviceContext4</b> : ID2D1DeviceContext3<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IDeviceContext4 : IDeviceContext3 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext4::CreateSvgGlyphStyle (ID2D1SvgGlyphStyle** svgGlyphStyle)</b><br/>
	/// </summary>
	/// <param name="svgGlyphStyle">_COM_Outptr_ <b>ID2D1SvgGlyphStyle** svgGlyphStyle</b></param>
	int CreateSvgGlyphStyle<T0> (T0** svgGlyphStyle) where T0 : unmanaged, ISvgGlyphStyle;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext4::CreateSvgGlyphStyle (ID2D1SvgGlyphStyle** svgGlyphStyle)</b><br/>
	/// </summary>
	/// <param name="svgGlyphStyle">_COM_Outptr_ <b>ID2D1SvgGlyphStyle** svgGlyphStyle</b></param>
	int CreateSvgGlyphStyle<T0> (out T0* svgGlyphStyle) where T0 : unmanaged, ISvgGlyphStyle;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext4::DrawText (WCHAR* string, UINT32 stringLength, IDWriteTextFormat* textFormat, D2D1_RECT_F* layoutRect, ID2D1Brush* defaultFillBrush, ID2D1SvgGlyphStyle* svgGlyphStyle, UINT32 colorPaletteIndex, D2D1_DRAW_TEXT_OPTIONS options, DWRITE_MEASURING_MODE measuringMode)</b><br/>
	/// </summary>
	...
	/// <param name="defaultFillBrush">_In_opt_ <b>ID2D1Brush* defaultFillBrush</b></param>
	/// <param name="svgGlyphStyle">_In_opt_ <b>ID2D1SvgGlyphStyle* svgGlyphStyle</b></param>
	...
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext4::DrawTextLayout (D2D1_POINT_2F origin, IDWriteTextLayout* textLayout, ID2D1Brush* defaultFillBrush, ID2D1SvgGlyphStyle* svgGlyphStyle, UINT32 colorPaletteIndex, D2D1_DRAW_TEXT_OPTIONS options)</b><br/>
	/// </summary>
	...
	/// <param name="colorPaletteIndex"><b>UINT32 colorPaletteIndex</b></param>
	/// <param name="options"><b>D2D1_DRAW_TEXT_OPTIONS options</b></param>
	void DrawTextLayout<T0, T1, T2> (Vector2F origin, T0* textLayout, T1* defaultFillBrush, T2* svgGlyphStyle, uint colorPaletteIndex, DrawTextOptions options) where T0 : unmanaged, DirectWrite.ITextLayout where T1 : unmanaged, IBrush where T2 : unmanaged, ISvgGlyphStyle;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext4::DrawColorBitmapGlyphRun (DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, D2D1_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, DWRITE_MEASURING_MODE measuringMode, D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION bitmapSnapOption)</b><br/>
	/// </summary>
	/// <param name="glyphImageFormat"><b>DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat</b></param>
	...
	/// <param name="measuringMode"><b>DWRITE_MEASURING_MODE measuringMode</b></param>
	/// <param name="bitmapSnapOption"><b>D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION bitmapSnapOption</b></param>
	void DrawColorBitmapGlyphRun (DirectWrite.GlyphImageFormats glyphImageFormat, Vector2F baselineOrigin, DirectWrite.GlyphRun* glyphRun, DirectWrite.MeasuringMode measuringMode, ColorBitmapGlyphSnapOption bitmapSnapOption);
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext4::DrawSvgGlyphRun (D2D1_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, ID2D1Brush* defaultFillBrush, ID2D1SvgGlyphStyle* svgGlyphStyle, UINT32 colorPaletteIndex, DWRITE_MEASURING_MODE measuringMode)</b><br/>
	/// </summary>
	/// <param name="baselineOrigin"><b>D2D1_POINT_2F baselineOrigin</b></param>
	/// <param name="glyphRun">_In_ <b>DWRITE_GLYPH_RUN* glyphRun</b></param>
	/// <param name="defaultFillBrush">_In_opt_ <b>ID2D1Brush* defaultFillBrush</b></param>
	...
	/// <param name="colorPaletteIndex"><b>UINT32 colorPaletteIndex</b></param>
	/// <param name="measuringMode"><b>DWRITE_MEASURING_MODE measuringMode</b></param>
	void DrawSvgGlyphRun<T0, T1> (Vector2F baselineOrigin, DirectWrite.GlyphRun* glyphRun, T0* defaultFillBrush, T1* svgGlyphStyle, uint colorPaletteIndex, DirectWrite.MeasuringMode measuringMode) where T0 : unmanaged, IBrush where T1 : unmanaged, ISvgGlyphStyle;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext4::GetColorBitmapGlyphImage (DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, D2D1_POINT_2F glyphOrigin, IDWriteFontFace* fontFace, FLOAT fontEmSize, UINT16 glyphIndex, BOOL isSideways, D2D1_MATRIX_3X2_F* worldTransform, FLOAT dpiX, FLOAT dpiY, D2D1_MATRIX_3X2_F* glyphTransform, ID2D1Image** glyphImage)</b><br/>
	/// </summary>
	/// <param name="glyphImageFormat"><b>DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat</b></param>
	/// <param name="glyphOrigin"><b>D2D1_POINT_2F glyphOrigin</b></param>
	/// <param name="fontFace">_In_ <b>IDWriteFontFace* fontFace</b></param>
	/// <param name="fontEmSize"><b>FLOAT fontEmSize</b></param>
	/// <param name="glyphIndex"><b>UINT16 glyphIndex</b></param>
	...
	/// <param name="glyphTransform">_Out_ <b>D2D1_MATRIX_3X2_F* glyphTransform</b></param>
	/// <param name="glyphImage">_COM_Outptr_ <b>ID2D1Image** glyphImage</b></param>
	...
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext4::GetSvgGlyphImage (D2D1_POINT_2F glyphOrigin, IDWriteFontFace* fontFace, FLOAT fontEmSize, UINT16 glyphIndex, BOOL isSideways, D2D1_MATRIX_3X2_F* worldTransform, ID2D1Brush* defaultFillBrush, ID2D1SvgGlyphStyle* svgGlyphStyle, UINT32 colorPaletteIndex, D2D1_MATRIX_3X2_F* glyphTransform, ID2D1CommandList** glyphImage)</b><br/>
	/// </summary>
	/// <param name="glyphOrigin"><b>D2D1_POINT_2F glyphOrigin</b></param>
	/// <param name="fontFace">_In_ <b>IDWriteFontFace* fontFace</b></param>
	/// <param name="fontEmSize"><b>FLOAT fontEmSize</b></param>
	...
	/// <param name="colorPaletteIndex"><b>UINT32 colorPaletteIndex</b></param>
	/// <param name="glyphTransform">_Out_ <b>D2D1_MATRIX_3X2_F* glyphTransform</b></param>
	/// <param name="glyphImage">_COM_Outptr_ <b>ID2D1CommandList** glyphImage</b></param>
...
/// <summary>
/// Instance of <b>ID2D1DeviceContext4</b><br/>
/// D2D1_3.h
/// </summary>
unsafe public readonly struct DeviceContext4 : IDeviceContext4 {
//unsafe public readonly struct IDeviceContext4Obj : IDeviceContext4 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly DeviceContext4* GetCurrentPointer () => (DeviceContext4*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IDeviceContext4Obj* GetCurrentPointer () => (IDeviceContext4Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x8c427831, 0x3d90, 0x4476, 0xb6, 0x47, 0xc4, 0xfa, 0xe3, 0x49, 0xe4, 0xdb);
