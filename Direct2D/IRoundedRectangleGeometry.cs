...
/// <summary>
/// INTERFACE <b>ID2D1RoundedRectangleGeometry</b> : ID2D1Geometry<br/>
/// D2D1.h
/// </summary>
unsafe public interface IRoundedRectangleGeometry : IGeometry {
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1RoundedRectangleGeometry::GetRoundedRect (D2D1_ROUNDED_RECT* roundedRect)</b><br/>
	/// </summary>
	/// <param name="roundedRect">_Out_ <b>D2D1_ROUNDED_RECT* roundedRect</b></param>
...
/// <summary>
/// Instance of <b>ID2D1RoundedRectangleGeometry</b><br/>
/// D2D1.h
/// </summary>
unsafe public readonly struct RoundedRectangleGeometry : IRoundedRectangleGeometry {
//unsafe public readonly struct IRoundedRectangleGeometryObj : IRoundedRectangleGeometry {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly RoundedRectangleGeometry* GetCurrentPointer () => (RoundedRectangleGeometry*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IRoundedRectangleGeometryObj* GetCurrentPointer () => (IRoundedRectangleGeometryObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x2cd906a3, 0x12e2, 0x11dc, 0x9f, 0xed, 0x00, 0x11, 0x43, 0xa0, 0x55, 0xf9);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetRoundedRect (RoundedRect* roundedRect) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->GetRoundedRect (ptr, roundedRect);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetRoundedRect (out RoundedRect roundedRect) {
		fixed (RoundedRect* _roundedRect = &roundedRect) {
			var ptr = GetCurrentPointer ();
			((FunctionPointer*) ptr->_pointer)->GetRoundedRect (ptr, _roundedRect);
			return;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 17
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, RoundedRect*, void> GetRoundedRect;
	}
