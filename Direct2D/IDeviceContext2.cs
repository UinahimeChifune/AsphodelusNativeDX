...
/// <summary>
/// INTERFACE <b>ID2D1DeviceContext2</b> : ID2D1DeviceContext1<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IDeviceContext2 : IDeviceContext1 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateInk (D2D1_INK_POINT* startPoint, ID2D1Ink** ink)</b><br/>
	/// </summary>
	/// <param name="startPoint">_In_ <b>D2D1_INK_POINT* startPoint</b></param>
	/// <param name="ink">_COM_Outptr_ <b>ID2D1Ink** ink</b></param>
	int CreateInk<T0> (InkPoint* startPoint, T0** ink) where T0 : unmanaged, IInk;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateInk (D2D1_INK_POINT* startPoint, ID2D1Ink** ink)</b><br/>
	/// </summary>
	/// <param name="startPoint">_In_ <b>D2D1_INK_POINT* startPoint</b></param>
	/// <param name="ink">_COM_Outptr_ <b>ID2D1Ink** ink</b></param>
	int CreateInk<T0> (InkPoint* startPoint, out T0* ink) where T0 : unmanaged, IInk;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateInkStyle (D2D1_INK_STYLE_PROPERTIES* inkStyleProperties, ID2D1InkStyle** inkStyle)</b><br/>
	/// </summary>
	/// <param name="inkStyleProperties">_In_opt_ <b>D2D1_INK_STYLE_PROPERTIES* inkStyleProperties</b></param>
	/// <param name="inkStyle">_COM_Outptr_ <b>ID2D1InkStyle** inkStyle</b></param>
	int CreateInkStyle<T0> (InkStyleProperties* inkStyleProperties, T0** inkStyle) where T0 : unmanaged, IInkStyle;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateInkStyle (D2D1_INK_STYLE_PROPERTIES* inkStyleProperties, ID2D1InkStyle** inkStyle)</b><br/>
	/// </summary>
	/// <param name="inkStyleProperties">_In_opt_ <b>D2D1_INK_STYLE_PROPERTIES* inkStyleProperties</b></param>
	/// <param name="inkStyle">_COM_Outptr_ <b>ID2D1InkStyle** inkStyle</b></param>
	int CreateInkStyle<T0> (InkStyleProperties* inkStyleProperties, out T0* inkStyle) where T0 : unmanaged, IInkStyle;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateGradientMesh (D2D1_GRADIENT_MESH_PATCH* patches, UINT32 patchesCount, ID2D1GradientMesh** gradientMesh)</b><br/>
	/// </summary>
	/// <param name="patches">_In_reads_(patchesCount) <b>D2D1_GRADIENT_MESH_PATCH* patches</b></param>
	/// <param name="patchesCount"><b>UINT32 patchesCount</b></param>
	/// <param name="gradientMesh">_COM_Outptr_ <b>ID2D1GradientMesh** gradientMesh</b></param>
	int CreateGradientMesh<T0> (GradientMeshPatch* patches, uint patchesCount, T0** gradientMesh) where T0 : unmanaged, IGradientMesh;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateGradientMesh (D2D1_GRADIENT_MESH_PATCH* patches, UINT32 patchesCount, ID2D1GradientMesh** gradientMesh)</b><br/>
	/// </summary>
	/// <param name="patches">_In_reads_(patchesCount) <b>D2D1_GRADIENT_MESH_PATCH* patches</b></param>
	/// <param name="patchesCount"><b>UINT32 patchesCount</b></param>
	/// <param name="gradientMesh">_COM_Outptr_ <b>ID2D1GradientMesh** gradientMesh</b></param>
	int CreateGradientMesh<T0> (GradientMeshPatch* patches, uint patchesCount, out T0* gradientMesh) where T0 : unmanaged, IGradientMesh;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateImageSourceFromWic (IWICBitmapSource* wicBitmapSource, D2D1_IMAGE_SOURCE_LOADING_OPTIONS loadingOptions, D2D1_ALPHA_MODE alphaMode, ID2D1ImageSourceFromWic** imageSource)</b><br/>
	/// </summary>
	/// <param name="wicBitmapSource">_In_ <b>IWICBitmapSource* wicBitmapSource</b></param>
	/// <param name="loadingOptions"><b>D2D1_IMAGE_SOURCE_LOADING_OPTIONS loadingOptions</b></param>
	/// <param name="alphaMode"><b>D2D1_ALPHA_MODE alphaMode</b></param>
	/// <param name="imageSource">_COM_Outptr_ <b>ID2D1ImageSourceFromWic** imageSource</b></param>
	int CreateImageSourceFromWic<T0, T1> (T0* wicBitmapSource, ImageSourceLoadingOptions loadingOptions, AlphaMode alphaMode, T1** imageSource) where T0 : unmanaged, WIC.IBitmapSource where T1 : unmanaged, IImageSourceFromWic;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateImageSourceFromWic (IWICBitmapSource* wicBitmapSource, D2D1_IMAGE_SOURCE_LOADING_OPTIONS loadingOptions, D2D1_ALPHA_MODE alphaMode, ID2D1ImageSourceFromWic** imageSource)</b><br/>
	/// </summary>
	/// <param name="wicBitmapSource">_In_ <b>IWICBitmapSource* wicBitmapSource</b></param>
	...
	/// <param name="alphaMode"><b>D2D1_ALPHA_MODE alphaMode</b></param>
	/// <param name="imageSource">_COM_Outptr_ <b>ID2D1ImageSourceFromWic** imageSource</b></param>
	int CreateImageSourceFromWic<T0, T1> (T0* wicBitmapSource, ImageSourceLoadingOptions loadingOptions, AlphaMode alphaMode, out T1* imageSource) where T0 : unmanaged, WIC.IBitmapSource where T1 : unmanaged, IImageSourceFromWic;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateLookupTable3D (D2D1_BUFFER_PRECISION precision, UINT32* extents, BYTE* data, UINT32 dataCount, UINT32* strides, ID2D1LookupTable3D** lookupTable)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateImageSourceFromDxgi (IDXGISurface** surfaces, UINT32 surfaceCount, DXGI_COLOR_SPACE_TYPE colorSpace, D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options, ID2D1ImageSource** imageSource)</b><br/>
	/// </summary>
	/// <param name="surfaces">_In_reads_(surfaceCount) <b>IDXGISurface** surfaces</b></param>
	/// <param name="surfaceCount"><b>UINT32 surfaceCount</b></param>
	/// <param name="colorSpace"><b>DXGI_COLOR_SPACE_TYPE colorSpace</b></param>
	/// <param name="options"><b>D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options</b></param>
	/// <param name="imageSource">_COM_Outptr_ <b>ID2D1ImageSource** imageSource</b></param>
	int CreateImageSourceFromDxgi<T0, T1> (T0** surfaces, uint surfaceCount, DXGI.ColorSpaceType colorSpace, ImageSourceFromDxgiOptions options, T1** imageSource) where T0 : unmanaged, DXGI.ISurface where T1 : unmanaged, IImageSource;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateImageSourceFromDxgi (IDXGISurface** surfaces, UINT32 surfaceCount, DXGI_COLOR_SPACE_TYPE colorSpace, D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options, ID2D1ImageSource** imageSource)</b><br/>
	/// </summary>
	/// <param name="surfaces">_In_reads_(surfaceCount) <b>IDXGISurface** surfaces</b></param>
	...
	/// <param name="options"><b>D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options</b></param>
	/// <param name="imageSource">_COM_Outptr_ <b>ID2D1ImageSource** imageSource</b></param>
	int CreateImageSourceFromDxgi<T0, T1> (T0** surfaces, uint surfaceCount, DXGI.ColorSpaceType colorSpace, ImageSourceFromDxgiOptions options, out T1* imageSource) where T0 : unmanaged, DXGI.ISurface where T1 : unmanaged, IImageSource;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::GetGradientMeshWorldBounds (ID2D1GradientMesh* gradientMesh, D2D1_RECT_F* pBounds)</b><br/>
	/// </summary>
	/// <param name="gradientMesh">_In_ <b>ID2D1GradientMesh* gradientMesh</b></param>
	/// <param name="pBounds">_Out_ <b>D2D1_RECT_F* pBounds</b></param>
	int GetGradientMeshWorldBounds<T0> (T0* gradientMesh, Vector4F* pBounds) where T0 : unmanaged, IGradientMesh;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::GetGradientMeshWorldBounds (ID2D1GradientMesh* gradientMesh, D2D1_RECT_F* pBounds)</b><br/>
	/// </summary>
	/// <param name="gradientMesh">_In_ <b>ID2D1GradientMesh* gradientMesh</b></param>
	/// <param name="pBounds">_Out_ <b>D2D1_RECT_F* pBounds</b></param>
	int GetGradientMeshWorldBounds<T0> (T0* gradientMesh, out Vector4F pBounds) where T0 : unmanaged, IGradientMesh;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext2::DrawInk (ID2D1Ink* ink, ID2D1Brush* brush, ID2D1InkStyle* inkStyle)</b><br/>
	/// </summary>
	/// <param name="ink">_In_ <b>ID2D1Ink* ink</b></param>
	/// <param name="brush">_In_ <b>ID2D1Brush* brush</b></param>
	/// <param name="inkStyle">_In_opt_ <b>ID2D1InkStyle* inkStyle</b></param>
	void DrawInk<T0, T1, T2> (T0* ink, T1* brush, T2* inkStyle) where T0 : unmanaged, IInk where T1 : unmanaged, IBrush where T2 : unmanaged, IInkStyle;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext2::DrawGradientMesh (ID2D1GradientMesh* gradientMesh)</b><br/>
	/// </summary>
	/// <param name="gradientMesh">_In_ <b>ID2D1GradientMesh* gradientMesh</b></param>
	void DrawGradientMesh<T0> (T0* gradientMesh) where T0 : unmanaged, IGradientMesh;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext2::DrawGdiMetafile (ID2D1GdiMetafile* gdiMetafile, D2D1_RECT_F* destinationRectangle, D2D1_RECT_F* sourceRectangle)</b><br/>
	/// </summary>
	...
	void DrawGdiMetafile<T0> (T0* gdiMetafile, Vector4F* destinationRectangle, Vector4F* sourceRectangle) where T0 : unmanaged, IGdiMetafile;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateTransformedImageSource (ID2D1ImageSource* imageSource, D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES* properties, ID2D1TransformedImageSource** transformedImageSource)</b><br/>
	/// </summary>
	/// <param name="imageSource">_In_ <b>ID2D1ImageSource* imageSource</b></param>
	/// <param name="properties">_In_ <b>D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES* properties</b></param>
	/// <param name="transformedImageSource">_COM_Outptr_ <b>ID2D1TransformedImageSource** transformedImageSource</b></param>
	int CreateTransformedImageSource<T0, T1> (T0* imageSource, TransformedImageSourceProperties* properties, T1** transformedImageSource) where T0 : unmanaged, IImageSource where T1 : unmanaged, ITransformedImageSource;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext2::CreateTransformedImageSource (ID2D1ImageSource* imageSource, D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES* properties, ID2D1TransformedImageSource** transformedImageSource)</b><br/>
	/// </summary>
	/// <param name="imageSource">_In_ <b>ID2D1ImageSource* imageSource</b></param>
	/// <param name="properties">_In_ <b>D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES* properties</b></param>
	/// <param name="transformedImageSource">_COM_Outptr_ <b>ID2D1TransformedImageSource** transformedImageSource</b></param>
	int CreateTransformedImageSource<T0, T1> (T0* imageSource, TransformedImageSourceProperties* properties, out T1* transformedImageSource) where T0 : unmanaged, IImageSource where T1 : unmanaged, ITransformedImageSource;
}

/// <summary>
/// Instance of <b>ID2D1DeviceContext2</b><br/>
/// D2D1_3.h
/// </summary>
...
//unsafe public readonly struct IDeviceContext2Obj : IDeviceContext2 {
	...
	static readonly Guid _guid = new (0x394ea6a3, 0x0c34, 0x4321, 0x95, 0x0b, 0x6c, 0xa2, 0x0f, 0x0b, 0xe6, 0xc7);
