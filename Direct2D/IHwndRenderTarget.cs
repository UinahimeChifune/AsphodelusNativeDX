...
/// <summary>
/// INTERFACE <b>ID2D1HwndRenderTarget</b> : ID2D1RenderTarget<br/>
/// D2D1.h
/// </summary>
unsafe public interface IHwndRenderTarget : IRenderTarget {
	/// <summary>
	/// STDMETHOD_ <b>D2D1_WINDOW_STATE ID2D1HwndRenderTarget::CheckWindowState ()</b><br/>
	/// </summary>
	WindowState CheckWindowState ();
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1HwndRenderTarget::Resize (D2D1_SIZE_U* pixelSize)</b><br/>
	/// </summary>
	/// <param name="pixelSize">_In_ <b>D2D1_SIZE_U* pixelSize</b></param>
	int Resize (Vector2U* pixelSize);
	/// <summary>
	/// STDMETHOD_ <b>HWND ID2D1HwndRenderTarget::GetHwnd ()</b><br/>
	/// </summary>
	IntPtr GetHwnd ();
}

/// <summary>
/// Instance of <b>ID2D1HwndRenderTarget</b><br/>
/// D2D1.h
/// </summary>
unsafe public readonly struct HwndRenderTarget : IHwndRenderTarget {
//unsafe public readonly struct IHwndRenderTargetObj : IHwndRenderTarget {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly HwndRenderTarget* GetCurrentPointer () => (HwndRenderTarget*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IHwndRenderTargetObj* GetCurrentPointer () => (IHwndRenderTargetObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x2cd90698, 0x12e2, 0x11dc, 0x9f, 0xed, 0x00, 0x11, 0x43, 0xa0, 0x55, 0xf9);
	...
	public readonly WindowState CheckWindowState () {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CheckWindowState (ptr);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int Resize (Vector2U* pixelSize) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->Resize (ptr, pixelSize);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly IntPtr GetHwnd () {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->GetHwnd (ptr);
		return hr;
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 57
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, WindowState> CheckWindowState;
		/// <summary>
		/// OFFSET 58
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, Vector2U*, int> Resize;
		/// <summary>
		/// OFFSET 59
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, IntPtr> GetHwnd;
	}
