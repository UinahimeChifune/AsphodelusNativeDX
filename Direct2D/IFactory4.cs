...
/// <summary>
/// INTERFACE <b>ID2D1Factory4</b> : ID2D1Factory3<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IFactory4 : IFactory3 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory4::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device3** d2dDevice3)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice3">_COM_Outptr_ <b>ID2D1Device3** d2dDevice3</b></param>
	int CreateDevice3<T0, T1> (T0* dxgiDevice, T1** d2dDevice3) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice3;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory4::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device3** d2dDevice3)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice3">_COM_Outptr_ <b>ID2D1Device3** d2dDevice3</b></param>
	int CreateDevice3<T0, T1> (T0* dxgiDevice, out T1* d2dDevice3) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice3;
}

/// <summary>
/// Instance of <b>ID2D1Factory4</b><br/>
/// D2D1_3.h
/// </summary>
...
//unsafe public readonly struct IFactory4Obj : IFactory4 {
	...
	static readonly Guid _guid = new (0xbd4ec2d2, 0x0662, 0x4bee, 0xba, 0x8e, 0x6f, 0x29, 0xf0, 0x32, 0xe0, 0x96);
