...
/// <summary>
/// INTERFACE <b>ID2D1CommandSink2</b> : ID2D1CommandSink1<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface ICommandSink2 : ICommandSink1 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1CommandSink2::DrawInk (ID2D1Ink* ink, ID2D1Brush* brush, ID2D1InkStyle* inkStyle)</b><br/>
	/// </summary>
	...
	int DrawInk<T0, T1, T2> (T0* ink, T1* brush, T2* inkStyle) where T0 : unmanaged, IInk where T1 : unmanaged, IBrush where T2 : unmanaged, IInkStyle;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1CommandSink2::DrawGradientMesh (ID2D1GradientMesh* gradientMesh)</b><br/>
	/// </summary>
	/// <param name="gradientMesh">_In_ <b>ID2D1GradientMesh* gradientMesh</b></param>
	int DrawGradientMesh<T0> (T0* gradientMesh) where T0 : unmanaged, IGradientMesh;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1CommandSink2::DrawGdiMetafile (ID2D1GdiMetafile* gdiMetafile, D2D1_RECT_F* destinationRectangle, D2D1_RECT_F* sourceRectangle)</b><br/>
	/// </summary>
	...
	int DrawGdiMetafile<T0> (T0* gdiMetafile, Vector4F* destinationRectangle, Vector4F* sourceRectangle) where T0 : unmanaged, IGdiMetafile;
}

/// <summary>
/// Instance of <b>ID2D1CommandSink2</b><br/>
/// D2D1_3.h
/// </summary>
unsafe public readonly struct CommandSink2 : ICommandSink2 {
//unsafe public readonly struct ICommandSink2Obj : ICommandSink2 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly CommandSink2* GetCurrentPointer () => (CommandSink2*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly ICommandSink2Obj* GetCurrentPointer () => (ICommandSink2Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x3bab440e, 0x417e, 0x47df, 0xa2, 0xe2, 0xbc, 0x0b, 0xe6, 0xa0, 0x09, 0x16);
