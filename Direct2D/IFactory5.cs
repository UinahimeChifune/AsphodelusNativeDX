...
/// <summary>
/// INTERFACE <b>ID2D1Factory5</b> : ID2D1Factory4<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IFactory5 : IFactory4 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory5::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device4** d2dDevice4)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice4">_COM_Outptr_ <b>ID2D1Device4** d2dDevice4</b></param>
	int CreateDevice4<T0, T1> (T0* dxgiDevice, T1** d2dDevice4) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice4;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory5::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device4** d2dDevice4)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice4">_COM_Outptr_ <b>ID2D1Device4** d2dDevice4</b></param>
	int CreateDevice4<T0, T1> (T0* dxgiDevice, out T1* d2dDevice4) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice4;
}

/// <summary>
/// Instance of <b>ID2D1Factory5</b><br/>
/// D2D1_3.h
/// </summary>
...
//unsafe public readonly struct IFactory5Obj : IFactory5 {
	...
	static readonly Guid _guid = new (0xc4349994, 0x838e, 0x4b0f, 0x8c, 0xab, 0x44, 0x99, 0x7d, 0x9e, 0xea, 0xcc);
