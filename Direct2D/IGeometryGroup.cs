...
/// <summary>
/// INTERFACE <b>ID2D1GeometryGroup</b> : ID2D1Geometry<br/>
/// D2D1.h
/// </summary>
unsafe public interface IGeometryGroup : IGeometry {
	/// <summary>
	/// STDMETHOD_ <b>D2D1_FILL_MODE ID2D1GeometryGroup::GetFillMode ()</b><br/>
	/// </summary>
	FillMode GetFillMode ();
	/// <summary>
	/// STDMETHOD_ <b>UINT32 ID2D1GeometryGroup::GetSourceGeometryCount ()</b><br/>
	/// </summary>
	uint GetSourceGeometryCount ();
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1GeometryGroup::GetSourceGeometries (ID2D1Geometry** geometries, UINT32 geometriesCount)</b><br/>
	/// </summary>
	/// <param name="geometries">_Out_writes_(geometriesCount) <b>ID2D1Geometry** geometries</b></param>
	/// <param name="geometriesCount"><b>UINT32 geometriesCount</b></param>
	void GetSourceGeometries<T0> (T0** geometries, uint geometriesCount) where T0 : unmanaged, IGeometry;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1GeometryGroup::GetSourceGeometries (ID2D1Geometry** geometries, UINT32 geometriesCount)</b><br/>
	/// </summary>
	/// <param name="geometries">_Out_writes_(geometriesCount) <b>ID2D1Geometry** geometries</b></param>
	/// <param name="geometriesCount"><b>UINT32 geometriesCount</b></param>
	void GetSourceGeometries<T0> (out T0* geometries, uint geometriesCount) where T0 : unmanaged, IGeometry;
}

/// <summary>
/// Instance of <b>ID2D1GeometryGroup</b><br/>
/// D2D1.h
/// </summary>
unsafe public readonly struct GeometryGroup : IGeometryGroup {
//unsafe public readonly struct IGeometryGroupObj : IGeometryGroup {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly GeometryGroup* GetCurrentPointer () => (GeometryGroup*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IGeometryGroupObj* GetCurrentPointer () => (IGeometryGroupObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x2cd906a6, 0x12e2, 0x11dc, 0x9f, 0xed, 0x00, 0x11, 0x43, 0xa0, 0x55, 0xf9);
	...
	public readonly FillMode GetFillMode () {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->GetFillMode (ptr);
		return hr;
	}
	...
	public readonly uint GetSourceGeometryCount () {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->GetSourceGeometryCount (ptr);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetSourceGeometries<T0> (T0** geometries, uint geometriesCount) where T0 : unmanaged, IGeometry {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->GetSourceGeometries (ptr, (void**) geometries, geometriesCount);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetSourceGeometries<T0> (out T0* geometries, uint geometriesCount) where T0 : unmanaged, IGeometry {
		fixed (T0** _geometries = &geometries) {
			var ptr = GetCurrentPointer ();
			((FunctionPointer*) ptr->_pointer)->GetSourceGeometries (ptr, (void**) _geometries, geometriesCount);
			return;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 17
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, FillMode> GetFillMode;
		/// <summary>
		/// OFFSET 18
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, uint> GetSourceGeometryCount;
		/// <summary>
		/// OFFSET 19
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void**, uint, void> GetSourceGeometries;
	}
