...
/// <summary>
/// INTERFACE <b>ID2D1EffectContext2</b> : ID2D1EffectContext1<br/>
/// D2D1EFFECTAUTHOR_1.h
/// </summary>
unsafe public interface IEffectContext2 : IEffectContext1 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1EffectContext2::CreateColorContextFromDxgiColorSpace (DXGI_COLOR_SPACE_TYPE colorSpace, ID2D1ColorContext1** colorContext)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1EffectContext2::CreateColorContextFromSimpleColorProfile (D2D1_SIMPLE_COLOR_PROFILE* simpleProfile, ID2D1ColorContext1** colorContext)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>ID2D1EffectContext2</b><br/>
/// D2D1EFFECTAUTHOR_1.h
/// </summary>
unsafe public readonly struct EffectContext2 : IEffectContext2 {
//unsafe public readonly struct IEffectContext2Obj : IEffectContext2 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly EffectContext2* GetCurrentPointer () => (EffectContext2*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IEffectContext2Obj* GetCurrentPointer () => (IEffectContext2Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x577ad2a0, 0x9fc7, 0x4dda, 0x8b, 0x18, 0xda, 0xb8, 0x10, 0x14, 0x00, 0x52);
