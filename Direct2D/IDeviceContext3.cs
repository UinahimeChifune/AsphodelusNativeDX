...
/// <summary>
/// INTERFACE <b>ID2D1DeviceContext3</b> : ID2D1DeviceContext2<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IDeviceContext3 : IDeviceContext2 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext3::CreateSpriteBatch (ID2D1SpriteBatch** spriteBatch)</b><br/>
	/// </summary>
	/// <param name="spriteBatch">_COM_Outptr_ <b>ID2D1SpriteBatch** spriteBatch</b></param>
	int CreateSpriteBatch<T0> (T0** spriteBatch) where T0 : unmanaged, ISpriteBatch;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext3::CreateSpriteBatch (ID2D1SpriteBatch** spriteBatch)</b><br/>
	/// </summary>
	/// <param name="spriteBatch">_COM_Outptr_ <b>ID2D1SpriteBatch** spriteBatch</b></param>
	int CreateSpriteBatch<T0> (out T0* spriteBatch) where T0 : unmanaged, ISpriteBatch;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext3::DrawSpriteBatch (ID2D1SpriteBatch* spriteBatch, UINT32 startIndex, UINT32 spriteCount, ID2D1Bitmap* bitmap, D2D1_BITMAP_INTERPOLATION_MODE interpolationMode, D2D1_SPRITE_OPTIONS spriteOptions)</b><br/>
	/// </summary>
	/// <param name="spriteBatch">_In_ <b>ID2D1SpriteBatch* spriteBatch</b></param>
	...
	/// <param name="spriteOptions"><b>D2D1_SPRITE_OPTIONS spriteOptions</b></param>
	void DrawSpriteBatch<T0, T1> (T0* spriteBatch, uint startIndex, uint spriteCount, T1* bitmap, BitmapInterpolationMode interpolationMode, SpriteOptions spriteOptions) where T0 : unmanaged, ISpriteBatch where T1 : unmanaged, IBitmap;
}

/// <summary>
/// Instance of <b>ID2D1DeviceContext3</b><br/>
/// D2D1_3.h
/// </summary>
...
//unsafe public readonly struct IDeviceContext3Obj : IDeviceContext3 {
	...
	static readonly Guid _guid = new (0x235a7496, 0x8351, 0x414c, 0xbc, 0xd4, 0x66, 0x72, 0xab, 0x2d, 0x8e, 0x00);
