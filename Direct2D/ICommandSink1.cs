...
/// <summary>
/// INTERFACE <b>ID2D1CommandSink1</b> : ID2D1CommandSink<br/>
/// D2D1_2.h
/// </summary>
unsafe public interface ICommandSink1 : ICommandSink {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1CommandSink1::SetPrimitiveBlend1 (D2D1_PRIMITIVE_BLEND primitiveBlend)</b><br/>
	/// </summary>
	/// <param name="primitiveBlend"><b>D2D1_PRIMITIVE_BLEND primitiveBlend</b></param>
	int SetPrimitiveBlend1 (PrimitiveBlend primitiveBlend);
}

/// <summary>
/// Instance of <b>ID2D1CommandSink1</b><br/>
/// D2D1_2.h
/// </summary>
unsafe public readonly struct CommandSink1 : ICommandSink1 {
//unsafe public readonly struct ICommandSink1Obj : ICommandSink1 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly CommandSink1* GetCurrentPointer () => (CommandSink1*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly ICommandSink1Obj* GetCurrentPointer () => (ICommandSink1Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x9eb767fd, 0x4269, 0x4467, 0xb8, 0xc2, 0xeb, 0x30, 0xcb, 0x30, 0x57, 0x43);
