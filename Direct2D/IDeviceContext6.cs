...
/// <summary>
/// INTERFACE <b>ID2D1DeviceContext6</b> : ID2D1DeviceContext5<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IDeviceContext6 : IDeviceContext5 {
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext6::BlendImage (ID2D1Image* image, D2D1_BLEND_MODE blendMode, D2D1_POINT_2F* targetOffset, D2D1_RECT_F* imageRectangle, D2D1_INTERPOLATION_MODE interpolationMode)</b><br/>
	/// </summary>
	/// <param name="image">_In_ <b>ID2D1Image* image</b></param>
	/// <param name="blendMode"><b>D2D1_BLEND_MODE blendMode</b></param>
	...
	void BlendImage<T0> (T0* image, BlendMode blendMode, Vector2F* targetOffset, Vector4F* imageRectangle, InterpolationMode interpolationMode) where T0 : unmanaged, IImage;
}

/// <summary>
/// Instance of <b>ID2D1DeviceContext6</b><br/>
/// D2D1_3.h
/// </summary>
unsafe public readonly struct DeviceContext6 : IDeviceContext6 {
//unsafe public readonly struct IDeviceContext6Obj : IDeviceContext6 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly DeviceContext6* GetCurrentPointer () => (DeviceContext6*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IDeviceContext6Obj* GetCurrentPointer () => (IDeviceContext6Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x985f7e37, 0x4ed0, 0x4a19, 0x98, 0xa3, 0x15, 0xb0, 0xed, 0xfd, 0xe3, 0x06);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void BlendImage<T0> (T0* image, BlendMode blendMode, Vector2F* targetOffset, Vector4F* imageRectangle, InterpolationMode interpolationMode) where T0 : unmanaged, IImage {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->BlendImage (ptr, image, blendMode, targetOffset, imageRectangle, interpolationMode);
		return;
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 119
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, BlendMode, Vector2F*, Vector4F*, InterpolationMode, void> BlendImage;
	}
