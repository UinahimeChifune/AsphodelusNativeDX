...
/// <summary>
/// INTERFACE <b>ID2D1Factory7</b> : ID2D1Factory6<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IFactory7 : IFactory6 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory7::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device6** d2dDevice6)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice6">_COM_Outptr_ <b>ID2D1Device6** d2dDevice6</b></param>
	int CreateDevice6<T0, T1> (T0* dxgiDevice, T1** d2dDevice6) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice6;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory7::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device6** d2dDevice6)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice6">_COM_Outptr_ <b>ID2D1Device6** d2dDevice6</b></param>
	int CreateDevice6<T0, T1> (T0* dxgiDevice, out T1* d2dDevice6) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice6;
}

/// <summary>
/// Instance of <b>ID2D1Factory7</b><br/>
/// D2D1_3.h
/// </summary>
...
//unsafe public readonly struct IFactory7Obj : IFactory7 {
	...
	static readonly Guid _guid = new (0xbdc2bdd3, 0xb96c, 0x4de6, 0xbd, 0xf7, 0x99, 0xd4, 0x74, 0x54, 0x54, 0xde);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice2<T0, T1> (T0* dxgiDevice, T1** d2dDevice2) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice2 {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice2 (ptr, dxgiDevice, (void**) d2dDevice2);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice2<T0, T1> (T0* dxgiDevice, out T1* d2dDevice2) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice2 {
		fixed (T1** _d2dDevice2 = &d2dDevice2) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice2 (ptr, dxgiDevice, (void**) _d2dDevice2);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice3<T0, T1> (T0* dxgiDevice, T1** d2dDevice3) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice3 {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice3 (ptr, dxgiDevice, (void**) d2dDevice3);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice3<T0, T1> (T0* dxgiDevice, out T1* d2dDevice3) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice3 {
		fixed (T1** _d2dDevice3 = &d2dDevice3) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice3 (ptr, dxgiDevice, (void**) _d2dDevice3);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice4<T0, T1> (T0* dxgiDevice, T1** d2dDevice4) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice4 {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice4 (ptr, dxgiDevice, (void**) d2dDevice4);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice4<T0, T1> (T0* dxgiDevice, out T1* d2dDevice4) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice4 {
		fixed (T1** _d2dDevice4 = &d2dDevice4) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice4 (ptr, dxgiDevice, (void**) _d2dDevice4);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice5<T0, T1> (T0* dxgiDevice, T1** d2dDevice5) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice5 {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice5 (ptr, dxgiDevice, (void**) d2dDevice5);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice5<T0, T1> (T0* dxgiDevice, out T1* d2dDevice5) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice5 {
		fixed (T1** _d2dDevice5 = &d2dDevice5) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice5 (ptr, dxgiDevice, (void**) _d2dDevice5);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice6<T0, T1> (T0* dxgiDevice, T1** d2dDevice6) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice6 {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice (ptr, dxgiDevice, (void**) d2dDevice6);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateDevice6<T0, T1> (T0* dxgiDevice, out T1* d2dDevice6) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice6 {
		fixed (T1** _d2dDevice6 = &d2dDevice6) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateDevice6 (ptr, dxgiDevice, (void**) _d2dDevice6);
			return hr;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 28
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void**, int> CreateDevice2;
		/// <summary>
		/// OFFSET 29
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void**, int> CreateDevice3;
		/// <summary>
		/// OFFSET 30
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void**, int> CreateDevice4;
		/// <summary>
		/// OFFSET 31
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void**, int> CreateDevice5;
		/// <summary>
		/// OFFSET 32
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void**, int> CreateDevice6;
	}
