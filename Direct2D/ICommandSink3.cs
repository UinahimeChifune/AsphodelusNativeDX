...
/// <summary>
/// INTERFACE <b>ID2D1CommandSink3</b> : ID2D1CommandSink2<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface ICommandSink3 : ICommandSink2 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1CommandSink3::DrawSpriteBatch (ID2D1SpriteBatch* spriteBatch, UINT32 startIndex, UINT32 spriteCount, ID2D1Bitmap* bitmap, D2D1_BITMAP_INTERPOLATION_MODE interpolationMode, D2D1_SPRITE_OPTIONS spriteOptions)</b><br/>
	/// </summary>
	...
	int DrawSpriteBatch<T0, T1> (T0* spriteBatch, uint startIndex, uint spriteCount, T1* bitmap, BitmapInterpolationMode interpolationMode, SpriteOptions spriteOptions) where T0 : unmanaged, ISpriteBatch where T1 : unmanaged, IBitmap;
}

/// <summary>
/// Instance of <b>ID2D1CommandSink3</b><br/>
/// D2D1_3.h
/// </summary>
unsafe public readonly struct CommandSink3 : ICommandSink3 {
//unsafe public readonly struct ICommandSink3Obj : ICommandSink3 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly CommandSink3* GetCurrentPointer () => (CommandSink3*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly ICommandSink3Obj* GetCurrentPointer () => (ICommandSink3Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x18079135, 0x4cf3, 0x4868, 0xbc, 0x8e, 0x06, 0x06, 0x7e, 0x6d, 0x24, 0x2d);
