...
/// <summary>
/// INTERFACE <b>ID2D1EllipseGeometry</b> : ID2D1Geometry<br/>
/// D2D1.h
/// </summary>
unsafe public interface IEllipseGeometry : IGeometry {
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1EllipseGeometry::GetEllipse (D2D1_ELLIPSE* ellipse)</b><br/>
	/// </summary>
	/// <param name="ellipse">_Out_ <b>D2D1_ELLIPSE* ellipse</b></param>
...
/// <summary>
/// Instance of <b>ID2D1EllipseGeometry</b><br/>
/// D2D1.h
/// </summary>
unsafe public readonly struct EllipseGeometry : IEllipseGeometry {
//unsafe public readonly struct IEllipseGeometryObj : IEllipseGeometry {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly EllipseGeometry* GetCurrentPointer () => (EllipseGeometry*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IEllipseGeometryObj* GetCurrentPointer () => (IEllipseGeometryObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x2cd906a4, 0x12e2, 0x11dc, 0x9f, 0xed, 0x00, 0x11, 0x43, 0xa0, 0x55, 0xf9);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetEllipse (Ellipse* ellipse) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->GetEllipse (ptr, ellipse);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetEllipse (out Ellipse ellipse) {
		fixed (Ellipse* _ellipse = &ellipse) {
			var ptr = GetCurrentPointer ();
			((FunctionPointer*) ptr->_pointer)->GetEllipse (ptr, _ellipse);
			return;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 17
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, Ellipse*, void> GetEllipse;
	}
