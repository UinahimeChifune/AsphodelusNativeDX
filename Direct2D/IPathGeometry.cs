...
/// <summary>
/// INTERFACE <b>ID2D1PathGeometry</b> : ID2D1Geometry<br/>
/// D2D1.h
/// </summary>
unsafe public interface IPathGeometry : IGeometry {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1PathGeometry::Open (ID2D1GeometrySink** geometrySink)</b><br/>
	/// </summary>
	/// <param name="geometrySink">_COM_Outptr_ <b>ID2D1GeometrySink** geometrySink</b></param>
	int Open<T0> (T0** geometrySink) where T0 : unmanaged, IGeometrySink;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1PathGeometry::Open (ID2D1GeometrySink** geometrySink)</b><br/>
	/// </summary>
	/// <param name="geometrySink">_COM_Outptr_ <b>ID2D1GeometrySink** geometrySink</b></param>
	int Open<T0> (out T0* geometrySink) where T0 : unmanaged, IGeometrySink;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1PathGeometry::Stream (ID2D1GeometrySink* geometrySink)</b><br/>
	/// </summary>
	/// <param name="geometrySink">_In_ <b>ID2D1GeometrySink* geometrySink</b></param>
	int Stream<T0> (T0* geometrySink) where T0 : unmanaged, IGeometrySink;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1PathGeometry::GetSegmentCount (UINT32* count)</b><br/>
	/// </summary>
	/// <param name="count">_Out_ <b>UINT32* count</b></param>
	int GetSegmentCount (uint* count);
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1PathGeometry::GetSegmentCount (UINT32* count)</b><br/>
	/// </summary>
	/// <param name="count">_Out_ <b>UINT32* count</b></param>
	int GetSegmentCount (out uint count);
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1PathGeometry::GetFigureCount (UINT32* count)</b><br/>
	/// </summary>
	/// <param name="count">_Out_ <b>UINT32* count</b></param>
	int GetFigureCount (uint* count);
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1PathGeometry::GetFigureCount (UINT32* count)</b><br/>
	/// </summary>
	/// <param name="count">_Out_ <b>UINT32* count</b></param>
	int GetFigureCount (out uint count);
}

/// <summary>
/// Instance of <b>ID2D1PathGeometry</b><br/>
/// D2D1.h
/// </summary>
unsafe public readonly struct PathGeometry : IPathGeometry {
//unsafe public readonly struct IPathGeometryObj : IPathGeometry {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly PathGeometry* GetCurrentPointer () => (PathGeometry*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IPathGeometryObj* GetCurrentPointer () => (IPathGeometryObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x2cd906a5, 0x12e2, 0x11dc, 0x9f, 0xed, 0x00, 0x11, 0x43, 0xa0, 0x55, 0xf9);
