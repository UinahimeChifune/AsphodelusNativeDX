...
/// <summary>
/// INTERFACE <b>ID2D1DeviceContext</b> : ID2D1RenderTarget<br/>
/// D2D1_1.h
/// </summary>
unsafe public interface IDeviceContext : IRenderTarget {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateBitmap (D2D1_SIZE_U size, void* sourceData, UINT32 pitch, D2D1_BITMAP_PROPERTIES1* bitmapProperties, ID2D1Bitmap1** bitmap)</b><br/>
	/// </summary>
	/// <param name="size"><b>D2D1_SIZE_U size</b></param>
	/// <param name="sourceData">_In_opt_ <b>void* sourceData</b></param>
	/// <param name="pitch"><b>UINT32 pitch</b></param>
	/// <param name="bitmapProperties">_In_ <b>D2D1_BITMAP_PROPERTIES1* bitmapProperties</b></param>
	/// <param name="bitmap">_COM_Outptr_ <b>ID2D1Bitmap1** bitmap</b></param>
	int CreateBitmap<T0> (Vector2U size, void* sourceData, uint pitch, BitmapProperties1* bitmapProperties, T0** bitmap) where T0 : unmanaged, IBitmap1;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateBitmap (D2D1_SIZE_U size, void* sourceData, UINT32 pitch, D2D1_BITMAP_PROPERTIES1* bitmapProperties, ID2D1Bitmap1** bitmap)</b><br/>
	/// </summary>
	/// <param name="size"><b>D2D1_SIZE_U size</b></param>
	...
	/// <param name="bitmapProperties">_In_ <b>D2D1_BITMAP_PROPERTIES1* bitmapProperties</b></param>
	/// <param name="bitmap">_COM_Outptr_ <b>ID2D1Bitmap1** bitmap</b></param>
	int CreateBitmap<T0> (Vector2U size, void* sourceData, uint pitch, BitmapProperties1* bitmapProperties, out T0* bitmap) where T0 : unmanaged, IBitmap1;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateBitmapFromWicBitmap (IWICBitmapSource* wicBitmapSource, D2D1_BITMAP_PROPERTIES1* bitmapProperties, ID2D1Bitmap1** bitmap)</b><br/>
	/// </summary>
	/// <param name="wicBitmapSource">_In_ <b>IWICBitmapSource* wicBitmapSource</b></param>
	/// <param name="bitmapProperties">_In_opt_ <b>D2D1_BITMAP_PROPERTIES1* bitmapProperties</b></param>
	/// <param name="bitmap">_COM_Outptr_ <b>ID2D1Bitmap1** bitmap</b></param>
	int CreateBitmapFromWicBitmap<T0, T1> (T0* wicBitmapSource, BitmapProperties1* bitmapProperties, T1** bitmap) where T0 : unmanaged, WIC.IBitmapSource where T1 : unmanaged, IBitmap1;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateBitmapFromWicBitmap (IWICBitmapSource* wicBitmapSource, D2D1_BITMAP_PROPERTIES1* bitmapProperties, ID2D1Bitmap1** bitmap)</b><br/>
	/// </summary>
	/// <param name="wicBitmapSource">_In_ <b>IWICBitmapSource* wicBitmapSource</b></param>
	/// <param name="bitmapProperties">_In_opt_ <b>D2D1_BITMAP_PROPERTIES1* bitmapProperties</b></param>
	/// <param name="bitmap">_COM_Outptr_ <b>ID2D1Bitmap1** bitmap</b></param>
	int CreateBitmapFromWicBitmap<T0, T1> (T0* wicBitmapSource, BitmapProperties1* bitmapProperties, out T1* bitmap) where T0 : unmanaged, WIC.IBitmapSource where T1 : unmanaged, IBitmap1;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateColorContext (D2D1_COLOR_SPACE space, BYTE* profile, UINT32 profileSize, ID2D1ColorContext** colorContext)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateColorContextFromFilename (PCWSTR filename, ID2D1ColorContext** colorContext)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateColorContextFromWicColorContext (IWICColorContext* wicColorContext, ID2D1ColorContext** colorContext)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateBitmapFromDxgiSurface (IDXGISurface* surface, D2D1_BITMAP_PROPERTIES1* bitmapProperties, ID2D1Bitmap1** bitmap)</b><br/>
	/// </summary>
	/// <param name="surface">_In_ <b>IDXGISurface* surface</b></param>
	/// <param name="bitmapProperties">_In_opt_ <b>D2D1_BITMAP_PROPERTIES1* bitmapProperties</b></param>
	/// <param name="bitmap">_COM_Outptr_ <b>ID2D1Bitmap1** bitmap</b></param>
	int CreateBitmapFromDxgiSurface<T0, T1> (T0* surface, BitmapProperties1* bitmapProperties, T1** bitmap) where T0 : unmanaged, DXGI.ISurface where T1 : unmanaged, IBitmap1;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateBitmapFromDxgiSurface (IDXGISurface* surface, D2D1_BITMAP_PROPERTIES1* bitmapProperties, ID2D1Bitmap1** bitmap)</b><br/>
	/// </summary>
	/// <param name="surface">_In_ <b>IDXGISurface* surface</b></param>
	/// <param name="bitmapProperties">_In_opt_ <b>D2D1_BITMAP_PROPERTIES1* bitmapProperties</b></param>
	/// <param name="bitmap">_COM_Outptr_ <b>ID2D1Bitmap1** bitmap</b></param>
	int CreateBitmapFromDxgiSurface<T0, T1> (T0* surface, BitmapProperties1* bitmapProperties, out T1* bitmap) where T0 : unmanaged, DXGI.ISurface where T1 : unmanaged, IBitmap1;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateEffect (REFCLSID effectId, ID2D1Effect** effect)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateGradientStopCollection (D2D1_GRADIENT_STOP* straightAlphaGradientStops, UINT32 straightAlphaGradientStopsCount, D2D1_COLOR_SPACE preInterpolationSpace, D2D1_COLOR_SPACE postInterpolationSpace, D2D1_BUFFER_PRECISION bufferPrecision, D2D1_EXTEND_MODE extendMode, D2D1_COLOR_INTERPOLATION_MODE colorInterpolationMode, ID2D1GradientStopCollection1** gradientStopCollection1)</b><br/>
	/// </summary>
	/// <param name="straightAlphaGradientStops">_In_reads_(straightAlphaGradientStopsCount) <b>D2D1_GRADIENT_STOP* straightAlphaGradientStops</b></param>
	/// <param name="straightAlphaGradientStopsCount">_In_range_(>=,1) <b>UINT32 straightAlphaGradientStopsCount</b></param>
	/// <param name="preInterpolationSpace"><b>D2D1_COLOR_SPACE preInterpolationSpace</b></param>
	/// <param name="postInterpolationSpace"><b>D2D1_COLOR_SPACE postInterpolationSpace</b></param>
	...
	/// <param name="colorInterpolationMode"><b>D2D1_COLOR_INTERPOLATION_MODE colorInterpolationMode</b></param>
	/// <param name="gradientStopCollection1">_COM_Outptr_ <b>ID2D1GradientStopCollection1** gradientStopCollection1</b></param>
	...
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateImageBrush (ID2D1Image* image, D2D1_IMAGE_BRUSH_PROPERTIES* imageBrushProperties, D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1ImageBrush** imageBrush)</b><br/>
	/// </summary>
	/// <param name="image">_In_opt_ <b>ID2D1Image* image</b></param>
	/// <param name="imageBrushProperties">_In_ <b>D2D1_IMAGE_BRUSH_PROPERTIES* imageBrushProperties</b></param>
	/// <param name="brushProperties">_In_opt_ <b>D2D1_BRUSH_PROPERTIES* brushProperties</b></param>
	/// <param name="imageBrush">_COM_Outptr_ <b>ID2D1ImageBrush** imageBrush</b></param>
	int CreateImageBrush<T0, T1> (T0* image, ImageBrushProperties* imageBrushProperties, BrushProperties* brushProperties, T1** imageBrush) where T0 : unmanaged, IImage where T1 : unmanaged, IImageBrush;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateImageBrush (ID2D1Image* image, D2D1_IMAGE_BRUSH_PROPERTIES* imageBrushProperties, D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1ImageBrush** imageBrush)</b><br/>
	/// </summary>
	/// <param name="image">_In_opt_ <b>ID2D1Image* image</b></param>
	...
	/// <param name="brushProperties">_In_opt_ <b>D2D1_BRUSH_PROPERTIES* brushProperties</b></param>
	/// <param name="imageBrush">_COM_Outptr_ <b>ID2D1ImageBrush** imageBrush</b></param>
	int CreateImageBrush<T0, T1> (T0* image, ImageBrushProperties* imageBrushProperties, BrushProperties* brushProperties, out T1* imageBrush) where T0 : unmanaged, IImage where T1 : unmanaged, IImageBrush;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateBitmapBrush (ID2D1Bitmap* bitmap, D2D1_BITMAP_BRUSH_PROPERTIES1* bitmapBrushProperties, D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1BitmapBrush1** bitmapBrush)</b><br/>
	/// </summary>
	/// <param name="bitmap">_In_opt_ <b>ID2D1Bitmap* bitmap</b></param>
	/// <param name="bitmapBrushProperties">_In_opt_ <b>D2D1_BITMAP_BRUSH_PROPERTIES1* bitmapBrushProperties</b></param>
	/// <param name="brushProperties">_In_opt_ <b>D2D1_BRUSH_PROPERTIES* brushProperties</b></param>
	/// <param name="bitmapBrush">_COM_Outptr_ <b>ID2D1BitmapBrush1** bitmapBrush</b></param>
	int CreateBitmapBrush<T0, T1> (T0* bitmap, BitmapBrushProperties1* bitmapBrushProperties, BrushProperties* brushProperties, T1** bitmapBrush) where T0 : unmanaged, IBitmap where T1 : unmanaged, IBitmapBrush1;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateBitmapBrush (ID2D1Bitmap* bitmap, D2D1_BITMAP_BRUSH_PROPERTIES1* bitmapBrushProperties, D2D1_BRUSH_PROPERTIES* brushProperties, ID2D1BitmapBrush1** bitmapBrush)</b><br/>
	/// </summary>
	/// <param name="bitmap">_In_opt_ <b>ID2D1Bitmap* bitmap</b></param>
	...
	/// <param name="brushProperties">_In_opt_ <b>D2D1_BRUSH_PROPERTIES* brushProperties</b></param>
	/// <param name="bitmapBrush">_COM_Outptr_ <b>ID2D1BitmapBrush1** bitmapBrush</b></param>
	int CreateBitmapBrush<T0, T1> (T0* bitmap, BitmapBrushProperties1* bitmapBrushProperties, BrushProperties* brushProperties, out T1* bitmapBrush) where T0 : unmanaged, IBitmap where T1 : unmanaged, IBitmapBrush1;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateCommandList (ID2D1CommandList** commandList)</b><br/>
	/// </summary>
	/// <param name="commandList">_COM_Outptr_ <b>ID2D1CommandList** commandList</b></param>
	int CreateCommandList<T0> (T0** commandList) where T0 : unmanaged, ICommandList;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::CreateCommandList (ID2D1CommandList** commandList)</b><br/>
	/// </summary>
	/// <param name="commandList">_COM_Outptr_ <b>ID2D1CommandList** commandList</b></param>
	int CreateCommandList<T0> (out T0* commandList) where T0 : unmanaged, ICommandList;
	/// <summary>
	/// STDMETHOD_ <b>BOOL ID2D1DeviceContext::IsDxgiFormatSupported (DXGI_FORMAT format)</b><br/>
	/// </summary>
	/// <param name="format"><b>DXGI_FORMAT format</b></param>
	bool IsDxgiFormatSupported (DXGI.Format format);
	/// <summary>
	/// STDMETHOD_ <b>BOOL ID2D1DeviceContext::IsBufferPrecisionSupported (D2D1_BUFFER_PRECISION bufferPrecision)</b><br/>
	/// </summary>
	/// <param name="bufferPrecision"><b>D2D1_BUFFER_PRECISION bufferPrecision</b></param>
	bool IsBufferPrecisionSupported (BufferPrecision bufferPrecision);
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetImageLocalBounds (ID2D1Image* image, D2D1_RECT_F* localBounds)</b><br/>
	/// </summary>
	/// <param name="image">_In_ <b>ID2D1Image* image</b></param>
	/// <param name="localBounds">_Out_ <b>D2D1_RECT_F* localBounds</b></param>
	int GetImageLocalBounds<T0> (T0* image, Vector4F* localBounds) where T0 : unmanaged, IImage;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetImageLocalBounds (ID2D1Image* image, D2D1_RECT_F* localBounds)</b><br/>
	/// </summary>
	/// <param name="image">_In_ <b>ID2D1Image* image</b></param>
	/// <param name="localBounds">_Out_ <b>D2D1_RECT_F* localBounds</b></param>
	int GetImageLocalBounds<T0> (T0* image, out Vector4F localBounds) where T0 : unmanaged, IImage;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetImageWorldBounds (ID2D1Image* image, D2D1_RECT_F* worldBounds)</b><br/>
	/// </summary>
	/// <param name="image">_In_ <b>ID2D1Image* image</b></param>
	/// <param name="worldBounds">_Out_ <b>D2D1_RECT_F* worldBounds</b></param>
	int GetImageWorldBounds<T0> (T0* image, Vector4F* worldBounds) where T0 : unmanaged, IImage;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetImageWorldBounds (ID2D1Image* image, D2D1_RECT_F* worldBounds)</b><br/>
	/// </summary>
	/// <param name="image">_In_ <b>ID2D1Image* image</b></param>
	/// <param name="worldBounds">_Out_ <b>D2D1_RECT_F* worldBounds</b></param>
	int GetImageWorldBounds<T0> (T0* image, out Vector4F worldBounds) where T0 : unmanaged, IImage;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetGlyphRunWorldBounds (D2D1_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, DWRITE_MEASURING_MODE measuringMode, D2D1_RECT_F* bounds)</b><br/>
	/// </summary>
	...
	int GetGlyphRunWorldBounds (Vector2F baselineOrigin, DirectWrite.GlyphRun* glyphRun, DirectWrite.MeasuringMode measuringMode, Vector4F* bounds);
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetGlyphRunWorldBounds (D2D1_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, DWRITE_MEASURING_MODE measuringMode, D2D1_RECT_F* bounds)</b><br/>
	/// </summary>
	/// <param name="baselineOrigin"><b>D2D1_POINT_2F baselineOrigin</b></param>
	...
	/// <param name="measuringMode"><b>DWRITE_MEASURING_MODE measuringMode</b></param>
	/// <param name="bounds">_Out_ <b>D2D1_RECT_F* bounds</b></param>
	int GetGlyphRunWorldBounds (Vector2F baselineOrigin, DirectWrite.GlyphRun* glyphRun, DirectWrite.MeasuringMode measuringMode, out Vector4F bounds);
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::GetDevice (ID2D1Device** device)</b><br/>
	/// </summary>
	/// <param name="device">_Outptr_ <b>ID2D1Device** device</b></param>
	void GetDevice<T0> (T0** device) where T0 : unmanaged, IDevice;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::GetDevice (ID2D1Device** device)</b><br/>
	/// </summary>
	/// <param name="device">_Outptr_ <b>ID2D1Device** device</b></param>
	void GetDevice<T0> (out T0* device) where T0 : unmanaged, IDevice;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::SetTarget (ID2D1Image* image)</b><br/>
	/// </summary>
	/// <param name="image">_In_opt_ <b>ID2D1Image* image</b></param>
	void SetTarget<T0> (T0* image) where T0 : unmanaged, IImage;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::GetTarget (ID2D1Image** image)</b><br/>
	/// </summary>
	/// <param name="image">_Outptr_result_maybenull_ <b>ID2D1Image** image</b></param>
	void GetTarget<T0> (T0** image) where T0 : unmanaged, IImage;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::GetTarget (ID2D1Image** image)</b><br/>
	/// </summary>
	/// <param name="image">_Outptr_result_maybenull_ <b>ID2D1Image** image</b></param>
	void GetTarget<T0> (out T0* image) where T0 : unmanaged, IImage;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::SetRenderingControls (D2D1_RENDERING_CONTROLS* renderingControls)</b><br/>
	/// </summary>
	/// <param name="renderingControls">_In_ <b>D2D1_RENDERING_CONTROLS* renderingControls</b></param>
	void SetRenderingControls (RenderingControls* renderingControls);
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::GetRenderingControls (D2D1_RENDERING_CONTROLS* renderingControls)</b><br/>
	/// </summary>
	/// <param name="renderingControls">_Out_ <b>D2D1_RENDERING_CONTROLS* renderingControls</b></param>
	void GetRenderingControls (RenderingControls* renderingControls);
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::GetRenderingControls (D2D1_RENDERING_CONTROLS* renderingControls)</b><br/>
	/// </summary>
	/// <param name="renderingControls">_Out_ <b>D2D1_RENDERING_CONTROLS* renderingControls</b></param>
	void GetRenderingControls (out RenderingControls renderingControls);
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::SetPrimitiveBlend (D2D1_PRIMITIVE_BLEND primitiveBlend)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHOD_ <b>D2D1_PRIMITIVE_BLEND ID2D1DeviceContext::GetPrimitiveBlend ()</b><br/>
	/// </summary>
	PrimitiveBlend GetPrimitiveBlend ();
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::SetUnitMode (D2D1_UNIT_MODE unitMode)</b><br/>
	/// </summary>
	/// <param name="unitMode"><b>D2D1_UNIT_MODE unitMode</b></param>
	void SetUnitMode (UnitMode unitMode);
	/// <summary>
	/// STDMETHOD_ <b>D2D1_UNIT_MODE ID2D1DeviceContext::GetUnitMode ()</b><br/>
	/// </summary>
	UnitMode GetUnitMode ();
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::DrawGlyphRun (D2D1_POINT_2F baselineOrigin, DWRITE_GLYPH_RUN* glyphRun, DWRITE_GLYPH_RUN_DESCRIPTION* glyphRunDescription, ID2D1Brush* foregroundBrush, DWRITE_MEASURING_MODE measuringMode)</b><br/>
	/// </summary>
	/// <param name="baselineOrigin"><b>D2D1_POINT_2F baselineOrigin</b></param>
	/// <param name="glyphRun">_In_ <b>DWRITE_GLYPH_RUN* glyphRun</b></param>
	...
	/// <param name="measuringMode"><b>DWRITE_MEASURING_MODE measuringMode</b></param>
	void DrawGlyphRun<T0> (Vector2F baselineOrigin, DirectWrite.GlyphRun* glyphRun, DirectWrite.GlyphRunDescription* glyphRunDescription, T0* foregroundBrush, DirectWrite.MeasuringMode measuringMode) where T0 : unmanaged, IBrush;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::DrawImage (ID2D1Image* image, D2D1_POINT_2F* targetOffset, D2D1_RECT_F* imageRectangle, D2D1_INTERPOLATION_MODE interpolationMode, D2D1_COMPOSITE_MODE compositeMode)</b><br/>
	/// </summary>
	/// <param name="image">_In_ <b>ID2D1Image* image</b></param>
	...
	void DrawImage<T0> (T0* image, Vector2F* targetOffset, Vector4F* imageRectangle, InterpolationMode interpolationMode, CompositeMode compositeMode) where T0 : unmanaged, IImage;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::DrawGdiMetafile (ID2D1GdiMetafile* gdiMetafile, D2D1_POINT_2F* targetOffset)</b><br/>
	/// </summary>
	/// <param name="gdiMetafile">_In_ <b>ID2D1GdiMetafile* gdiMetafile</b></param>
	/// <param name="targetOffset">_In_opt_ <b>D2D1_POINT_2F* targetOffset</b></param>
	void DrawGdiMetafile<T0> (T0* gdiMetafile, Vector2F* targetOffset) where T0 : unmanaged, IGdiMetafile;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::DrawBitmap (ID2D1Bitmap* bitmap, D2D1_RECT_F* destinationRectangle, FLOAT opacity, D2D1_INTERPOLATION_MODE interpolationMode, D2D1_RECT_F* sourceRectangle, D2D1_MATRIX_4X4_F* perspectiveTransform)</b><br/>
	/// </summary>
	...
	void DrawBitmap<T0> (T0* bitmap, Vector4F* destinationRectangle, float opacity, InterpolationMode interpolationMode, Vector4F* sourceRectangle, Matrix4x4F* perspectiveTransform) where T0 : unmanaged, IBitmap;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::PushLayer (D2D1_LAYER_PARAMETERS1* layerParameters, ID2D1Layer* layer)</b><br/>
	/// </summary>
	/// <param name="layerParameters">_In_ <b>D2D1_LAYER_PARAMETERS1* layerParameters</b></param>
	/// <param name="layer">_In_opt_ <b>ID2D1Layer* layer</b></param>
	void PushLayer<T0> (LayerParameters1* layerParameters, T0* layer) where T0 : unmanaged, ILayer;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::InvalidateEffectInputRectangle (ID2D1Effect* effect, UINT32 input, D2D1_RECT_F* inputRectangle)</b><br/>
	/// </summary>
	/// <param name="effect">_In_ <b>ID2D1Effect* effect</b></param>
	/// <param name="input"><b>UINT32 input</b></param>
	/// <param name="inputRectangle">_In_ <b>D2D1_RECT_F* inputRectangle</b></param>
	int InvalidateEffectInputRectangle<T0> (T0* effect, uint input, Vector4F* inputRectangle) where T0 : unmanaged, IEffect;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetEffectInvalidRectangleCount (ID2D1Effect* effect, UINT32* rectangleCount)</b><br/>
	/// </summary>
	/// <param name="effect">_In_ <b>ID2D1Effect* effect</b></param>
	/// <param name="rectangleCount">_Out_ <b>UINT32* rectangleCount</b></param>
	int GetEffectInvalidRectangleCount<T0> (T0* effect, uint* rectangleCount) where T0 : unmanaged, IEffect;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetEffectInvalidRectangleCount (ID2D1Effect* effect, UINT32* rectangleCount)</b><br/>
	/// </summary>
	/// <param name="effect">_In_ <b>ID2D1Effect* effect</b></param>
	/// <param name="rectangleCount">_Out_ <b>UINT32* rectangleCount</b></param>
	int GetEffectInvalidRectangleCount<T0> (T0* effect, out uint rectangleCount) where T0 : unmanaged, IEffect;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetEffectInvalidRectangles (ID2D1Effect* effect, D2D1_RECT_F* rectangles, UINT32 rectanglesCount)</b><br/>
	/// </summary>
	/// <param name="effect">_In_ <b>ID2D1Effect* effect</b></param>
	/// <param name="rectangles">_Out_writes_(rectanglesCount) <b>D2D1_RECT_F* rectangles</b></param>
	/// <param name="rectanglesCount"><b>UINT32 rectanglesCount</b></param>
	int GetEffectInvalidRectangles<T0> (T0* effect, Vector4F* rectangles, uint rectanglesCount) where T0 : unmanaged, IEffect;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1DeviceContext::GetEffectRequiredInputRectangles (ID2D1Effect* renderEffect, D2D1_RECT_F* renderImageRectangle, D2D1_EFFECT_INPUT_DESCRIPTION* inputDescriptions, D2D1_RECT_F* requiredInputRects, UINT32 inputCount)</b><br/>
	/// </summary>
	/// <param name="renderEffect">_In_ <b>ID2D1Effect* renderEffect</b></param>
	/// <param name="renderImageRectangle">_In_opt_ <b>D2D1_RECT_F* renderImageRectangle</b></param>
	/// <param name="inputDescriptions">_In_reads_(inputCount) <b>D2D1_EFFECT_INPUT_DESCRIPTION* inputDescriptions</b></param>
	/// <param name="requiredInputRects">_Out_writes_(inputCount) <b>D2D1_RECT_F* requiredInputRects</b></param>
	/// <param name="inputCount"><b>UINT32 inputCount</b></param>
	int GetEffectRequiredInputRectangles<T0> (T0* renderEffect, Vector4F* renderImageRectangle, EffectInputDescription* inputDescriptions, Vector4F* requiredInputRects, uint inputCount) where T0 : unmanaged, IEffect;
	/// <summary>
	/// STDMETHOD_ <b>void ID2D1DeviceContext::FillOpacityMask (ID2D1Bitmap* opacityMask, ID2D1Brush* brush, D2D1_RECT_F* destinationRectangle, D2D1_RECT_F* sourceRectangle)</b><br/>
	/// </summary>
	/// <param name="opacityMask">_In_ <b>ID2D1Bitmap* opacityMask</b></param>
	/// <param name="brush">_In_ <b>ID2D1Brush* brush</b></param>
	/// <param name="destinationRectangle">_In_opt_ <b>D2D1_RECT_F* destinationRectangle</b></param>
	/// <param name="sourceRectangle">_In_opt_ <b>D2D1_RECT_F* sourceRectangle</b></param>
	void FillOpacityMask<T0, T1> (T0* opacityMask, T1* brush, Vector4F* destinationRectangle, Vector4F* sourceRectangle) where T0 : unmanaged, IBitmap where T1 : unmanaged, IBrush;
}

/// <summary>
/// Instance of <b>ID2D1DeviceContext</b><br/>
/// D2D1_1.h
/// </summary>
...
//unsafe public readonly struct IDeviceContextObj : IDeviceContext {
	...
	static readonly Guid _guid = new (0xe8f7fe7a, 0x191c, 0x466d, 0xad, 0x95, 0x97, 0x56, 0x78, 0xbd, 0xa9, 0x98);
