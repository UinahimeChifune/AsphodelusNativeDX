...
/// <summary>
/// INTERFACE <b>ID2D1Factory3</b> : ID2D1Factory2<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IFactory3 : IFactory2 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory3::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device2** d2dDevice2)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice2">_COM_Outptr_ <b>ID2D1Device2** d2dDevice2</b></param>
	int CreateDevice2<T0, T1> (T0* dxgiDevice, T1** d2dDevice2) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice2;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Factory3::CreateDevice (IDXGIDevice* dxgiDevice, ID2D1Device2** d2dDevice2)</b><br/>
	/// </summary>
	/// <param name="dxgiDevice">_In_ <b>IDXGIDevice* dxgiDevice</b></param>
	/// <param name="d2dDevice2">_COM_Outptr_ <b>ID2D1Device2** d2dDevice2</b></param>
	int CreateDevice2<T0, T1> (T0* dxgiDevice, out T1* d2dDevice2) where T0 : unmanaged, DXGI.IDevice where T1 : unmanaged, IDevice2;
}

/// <summary>
/// Instance of <b>ID2D1Factory3</b><br/>
/// D2D1_3.h
/// </summary>
...
//unsafe public readonly struct IFactory3Obj : IFactory3 {
	...
	static readonly Guid _guid = new (0x0869759f, 0x4f00, 0x413f, 0xb0, 0x3e, 0x2b, 0xda, 0x45, 0x40, 0x4d, 0x0f);
