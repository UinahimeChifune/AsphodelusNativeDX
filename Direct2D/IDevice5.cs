...
/// <summary>
/// INTERFACE <b>ID2D1Device5</b> : ID2D1Device4<br/>
/// D2D1_3.h
/// </summary>
unsafe public interface IDevice5 : IDevice4 {
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Device5::CreateDeviceContext (D2D1_DEVICE_CONTEXT_OPTIONS options, ID2D1DeviceContext5** deviceContext5)</b><br/>
	/// </summary>
	/// <param name="options"><b>D2D1_DEVICE_CONTEXT_OPTIONS options</b></param>
	/// <param name="deviceContext5">_COM_Outptr_ <b>ID2D1DeviceContext5** deviceContext5</b></param>
	int CreateDeviceContext5<T0> (DeviceContextOptions options, T0** deviceContext5) where T0 : unmanaged, IDeviceContext5;
	/// <summary>
	/// STDMETHOD <b>HRESULT ID2D1Device5::CreateDeviceContext (D2D1_DEVICE_CONTEXT_OPTIONS options, ID2D1DeviceContext5** deviceContext5)</b><br/>
	/// </summary>
	/// <param name="options"><b>D2D1_DEVICE_CONTEXT_OPTIONS options</b></param>
	/// <param name="deviceContext5">_COM_Outptr_ <b>ID2D1DeviceContext5** deviceContext5</b></param>
	int CreateDeviceContext5<T0> (DeviceContextOptions options, out T0* deviceContext5) where T0 : unmanaged, IDeviceContext5;
}

/// <summary>
/// Instance of <b>ID2D1Device5</b><br/>
/// D2D1_3.h
/// </summary>
...
//unsafe public readonly struct IDevice5Obj : IDevice5 {
	...
	static readonly Guid _guid = new (0xd55ba0a4, 0x6405, 0x4694, 0xae, 0xf5, 0x08, 0xee, 0x1a, 0x43, 0x58, 0xb4);
