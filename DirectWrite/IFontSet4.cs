...
/// <summary>
/// INTERFACE <b>IDWriteFontSet4</b> : IDWriteFontSet3<br/>
/// DWRITE_3.h
/// </summary>
unsafe public interface IFontSet4 : IFontSet3 {
	/// <summary>
	/// STDMETHOD_ <b>UINT32 IDWriteFontSet4::ConvertWeightStretchStyleToFontAxisValues (DWRITE_FONT_AXIS_VALUE* inputAxisValues, UINT32 inputAxisCount, DWRITE_FONT_WEIGHT fontWeight, DWRITE_FONT_STRETCH fontStretch, DWRITE_FONT_STYLE fontStyle, float fontSize, DWRITE_FONT_AXIS_VALUE* outputAxisValues)</b><br/>
	/// </summary>
	/// <param name="inputAxisValues">_In_reads_opt_(inputAxisCount) <b>DWRITE_FONT_AXIS_VALUE* inputAxisValues</b></param>
	/// <param name="inputAxisCount"><b>UINT32 inputAxisCount</b></param>
	...
	/// <param name="outputAxisValues">_Out_writes_to_(DWRITE_STANDARD_FONT_AXIS_COUNT, return) <b>DWRITE_FONT_AXIS_VALUE* outputAxisValues</b></param>
	...
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontSet4::GetMatchingFonts (WCHAR* familyName, DWRITE_FONT_AXIS_VALUE* fontAxisValues, UINT32 fontAxisValueCount, DWRITE_FONT_SIMULATIONS allowedSimulations, IDWriteFontSet4** matchingFonts)</b><br/>
	/// </summary>
	...
	/// <param name="allowedSimulations"><b>DWRITE_FONT_SIMULATIONS allowedSimulations</b></param>
	/// <param name="matchingFonts">_COM_Outptr_ <b>IDWriteFontSet4** matchingFonts</b></param>
	int GetMatchingFonts<T0> (char* familyName, FontAxisValue* fontAxisValues, uint fontAxisValueCount, FontSimulations allowedSimulations, T0** matchingFonts) where T0 : unmanaged, IFontSet4;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontSet4::GetMatchingFonts (WCHAR* familyName, DWRITE_FONT_AXIS_VALUE* fontAxisValues, UINT32 fontAxisValueCount, DWRITE_FONT_SIMULATIONS allowedSimulations, IDWriteFontSet4** matchingFonts)</b><br/>
	/// </summary>
	/// <param name="familyName">_In_z_ <b>WCHAR* familyName</b></param>
	...
	/// <param name="allowedSimulations"><b>DWRITE_FONT_SIMULATIONS allowedSimulations</b></param>
	/// <param name="matchingFonts">_COM_Outptr_ <b>IDWriteFontSet4** matchingFonts</b></param>
	int GetMatchingFonts<T0> (char* familyName, FontAxisValue* fontAxisValues, uint fontAxisValueCount, FontSimulations allowedSimulations, out T0* matchingFonts) where T0 : unmanaged, IFontSet4;
}

/// <summary>
/// Instance of <b>IDWriteFontSet4</b><br/>
/// DWRITE_3.h
/// </summary>
unsafe public readonly struct FontSet4 : IFontSet4 {
//unsafe public readonly struct IFontSet4Obj : IFontSet4 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly FontSet4* GetCurrentPointer () => (FontSet4*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IFontSet4Obj* GetCurrentPointer () => (IFontSet4Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xeec175fc, 0xbea9, 0x4c86, 0x8b, 0x53, 0xcc, 0xbd, 0xd7, 0xdf, 0x0c, 0x82);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly uint ConvertWeightStretchStyleToFontAxisValues (FontAxisValue* inputAxisValues, uint inputAxisCount, FontWeight fontWeight, FontStretch fontStretch, FontStyle fontStyle, float fontSize, FontAxisValue* outputAxisValues) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->ConvertWeightStretchStyleToFontAxisValues (ptr, inputAxisValues, inputAxisCount, fontWeight, fontStretch, fontStyle, fontSize, outputAxisValues);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetMatchingFonts<T0> (char* familyName, FontAxisValue* fontAxisValues, uint fontAxisValueCount, FontSimulations allowedSimulations, T0** matchingFonts) where T0 : unmanaged, IFontSet4 {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->___GetMatchingFonts (ptr, familyName, fontAxisValues, fontAxisValueCount, allowedSimulations, (void**) matchingFonts);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetMatchingFonts<T0> (char* familyName, FontAxisValue* fontAxisValues, uint fontAxisValueCount, FontSimulations allowedSimulations, out T0* matchingFonts) where T0 : unmanaged, IFontSet4 {
		fixed (T0** _matchingFonts = &matchingFonts) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->___GetMatchingFonts (ptr, familyName, fontAxisValues, fontAxisValueCount, allowedSimulations, (void**) _matchingFonts);
			return hr;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 30
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, FontAxisValue*, uint, FontWeight, FontStretch, FontStyle, float, FontAxisValue*, uint> ConvertWeightStretchStyleToFontAxisValues;
		/// <summary>
		/// OFFSET 31
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, char*, FontAxisValue*, uint, FontSimulations, void**, int> ___GetMatchingFonts;
	}
