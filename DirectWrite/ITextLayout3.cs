...
/// <summary>
/// INTERFACE <b>IDWriteTextLayout3</b> : IDWriteTextLayout2<br/>
/// DWRITE_3.h
/// </summary>
unsafe public interface ITextLayout3 : ITextLayout2 {
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout3::InvalidateLayout ()</b><br/>
	/// </summary>
	int InvalidateLayout ();
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout3::SetLineSpacing (DWRITE_LINE_SPACING* lineSpacingOptions)</b><br/>
	/// </summary>
	/// <param name="lineSpacingOptions">_In_ <b>DWRITE_LINE_SPACING* lineSpacingOptions</b></param>
	int SetLineSpacing (LineSpacing* lineSpacingOptions);
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout3::GetLineSpacing (DWRITE_LINE_SPACING* lineSpacingOptions)</b><br/>
	/// </summary>
	/// <param name="lineSpacingOptions">_Out_ <b>DWRITE_LINE_SPACING* lineSpacingOptions</b></param>
	int GetLineSpacing (LineSpacing* lineSpacingOptions);
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout3::GetLineSpacing (DWRITE_LINE_SPACING* lineSpacingOptions)</b><br/>
	/// </summary>
	/// <param name="lineSpacingOptions">_Out_ <b>DWRITE_LINE_SPACING* lineSpacingOptions</b></param>
	int GetLineSpacing (out LineSpacing lineSpacingOptions);
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout3::GetLineMetrics (DWRITE_LINE_METRICS1* lineMetrics, UINT32 maxLineCount, UINT32* actualLineCount)</b><br/>
	/// </summary>
	/// <param name="lineMetrics">_Out_writes_to_opt_(maxLineCount, *actualLineCount) <b>DWRITE_LINE_METRICS1* lineMetrics</b></param>
	/// <param name="maxLineCount"><b>UINT32 maxLineCount</b></param>
	/// <param name="actualLineCount">_Out_ <b>UINT32* actualLineCount</b></param>
	int GetLineMetrics (LineMetrics1* lineMetrics, uint maxLineCount, uint* actualLineCount);
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout3::GetLineMetrics (DWRITE_LINE_METRICS1* lineMetrics, UINT32 maxLineCount, UINT32* actualLineCount)</b><br/>
	/// </summary>
	/// <param name="lineMetrics">_Out_writes_to_opt_(maxLineCount, *actualLineCount) <b>DWRITE_LINE_METRICS1* lineMetrics</b></param>
	/// <param name="maxLineCount"><b>UINT32 maxLineCount</b></param>
	/// <param name="actualLineCount">_Out_ <b>UINT32* actualLineCount</b></param>
	int GetLineMetrics (LineMetrics1* lineMetrics, uint maxLineCount, out uint actualLineCount);
}

/// <summary>
/// Instance of <b>IDWriteTextLayout3</b><br/>
/// DWRITE_3.h
/// </summary>
unsafe public readonly struct TextLayout3 : ITextLayout3 {
//unsafe public readonly struct ITextLayout3Obj : ITextLayout3 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly TextLayout3* GetCurrentPointer () => (TextLayout3*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly ITextLayout3Obj* GetCurrentPointer () => (ITextLayout3Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x07ddcd52, 0x020e, 0x4de8, 0xac, 0x33, 0x6c, 0x95, 0x3d, 0x83, 0xf9, 0x2d);
