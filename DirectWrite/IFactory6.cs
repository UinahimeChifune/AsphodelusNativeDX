...
/// <summary>
/// INTERFACE <b>IDWriteFactory6</b> : IDWriteFactory5<br/>
/// DWRITE_3.h
/// </summary>
unsafe public interface IFactory6 : IFactory5 {
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateFontFaceReference (IDWriteFontFile* fontFile, UINT32 faceIndex, DWRITE_FONT_SIMULATIONS fontSimulations, DWRITE_FONT_AXIS_VALUE* fontAxisValues, UINT32 fontAxisValueCount, IDWriteFontFaceReference1** fontFaceReference)</b><br/>
	/// </summary>
	...
	int CreateFontFaceReference<T0, T1> (T0* fontFile, uint faceIndex, FontSimulations fontSimulations, FontAxisValue* fontAxisValues, uint fontAxisValueCount, T1** fontFaceReference) where T0 : unmanaged, IFontFile where T1 : unmanaged, IFontFaceReference1;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateFontFaceReference (IDWriteFontFile* fontFile, UINT32 faceIndex, DWRITE_FONT_SIMULATIONS fontSimulations, DWRITE_FONT_AXIS_VALUE* fontAxisValues, UINT32 fontAxisValueCount, IDWriteFontFaceReference1** fontFaceReference)</b><br/>
	/// </summary>
	/// <param name="fontFile">_In_ <b>IDWriteFontFile* fontFile</b></param>
	...
	/// <param name="fontAxisValueCount"><b>UINT32 fontAxisValueCount</b></param>
	/// <param name="fontFaceReference">_COM_Outptr_ <b>IDWriteFontFaceReference1** fontFaceReference</b></param>
	int CreateFontFaceReference<T0, T1> (T0* fontFile, uint faceIndex, FontSimulations fontSimulations, FontAxisValue* fontAxisValues, uint fontAxisValueCount, out T1* fontFaceReference) where T0 : unmanaged, IFontFile where T1 : unmanaged, IFontFaceReference1;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateFontResource (IDWriteFontFile* fontFile, UINT32 faceIndex, IDWriteFontResource** fontResource)</b><br/>
	/// </summary>
	/// <param name="fontFile">_In_ <b>IDWriteFontFile* fontFile</b></param>
	/// <param name="faceIndex"><b>UINT32 faceIndex</b></param>
	/// <param name="fontResource">_COM_Outptr_ <b>IDWriteFontResource** fontResource</b></param>
	int CreateFontResource<T0, T1> (T0* fontFile, uint faceIndex, T1** fontResource) where T0 : unmanaged, IFontFile where T1 : unmanaged, IFontResource;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateFontResource (IDWriteFontFile* fontFile, UINT32 faceIndex, IDWriteFontResource** fontResource)</b><br/>
	/// </summary>
	/// <param name="fontFile">_In_ <b>IDWriteFontFile* fontFile</b></param>
	/// <param name="faceIndex"><b>UINT32 faceIndex</b></param>
	/// <param name="fontResource">_COM_Outptr_ <b>IDWriteFontResource** fontResource</b></param>
	int CreateFontResource<T0, T1> (T0* fontFile, uint faceIndex, out T1* fontResource) where T0 : unmanaged, IFontFile where T1 : unmanaged, IFontResource;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::GetSystemFontSet (BOOL includeDownloadableFonts, IDWriteFontSet1** fontSet)</b><br/>
	/// </summary>
	...
	int GetSystemFontSet<T0> (bool includeDownloadableFonts, T0** fontSet) where T0 : unmanaged, IFontSet1;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::GetSystemFontSet (BOOL includeDownloadableFonts, IDWriteFontSet1** fontSet)</b><br/>
	/// </summary>
	/// <param name="includeDownloadableFonts"><b>BOOL includeDownloadableFonts</b></param>
	/// <param name="fontSet">_COM_Outptr_ <b>IDWriteFontSet1** fontSet</b></param>
	int GetSystemFontSet<T0> (bool includeDownloadableFonts, out T0* fontSet) where T0 : unmanaged, IFontSet1;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::GetSystemFontCollection (BOOL includeDownloadableFonts, DWRITE_FONT_FAMILY_MODEL fontFamilyModel, IDWriteFontCollection2** fontCollection)</b><br/>
	/// </summary>
	/// <param name="includeDownloadableFonts"><b>BOOL includeDownloadableFonts</b></param>
	/// <param name="fontFamilyModel"><b>DWRITE_FONT_FAMILY_MODEL fontFamilyModel</b></param>
	/// <param name="fontCollection">_COM_Outptr_ <b>IDWriteFontCollection2** fontCollection</b></param>
	int GetSystemFontCollection<T0> (bool includeDownloadableFonts, FontFamilyModel fontFamilyModel, T0** fontCollection) where T0 : unmanaged, IFontCollection2;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::GetSystemFontCollection (BOOL includeDownloadableFonts, DWRITE_FONT_FAMILY_MODEL fontFamilyModel, IDWriteFontCollection2** fontCollection)</b><br/>
	/// </summary>
	/// <param name="includeDownloadableFonts"><b>BOOL includeDownloadableFonts</b></param>
	/// <param name="fontFamilyModel"><b>DWRITE_FONT_FAMILY_MODEL fontFamilyModel</b></param>
	/// <param name="fontCollection">_COM_Outptr_ <b>IDWriteFontCollection2** fontCollection</b></param>
	int GetSystemFontCollection<T0> (bool includeDownloadableFonts, FontFamilyModel fontFamilyModel, out T0* fontCollection) where T0 : unmanaged, IFontCollection2;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateFontCollectionFromFontSet (IDWriteFontSet* fontSet, DWRITE_FONT_FAMILY_MODEL fontFamilyModel, IDWriteFontCollection2** fontCollection)</b><br/>
	/// </summary>
	/// <param name="fontSet"><b>IDWriteFontSet* fontSet</b></param>
	/// <param name="fontFamilyModel"><b>DWRITE_FONT_FAMILY_MODEL fontFamilyModel</b></param>
	/// <param name="fontCollection">_COM_Outptr_ <b>IDWriteFontCollection2** fontCollection</b></param>
	int CreateFontCollectionFromFontSet<T0, T1> (T0* fontSet, FontFamilyModel fontFamilyModel, T1** fontCollection) where T0 : unmanaged, IFontSet where T1 : unmanaged, IFontCollection2;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateFontCollectionFromFontSet (IDWriteFontSet* fontSet, DWRITE_FONT_FAMILY_MODEL fontFamilyModel, IDWriteFontCollection2** fontCollection)</b><br/>
	/// </summary>
	/// <param name="fontSet"><b>IDWriteFontSet* fontSet</b></param>
	/// <param name="fontFamilyModel"><b>DWRITE_FONT_FAMILY_MODEL fontFamilyModel</b></param>
	/// <param name="fontCollection">_COM_Outptr_ <b>IDWriteFontCollection2** fontCollection</b></param>
	int CreateFontCollectionFromFontSet<T0, T1> (T0* fontSet, FontFamilyModel fontFamilyModel, out T1* fontCollection) where T0 : unmanaged, IFontSet where T1 : unmanaged, IFontCollection2;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateFontSetBuilder (IDWriteFontSetBuilder2** fontSetBuilder)</b><br/>
	/// </summary>
	/// <param name="fontSetBuilder">_COM_Outptr_ <b>IDWriteFontSetBuilder2** fontSetBuilder</b></param>
	int CreateFontSetBuilder2<T0> (T0** fontSetBuilder) where T0 : unmanaged, IFontSetBuilder2;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateFontSetBuilder (IDWriteFontSetBuilder2** fontSetBuilder)</b><br/>
	/// </summary>
	/// <param name="fontSetBuilder">_COM_Outptr_ <b>IDWriteFontSetBuilder2** fontSetBuilder</b></param>
	int CreateFontSetBuilder2<T0> (out T0* fontSetBuilder) where T0 : unmanaged, IFontSetBuilder2;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateTextFormat (WCHAR* fontFamilyName, IDWriteFontCollection* fontCollection, DWRITE_FONT_AXIS_VALUE* fontAxisValues, UINT32 fontAxisValueCount, FLOAT fontSize, WCHAR* localeName, IDWriteTextFormat3** textFormat)</b><br/>
	/// </summary>
	...
	/// <param name="textFormat">_COM_Outptr_ <b>IDWriteTextFormat3** textFormat</b></param>
	int CreateTextFormat<T0, T1> (char* fontFamilyName, T0* fontCollection, FontAxisValue* fontAxisValues, uint fontAxisValueCount, float fontSize, char* localeName, T1** textFormat) where T0 : unmanaged, IFontCollection where T1 : unmanaged, ITextFormat3;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFactory6::CreateTextFormat (WCHAR* fontFamilyName, IDWriteFontCollection* fontCollection, DWRITE_FONT_AXIS_VALUE* fontAxisValues, UINT32 fontAxisValueCount, FLOAT fontSize, WCHAR* localeName, IDWriteTextFormat3** textFormat)</b><br/>
	/// </summary>
	/// <param name="fontFamilyName">_In_z_ <b>WCHAR* fontFamilyName</b></param>
	...
	/// <param name="localeName">_In_z_ <b>WCHAR* localeName</b></param>
	/// <param name="textFormat">_COM_Outptr_ <b>IDWriteTextFormat3** textFormat</b></param>
	int CreateTextFormat<T0, T1> (char* fontFamilyName, T0* fontCollection, FontAxisValue* fontAxisValues, uint fontAxisValueCount, float fontSize, char* localeName, out T1* textFormat) where T0 : unmanaged, IFontCollection where T1 : unmanaged, ITextFormat3;
}

/// <summary>
/// Instance of <b>IDWriteFactory6</b><br/>
/// DWRITE_3.h
/// </summary>
...
//unsafe public readonly struct IFactory6Obj : IFactory6 {
	...
	static readonly Guid _guid = new (0xf3744d80, 0x21f7, 0x42eb, 0xb3, 0x5d, 0x99, 0x5b, 0xc7, 0x2f, 0xc2, 0x23);
