...
/// <summary>
/// INTERFACE <b>IDWriteFontFace6</b> : IDWriteFontFace5<br/>
/// DWRITE_3.h
/// </summary>
unsafe public interface IFontFace6 : IFontFace5 {
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontFace6::GetFamilyNames (DWRITE_FONT_FAMILY_MODEL fontFamilyModel, IDWriteLocalizedStrings** names)</b><br/>
	/// </summary>
	...
	int GetFamilyNames<T0> (FontFamilyModel fontFamilyModel, T0** names) where T0 : unmanaged, ILocalizedStrings;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontFace6::GetFamilyNames (DWRITE_FONT_FAMILY_MODEL fontFamilyModel, IDWriteLocalizedStrings** names)</b><br/>
	/// </summary>
	/// <param name="fontFamilyModel"><b>DWRITE_FONT_FAMILY_MODEL fontFamilyModel</b></param>
	/// <param name="names">_COM_Outptr_ <b>IDWriteLocalizedStrings** names</b></param>
	int GetFamilyNames<T0> (FontFamilyModel fontFamilyModel, out T0* names) where T0 : unmanaged, ILocalizedStrings;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontFace6::GetFaceNames (DWRITE_FONT_FAMILY_MODEL fontFamilyModel, IDWriteLocalizedStrings** names)</b><br/>
	/// </summary>
	/// <param name="fontFamilyModel"><b>DWRITE_FONT_FAMILY_MODEL fontFamilyModel</b></param>
	/// <param name="names">_COM_Outptr_ <b>IDWriteLocalizedStrings** names</b></param>
	int GetFaceNames<T0> (FontFamilyModel fontFamilyModel, T0** names) where T0 : unmanaged, ILocalizedStrings;
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontFace6::GetFaceNames (DWRITE_FONT_FAMILY_MODEL fontFamilyModel, IDWriteLocalizedStrings** names)</b><br/>
	/// </summary>
	/// <param name="fontFamilyModel"><b>DWRITE_FONT_FAMILY_MODEL fontFamilyModel</b></param>
	/// <param name="names">_COM_Outptr_ <b>IDWriteLocalizedStrings** names</b></param>
	int GetFaceNames<T0> (FontFamilyModel fontFamilyModel, out T0* names) where T0 : unmanaged, ILocalizedStrings;
}

/// <summary>
/// Instance of <b>IDWriteFontFace6</b><br/>
/// DWRITE_3.h
/// </summary>
unsafe public readonly struct FontFace6 : IFontFace6 {
//unsafe public readonly struct IFontFace6Obj : IFontFace6 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly FontFace6* GetCurrentPointer () => (FontFace6*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IFontFace6Obj* GetCurrentPointer () => (IFontFace6Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xc4b1fe1b, 0x6e84, 0x47d5, 0xb5, 0x4c, 0xa5, 0x97, 0x98, 0x1b, 0x06, 0xad);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetFamilyNames<T0> (FontFamilyModel fontFamilyModel, T0** names) where T0 : unmanaged, ILocalizedStrings {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->_GetFamilyNames (ptr, fontFamilyModel, (void**) names);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetFamilyNames<T0> (FontFamilyModel fontFamilyModel, out T0* names) where T0 : unmanaged, ILocalizedStrings {
		fixed (T0** _names = &names) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->_GetFamilyNames (ptr, fontFamilyModel, (void**) _names);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetFaceNames<T0> (FontFamilyModel fontFamilyModel, T0** names) where T0 : unmanaged, ILocalizedStrings {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->_GetFaceNames (ptr, fontFamilyModel, (void**) names);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetFaceNames<T0> (FontFamilyModel fontFamilyModel, out T0* names) where T0 : unmanaged, ILocalizedStrings {
		fixed (T0** _names = &names) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->_GetFaceNames (ptr, fontFamilyModel, (void**) _names);
			return hr;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 58
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, FontFamilyModel, void**, int> _GetFamilyNames;
		/// <summary>
		/// OFFSET 59
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, FontFamilyModel, void**, int> _GetFaceNames;
	}
