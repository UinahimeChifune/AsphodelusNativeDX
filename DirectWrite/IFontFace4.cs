...
/// <summary>
/// INTERFACE <b>IDWriteFontFace4</b> : IDWriteFontFace3<br/>
/// DWRITE_3.h
/// </summary>
unsafe public interface IFontFace4 : IFontFace3 {
	/// <summary>
	/// STDMETHOD_ <b>DWRITE_GLYPH_IMAGE_FORMATS IDWriteFontFace4::GetGlyphImageFormats ()</b><br/>
	/// </summary>
	GlyphImageFormats GetGlyphImageFormats ();
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontFace4::GetGlyphImageFormats (UINT16 glyphId, UINT32 pixelsPerEmFirst, UINT32 pixelsPerEmLast, DWRITE_GLYPH_IMAGE_FORMATS* glyphImageFormats)</b><br/>
	/// </summary>
	/// <param name="glyphId"><b>UINT16 glyphId</b></param>
	/// <param name="pixelsPerEmFirst"><b>UINT32 pixelsPerEmFirst</b></param>
	/// <param name="pixelsPerEmLast"><b>UINT32 pixelsPerEmLast</b></param>
	/// <param name="glyphImageFormats">_Out_ <b>DWRITE_GLYPH_IMAGE_FORMATS* glyphImageFormats</b></param>
	int GetGlyphImageFormats (ushort glyphId, uint pixelsPerEmFirst, uint pixelsPerEmLast, GlyphImageFormats* glyphImageFormats);
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontFace4::GetGlyphImageFormats (UINT16 glyphId, UINT32 pixelsPerEmFirst, UINT32 pixelsPerEmLast, DWRITE_GLYPH_IMAGE_FORMATS* glyphImageFormats)</b><br/>
	/// </summary>
	/// <param name="glyphId"><b>UINT16 glyphId</b></param>
	...
	/// <param name="pixelsPerEmLast"><b>UINT32 pixelsPerEmLast</b></param>
	/// <param name="glyphImageFormats">_Out_ <b>DWRITE_GLYPH_IMAGE_FORMATS* glyphImageFormats</b></param>
	int GetGlyphImageFormats (ushort glyphId, uint pixelsPerEmFirst, uint pixelsPerEmLast, out GlyphImageFormats glyphImageFormats);
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontFace4::GetGlyphImageData (UINT16 glyphId, UINT32 pixelsPerEm, DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, DWRITE_GLYPH_IMAGE_DATA* glyphData, void** glyphDataContext)</b><br/>
	/// </summary>
	/// <param name="glyphId">_In_ <b>UINT16 glyphId</b></param>
	/// <param name="pixelsPerEm"><b>UINT32 pixelsPerEm</b></param>
	/// <param name="glyphImageFormat"><b>DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat</b></param>
	/// <param name="glyphData">_Out_ <b>DWRITE_GLYPH_IMAGE_DATA* glyphData</b></param>
	/// <param name="glyphDataContext">_Outptr_result_maybenull_ <b>void** glyphDataContext</b></param>
	int GetGlyphImageData (ushort glyphId, uint pixelsPerEm, GlyphImageFormats glyphImageFormat, GlyphImageData* glyphData, void** glyphDataContext);
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteFontFace4::GetGlyphImageData (UINT16 glyphId, UINT32 pixelsPerEm, DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, DWRITE_GLYPH_IMAGE_DATA* glyphData, void** glyphDataContext)</b><br/>
	/// </summary>
	/// <param name="glyphId">_In_ <b>UINT16 glyphId</b></param>
	...
	/// <param name="glyphData">_Out_ <b>DWRITE_GLYPH_IMAGE_DATA* glyphData</b></param>
	/// <param name="glyphDataContext">_Outptr_result_maybenull_ <b>void** glyphDataContext</b></param>
	int GetGlyphImageData (ushort glyphId, uint pixelsPerEm, GlyphImageFormats glyphImageFormat, out GlyphImageData glyphData, out void* glyphDataContext);
	/// <summary>
	/// STDMETHOD_ <b>void IDWriteFontFace4::ReleaseGlyphImageData (void* glyphDataContext)</b><br/>
	/// </summary>
	/// <param name="glyphDataContext"><b>void* glyphDataContext</b></param>
	void ReleaseGlyphImageData (void* glyphDataContext);
}

/// <summary>
/// Instance of <b>IDWriteFontFace4</b><br/>
/// DWRITE_3.h
/// </summary>
unsafe public readonly struct FontFace4 : IFontFace4 {
//unsafe public readonly struct IFontFace4Obj : IFontFace4 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly FontFace4* GetCurrentPointer () => (FontFace4*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IFontFace4Obj* GetCurrentPointer () => (IFontFace4Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x27f2a904, 0x4eb8, 0x441d, 0x96, 0x78, 0x05, 0x63, 0xf5, 0x3e, 0x3e, 0x2f);
