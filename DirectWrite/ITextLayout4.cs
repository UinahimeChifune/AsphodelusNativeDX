...
/// <summary>
/// INTERFACE <b>IDWriteTextLayout4</b> : IDWriteTextLayout3<br/>
/// DWRITE_3.h
/// </summary>
unsafe public interface ITextLayout4 : ITextLayout3 {
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout4::SetFontAxisValues (DWRITE_FONT_AXIS_VALUE* fontAxisValues, UINT32 fontAxisValueCount, DWRITE_TEXT_RANGE textRange)</b><br/>
	/// </summary>
	...
	int SetFontAxisValues (FontAxisValue* fontAxisValues, uint fontAxisValueCount, TextRange textRange);
	/// <summary>
	/// STDMETHOD_ <b>UINT32 IDWriteTextLayout4::GetFontAxisValueCount (UINT32 currentPosition)</b><br/>
	/// </summary>
	/// <param name="currentPosition"><b>UINT32 currentPosition</b></param>
	uint GetFontAxisValueCount (uint currentPosition);
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout4::GetFontAxisValues (UINT32 currentPosition, DWRITE_FONT_AXIS_VALUE* fontAxisValues, UINT32 fontAxisValueCount, DWRITE_TEXT_RANGE* textRange)</b><br/>
	/// </summary>
	/// <param name="currentPosition"><b>UINT32 currentPosition</b></param>
	...
	int GetFontAxisValues (uint currentPosition, FontAxisValue* fontAxisValues, uint fontAxisValueCount, TextRange* textRange);
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout4::GetFontAxisValues (UINT32 currentPosition, DWRITE_FONT_AXIS_VALUE* fontAxisValues, UINT32 fontAxisValueCount, DWRITE_TEXT_RANGE* textRange)</b><br/>
	/// </summary>
	/// <param name="currentPosition"><b>UINT32 currentPosition</b></param>
	...
	/// <param name="fontAxisValueCount"><b>UINT32 fontAxisValueCount</b></param>
	/// <param name="textRange">_Out_opt_ <b>DWRITE_TEXT_RANGE* textRange</b></param>
	int GetFontAxisValues (uint currentPosition, FontAxisValue* fontAxisValues, uint fontAxisValueCount, out TextRange textRange);
	/// <summary>
	/// STDMETHOD_ <b>DWRITE_AUTOMATIC_FONT_AXES IDWriteTextLayout4::GetAutomaticFontAxes ()</b><br/>
	/// </summary>
	AutomaticFontAxes GetAutomaticFontAxes ();
	/// <summary>
	/// STDMETHOD <b>HRESULT IDWriteTextLayout4::SetAutomaticFontAxes (DWRITE_AUTOMATIC_FONT_AXES automaticFontAxes)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>IDWriteTextLayout4</b><br/>
/// DWRITE_3.h
/// </summary>
unsafe public readonly struct TextLayout4 : ITextLayout4 {
//unsafe public readonly struct ITextLayout4Obj : ITextLayout4 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly TextLayout4* GetCurrentPointer () => (TextLayout4*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly ITextLayout4Obj* GetCurrentPointer () => (ITextLayout4Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x05a9bf42, 0x223f, 0x4441, 0xb5, 0xfb, 0x82, 0x63, 0x68, 0x5f, 0x55, 0xe9);
	...
	public readonly int InvalidateLayout () {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->InvalidateLayout (ptr);
		return hr;
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetLineMetrics (LineMetrics1* lineMetrics, uint maxLineCount, uint* actualLineCount) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->GetLineMetrics1 (ptr, lineMetrics, maxLineCount, actualLineCount);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetLineMetrics (LineMetrics1* lineMetrics, uint maxLineCount, out uint actualLineCount) {
		fixed (uint* _actualLineCount = &actualLineCount) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->GetLineMetrics1 (ptr, lineMetrics, maxLineCount, _actualLineCount);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int SetFontAxisValues (FontAxisValue* fontAxisValues, uint fontAxisValueCount, TextRange textRange) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->SetFontAxisValues (ptr, fontAxisValues, fontAxisValueCount, textRange);
		return hr;
	}
	...
	public readonly uint GetFontAxisValueCount (uint currentPosition) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->GetFontAxisValueCount (ptr, currentPosition);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetFontAxisValues (uint currentPosition, FontAxisValue* fontAxisValues, uint fontAxisValueCount, TextRange* textRange) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->GetFontAxisValues (ptr, currentPosition, fontAxisValues, fontAxisValueCount, textRange);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetFontAxisValues (uint currentPosition, FontAxisValue* fontAxisValues, uint fontAxisValueCount, out TextRange textRange) {
		fixed (TextRange* _textRange = &textRange) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->GetFontAxisValues (ptr, currentPosition, fontAxisValues, fontAxisValueCount, _textRange);
			return hr;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 80
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, int> InvalidateLayout;
		/// <summary>
		/// OFFSET 81
		/// </summary>
		...
		/// OFFSET 83
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, LineMetrics1*, uint, uint*, int> GetLineMetrics1;
		/// <summary>
		/// OFFSET 84
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, FontAxisValue*, uint, TextRange, int> SetFontAxisValues;
		/// <summary>
		/// OFFSET 85
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, uint, uint> GetFontAxisValueCount;
		/// <summary>
		/// OFFSET 86
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, uint, FontAxisValue*, uint, TextRange*, int> GetFontAxisValues;
		/// <summary>
		/// OFFSET 87
		/// </summary>
