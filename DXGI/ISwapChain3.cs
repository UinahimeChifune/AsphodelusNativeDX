...
/// <summary>
/// INTERFACE <b>IDXGISwapChain3</b> : IDXGISwapChain2<br/>
/// DXGI1_4.h
/// </summary>
unsafe public interface ISwapChain3 : ISwapChain2 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT IDXGISwapChain3::GetCurrentBackBufferIndex ()</b><br/>
	/// </summary>
	uint GetCurrentBackBufferIndex ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGISwapChain3::CheckColorSpaceSupport (DXGI_COLOR_SPACE_TYPE ColorSpace, UINT* pColorSpaceSupport)</b><br/>
	/// </summary>
	/// <param name="colorSpace">_In_ <b>DXGI_COLOR_SPACE_TYPE ColorSpace</b></param>
	/// <param name="pColorSpaceSupport">_Out_ <b>UINT* pColorSpaceSupport</b></param>
	int CheckColorSpaceSupport (ColorSpaceType colorSpace, uint* pColorSpaceSupport);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGISwapChain3::CheckColorSpaceSupport (DXGI_COLOR_SPACE_TYPE ColorSpace, UINT* pColorSpaceSupport)</b><br/>
	/// </summary>
	/// <param name="colorSpace">_In_ <b>DXGI_COLOR_SPACE_TYPE ColorSpace</b></param>
	/// <param name="pColorSpaceSupport">_Out_ <b>UINT* pColorSpaceSupport</b></param>
	int CheckColorSpaceSupport (ColorSpaceType colorSpace, out uint pColorSpaceSupport);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGISwapChain3::SetColorSpace1 (DXGI_COLOR_SPACE_TYPE ColorSpace)</b><br/>
	/// </summary>
	/// <param name="colorSpace">_In_ <b>DXGI_COLOR_SPACE_TYPE ColorSpace</b></param>
	int SetColorSpace1 (ColorSpaceType colorSpace);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGISwapChain3::ResizeBuffers1 (UINT BufferCount, UINT Width, UINT Height, DXGI_FORMAT Format, UINT SwapChainFlags, UINT* pCreationNodeMask, IUnknown* ppPresentQueue)</b><br/>
	/// </summary>
	/// <param name="bufferCount">_In_ <b>UINT BufferCount</b></param>
	...
	/// <param name="swapChainFlags">_In_ <b>UINT SwapChainFlags</b></param>
	/// <param name="pCreationNodeMask">_In_reads_(BufferCount) <b>UINT* pCreationNodeMask</b></param>
	/// <param name="ppPresentQueue">_In_reads_(BufferCount) <b>IUnknown* ppPresentQueue</b></param>
	int ResizeBuffers1<T0> (uint bufferCount, uint width, uint height, Format format, uint swapChainFlags, uint* pCreationNodeMask, T0* ppPresentQueue) where T0 : unmanaged, IUnknown;
}

/// <summary>
/// Instance of <b>IDXGISwapChain3</b><br/>
/// DXGI1_4.h
/// </summary>
unsafe public readonly struct SwapChain3 : ISwapChain3 {
//unsafe public readonly struct ISwapChain3Obj : ISwapChain3 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly SwapChain3* GetCurrentPointer () => (SwapChain3*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly ISwapChain3Obj* GetCurrentPointer () => (ISwapChain3Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x94d99bdb, 0xf1f8, 0x4ab0, 0xb2, 0x36, 0x7d, 0xa0, 0x17, 0x0e, 0xda, 0xb1);
