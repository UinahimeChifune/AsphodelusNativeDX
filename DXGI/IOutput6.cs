...
/// <summary>
/// INTERFACE <b>IDXGIOutput6</b> : IDXGIOutput5<br/>
/// DXGI1_6.h
/// </summary>
unsafe public interface IOutput6 : IOutput5 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGIOutput6::GetDesc1 (DXGI_OUTPUT_DESC1* pDesc)</b><br/>
	/// </summary>
	/// <param name="pDesc">_Out_ <b>DXGI_OUTPUT_DESC1* pDesc</b></param>
	int GetDesc1 (OutputDesc1* pDesc);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGIOutput6::GetDesc1 (DXGI_OUTPUT_DESC1* pDesc)</b><br/>
	/// </summary>
	/// <param name="pDesc">_Out_ <b>DXGI_OUTPUT_DESC1* pDesc</b></param>
	int GetDesc1 (out OutputDesc1 pDesc);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGIOutput6::CheckHardwareCompositionSupport (UINT* pFlags)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>IDXGIOutput6</b><br/>
/// DXGI1_6.h
/// </summary>
unsafe public readonly struct Output6 : IOutput6 {
//unsafe public readonly struct IOutput6Obj : IOutput6 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly Output6* GetCurrentPointer () => (Output6*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IOutput6Obj* GetCurrentPointer () => (IOutput6Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x068346e8, 0xaaec, 0x4b84, 0xad, 0xd7, 0x13, 0x7f, 0x51, 0x3f, 0x77, 0xa1);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetDesc1 (OutputDesc1* pDesc) {
		var ptr = GetCurrentPointer ();
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int GetDesc1 (out OutputDesc1 pDesc) {
		fixed (OutputDesc1* _pDesc = &pDesc) {
			var ptr = GetCurrentPointer ();
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CheckHardwareCompositionSupport (uint* pFlags) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CheckHardwareCompositionSupport (ptr, pFlags);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CheckHardwareCompositionSupport (out uint pFlags) {
		fixed (uint* _pFlags = &pFlags) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CheckHardwareCompositionSupport (ptr, _pFlags);
			return hr;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 27
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, OutputDesc1*, int> GetDesc1;
		/// <summary>
		/// OFFSET 28
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, uint*, int> CheckHardwareCompositionSupport;
	}
