...
/// <summary>
/// INTERFACE <b>IDXGIOutput3</b> : IDXGIOutput2<br/>
/// DXGI1_3.h
/// </summary>
unsafe public interface IOutput3 : IOutput2 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGIOutput3::CheckOverlaySupport (DXGI_FORMAT EnumFormat, IUnknown* pConcernedDevice, UINT* pFlags)</b><br/>
	/// </summary>
	/// <param name="enumFormat">_In_ <b>DXGI_FORMAT EnumFormat</b></param>
	/// <param name="pConcernedDevice">_In_ <b>IUnknown* pConcernedDevice</b></param>
	/// <param name="pFlags">_Out_ <b>UINT* pFlags</b></param>
	int CheckOverlaySupport<T0> (Format enumFormat, T0* pConcernedDevice, uint* pFlags) where T0 : unmanaged, IUnknown;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGIOutput3::CheckOverlaySupport (DXGI_FORMAT EnumFormat, IUnknown* pConcernedDevice, UINT* pFlags)</b><br/>
	/// </summary>
	/// <param name="enumFormat">_In_ <b>DXGI_FORMAT EnumFormat</b></param>
	/// <param name="pConcernedDevice">_In_ <b>IUnknown* pConcernedDevice</b></param>
	/// <param name="pFlags">_Out_ <b>UINT* pFlags</b></param>
	int CheckOverlaySupport<T0> (Format enumFormat, T0* pConcernedDevice, out uint pFlags) where T0 : unmanaged, IUnknown;
}

/// <summary>
/// Instance of <b>IDXGIOutput3</b><br/>
/// DXGI1_3.h
/// </summary>
unsafe public readonly struct Output3 : IOutput3 {
//unsafe public readonly struct IOutput3Obj : IOutput3 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly Output3* GetCurrentPointer () => (Output3*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IOutput3Obj* GetCurrentPointer () => (IOutput3Obj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x8a6bb301, 0x7e7e, 0x41f4, 0xa8, 0xe0, 0x5b, 0x32, 0xf7, 0xf9, 0x9b, 0x18);
