...
/// <summary>
/// INTERFACE <b>IDXGIFactory7</b> : IDXGIFactory6<br/>
/// DXGI1_6.h
/// </summary>
unsafe public interface IFactory7 : IFactory6 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGIFactory7::RegisterAdaptersChangedEvent (HANDLE hEvent, DWORD* pdwCookie)</b><br/>
	/// </summary>
	/// <param name="hEvent">_In_ <b>HANDLE hEvent</b></param>
	/// <param name="pdwCookie">_Out_ <b>DWORD* pdwCookie</b></param>
	int RegisterAdaptersChangedEvent (IntPtr hEvent, uint* pdwCookie);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGIFactory7::RegisterAdaptersChangedEvent (HANDLE hEvent, DWORD* pdwCookie)</b><br/>
	/// </summary>
	/// <param name="hEvent">_In_ <b>HANDLE hEvent</b></param>
	...
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IDXGIFactory7::UnregisterAdaptersChangedEvent (DWORD dwCookie)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>IDXGIFactory7</b><br/>
/// DXGI1_6.h
/// </summary>
...
//unsafe public readonly struct IFactory7Obj : IFactory7 {
	...
	static readonly Guid _guid = new (0xa4966eed, 0x76db, 0x44da, 0x84, 0xc1, 0xee, 0x9a, 0x7a, 0xfb, 0x20, 0xa8);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int RegisterAdaptersChangedEvent (IntPtr hEvent, uint* pdwCookie) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->RegisterAdaptersChangedEvent (ptr, hEvent, pdwCookie);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int RegisterAdaptersChangedEvent (IntPtr hEvent, out uint pdwCookie) {
		fixed (uint* _pdwCookie = &pdwCookie) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->RegisterAdaptersChangedEvent (ptr, hEvent, _pdwCookie);
			return hr;
		}
	}
	...
	public readonly int UnregisterAdaptersChangedEvent (uint dwCookie) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->UnregisterAdaptersChangedEvent (ptr, dwCookie);
		return hr;
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 30
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, IntPtr, uint*, int> RegisterAdaptersChangedEvent;
		/// <summary>
		/// OFFSET 31
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, uint, int> UnregisterAdaptersChangedEvent;
	}
