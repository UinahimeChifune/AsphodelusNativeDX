...
/// <summary>
/// INTERFACE <b>ID3D12Device10</b> : ID3D12Device9<br/>
/// D3D12.h
/// </summary>
unsafe public interface IDevice10 : IDevice9 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device10::CreateCommittedResource3 (D3D12_HEAP_PROPERTIES* pHeapProperties, D3D12_HEAP_FLAGS HeapFlags, D3D12_RESOURCE_DESC1* pDesc, D3D12_BARRIER_LAYOUT InitialLayout, D3D12_CLEAR_VALUE* pOptimizedClearValue, ID3D12ProtectedResourceSession* pProtectedSession, UINT32 NumCastableFormats, DXGI_FORMAT* pCastableFormats, REFIID riidResource, void** ppvResource)</b><br/>
	/// </summary>
	...
	/// <param name="pDesc">_In_ <b>D3D12_RESOURCE_DESC1* pDesc</b></param>
	/// <param name="initialLayout"><b>D3D12_BARRIER_LAYOUT InitialLayout</b></param>
	...
	/// <param name="numCastableFormats"><b>UINT32 NumCastableFormats</b></param>
	/// <param name="pCastableFormats">_In_opt_count_(NumCastableFormats) <b>DXGI_FORMAT* pCastableFormats</b></param>
	/// <param name="riidResource"><b>REFIID riidResource</b></param>
	/// <param name="ppvResource">_COM_Outptr_opt_ <b>void** ppvResource</b></param>
	int CreateCommittedResource3<T0> (HeapProperties* pHeapProperties, HeapFlags heapFlags, ResourceDesc1* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, T0* pProtectedSession, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riidResource, void** ppvResource) where T0 : unmanaged, IProtectedResourceSession;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device10::CreateCommittedResource3 (D3D12_HEAP_PROPERTIES* pHeapProperties, D3D12_HEAP_FLAGS HeapFlags, D3D12_RESOURCE_DESC1* pDesc, D3D12_BARRIER_LAYOUT InitialLayout, D3D12_CLEAR_VALUE* pOptimizedClearValue, ID3D12ProtectedResourceSession* pProtectedSession, UINT32 NumCastableFormats, DXGI_FORMAT* pCastableFormats, REFIID riidResource, void** ppvResource)</b><br/>
	/// </summary>
	/// <param name="pHeapProperties">_In_ <b>D3D12_HEAP_PROPERTIES* pHeapProperties</b></param>
	...
	/// <param name="riidResource"><b>REFIID riidResource</b></param>
	/// <param name="ppvResource">_COM_Outptr_opt_ <b>void** ppvResource</b></param>
	int CreateCommittedResource3<T0> (HeapProperties* pHeapProperties, HeapFlags heapFlags, ResourceDesc1* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, T0* pProtectedSession, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riidResource, out void* ppvResource) where T0 : unmanaged, IProtectedResourceSession;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device10::CreatePlacedResource2 (ID3D12Heap* pHeap, UINT64 HeapOffset, D3D12_RESOURCE_DESC1* pDesc, D3D12_BARRIER_LAYOUT InitialLayout, D3D12_CLEAR_VALUE* pOptimizedClearValue, UINT32 NumCastableFormats, DXGI_FORMAT* pCastableFormats, REFIID riid, void** ppvResource)</b><br/>
	/// </summary>
	...
	/// <param name="ppvResource">_COM_Outptr_opt_ <b>void** ppvResource</b></param>
	int CreatePlacedResource2<T0> (T0* pHeap, ulong heapOffset, ResourceDesc1* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riid, void** ppvResource) where T0 : unmanaged, IHeap;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device10::CreatePlacedResource2 (ID3D12Heap* pHeap, UINT64 HeapOffset, D3D12_RESOURCE_DESC1* pDesc, D3D12_BARRIER_LAYOUT InitialLayout, D3D12_CLEAR_VALUE* pOptimizedClearValue, UINT32 NumCastableFormats, DXGI_FORMAT* pCastableFormats, REFIID riid, void** ppvResource)</b><br/>
	/// </summary>
	/// <param name="pHeap">_In_ <b>ID3D12Heap* pHeap</b></param>
	...
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvResource">_COM_Outptr_opt_ <b>void** ppvResource</b></param>
	int CreatePlacedResource2<T0> (T0* pHeap, ulong heapOffset, ResourceDesc1* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riid, out void* ppvResource) where T0 : unmanaged, IHeap;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device10::CreateReservedResource2 (D3D12_RESOURCE_DESC* pDesc, D3D12_BARRIER_LAYOUT InitialLayout, D3D12_CLEAR_VALUE* pOptimizedClearValue, ID3D12ProtectedResourceSession* pProtectedSession, UINT32 NumCastableFormats, DXGI_FORMAT* pCastableFormats, REFIID riid, void** ppvResource)</b><br/>
	/// </summary>
	...
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvResource">_COM_Outptr_opt_ <b>void** ppvResource</b></param>
	int CreateReservedResource2<T0> (ResourceDesc* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, T0* pProtectedSession, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riid, void** ppvResource) where T0 : unmanaged, IProtectedResourceSession;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device10::CreateReservedResource2 (D3D12_RESOURCE_DESC* pDesc, D3D12_BARRIER_LAYOUT InitialLayout, D3D12_CLEAR_VALUE* pOptimizedClearValue, ID3D12ProtectedResourceSession* pProtectedSession, UINT32 NumCastableFormats, DXGI_FORMAT* pCastableFormats, REFIID riid, void** ppvResource)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_RESOURCE_DESC* pDesc</b></param>
	...
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvResource">_COM_Outptr_opt_ <b>void** ppvResource</b></param>
	int CreateReservedResource2<T0> (ResourceDesc* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, T0* pProtectedSession, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riid, out void* ppvResource) where T0 : unmanaged, IProtectedResourceSession;
}

/// <summary>
/// Instance of <b>ID3D12Device10</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct Device10 : IDevice10 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly Device10* GetCurrentPointer () => (Device10*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x517f8718, 0xaa66, 0x49f9, 0xb0, 0x2b, 0xa7, 0xab, 0x89, 0xc0, 0x60, 0x31);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int SetBackgroundProcessingMode (BackgroundProcessingMode mode, MeasurementsAction measurementsAction, IntPtr hEventToSignalUponCompletion, uint* pbFurtherMeasurementsDesired) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->SetBackgroundProcessingMode (ptr, mode, measurementsAction, hEventToSignalUponCompletion, pbFurtherMeasurementsDesired);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int SetBackgroundProcessingMode (BackgroundProcessingMode mode, MeasurementsAction measurementsAction, IntPtr hEventToSignalUponCompletion, out bool pbFurtherMeasurementsDesired) {
		uint _pbFurtherMeasurementsDesired;
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->SetBackgroundProcessingMode (ptr, mode, measurementsAction, hEventToSignalUponCompletion, &_pbFurtherMeasurementsDesired);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int AddToStateObject<T0> (StateObjectDesc* pAddition, T0* pStateObjectToGrowFrom, Guid riid, void** ppNewStateObject) where T0 : unmanaged, IStateObject {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->AddToStateObject (ptr, pAddition, pStateObjectToGrowFrom, riid, ppNewStateObject);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int AddToStateObject<T0> (StateObjectDesc* pAddition, T0* pStateObjectToGrowFrom, Guid riid, out void* ppNewStateObject) where T0 : unmanaged, IStateObject {
		fixed (void** _ppNewStateObject = &ppNewStateObject) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->AddToStateObject (ptr, pAddition, pStateObjectToGrowFrom, riid, _ppNewStateObject);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateProtectedResourceSession1 (ProtectedResourceSessionDesc1* pDesc, Guid riid, void** ppSession) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateProtectedResourceSession1 (ptr, pDesc, riid, ppSession);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateProtectedResourceSession1 (ProtectedResourceSessionDesc1* pDesc, Guid riid, out void* ppSession) {
		fixed (void** _ppSession = &ppSession) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateProtectedResourceSession1 (ptr, pDesc, riid, _ppSession);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly ResourceAllocationInfo GetResourceAllocationInfo2 (uint visibleMask, uint numResourceDescs, ResourceDesc1* pResourceDescs, ResourceAllocationInfo1* pResourceAllocationInfo1) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->GetResourceAllocationInfo2 (ptr, visibleMask, numResourceDescs, pResourceDescs, pResourceAllocationInfo1);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateCommittedResource2<T0> (HeapProperties* pHeapProperties, HeapFlags heapFlags, ResourceDesc1* pDesc, ResourceStates initialResourceState, ClearValue* pOptimizedClearValue, T0* pProtectedSession, Guid riidResource, void** ppvResource) where T0 : unmanaged, IProtectedResourceSession {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateCommittedResource2 (ptr, pHeapProperties, heapFlags, pDesc, initialResourceState, pOptimizedClearValue, pProtectedSession, riidResource, ppvResource);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateCommittedResource2<T0> (HeapProperties* pHeapProperties, HeapFlags heapFlags, ResourceDesc1* pDesc, ResourceStates initialResourceState, ClearValue* pOptimizedClearValue, T0* pProtectedSession, Guid riidResource, out void* ppvResource) where T0 : unmanaged, IProtectedResourceSession {
		fixed (void** _ppvResource = &ppvResource) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateCommittedResource2 (ptr, pHeapProperties, heapFlags, pDesc, initialResourceState, pOptimizedClearValue, pProtectedSession, riidResource, _ppvResource);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreatePlacedResource1<T0> (T0* pHeap, ulong heapOffset, ResourceDesc1* pDesc, ResourceStates initialState, ClearValue* pOptimizedClearValue, Guid riid, void** ppvResource) where T0 : unmanaged, IHeap {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreatePlacedResource1 (ptr, pHeap, heapOffset, pDesc, initialState, pOptimizedClearValue, riid, ppvResource);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreatePlacedResource1<T0> (T0* pHeap, ulong heapOffset, ResourceDesc1* pDesc, ResourceStates initialState, ClearValue* pOptimizedClearValue, Guid riid, out void* ppvResource) where T0 : unmanaged, IHeap {
		fixed (void** _ppvResource = &ppvResource) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreatePlacedResource1 (ptr, pHeap, heapOffset, pDesc, initialState, pOptimizedClearValue, riid, _ppvResource);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void CreateSamplerFeedbackUnorderedAccessView<T0, T1> (T0* pTargetedResource, T1* pFeedbackResource, CpuDescriptorHandle destDescriptor) where T0 : unmanaged, IResource where T1 : unmanaged, IResource {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->CreateSamplerFeedbackUnorderedAccessView (ptr, pTargetedResource, pFeedbackResource, destDescriptor);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetCopyableFootprints1 (ResourceDesc1* pResourceDesc, uint firstSubresource, uint numSubresources, ulong baseOffset, PlacedSubresourceFootprint* pLayouts, uint* pNumRows, ulong* pRowSizeInBytes, ulong* pTotalBytes) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->GetCopyableFootprints1 (ptr, pResourceDesc, firstSubresource, numSubresources, baseOffset, pLayouts, pNumRows, pRowSizeInBytes, pTotalBytes);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void GetCopyableFootprints1 (ResourceDesc1* pResourceDesc, uint firstSubresource, uint numSubresources, ulong baseOffset, PlacedSubresourceFootprint* pLayouts, uint* pNumRows, ulong* pRowSizeInBytes, out ulong pTotalBytes) {
		fixed (ulong* _pTotalBytes = &pTotalBytes) {
			var ptr = GetCurrentPointer ();
			((FunctionPointer*) ptr->_pointer)->GetCopyableFootprints1 (ptr, pResourceDesc, firstSubresource, numSubresources, baseOffset, pLayouts, pNumRows, pRowSizeInBytes, _pTotalBytes);
			return;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateShaderCacheSession (ShaderCacheSessionDesc* pDesc, Guid riid, void** ppvSession) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateShaderCacheSession (ptr, pDesc, riid, ppvSession);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateShaderCacheSession (ShaderCacheSessionDesc* pDesc, Guid riid, out void* ppvSession) {
		fixed (void** _ppvSession = &ppvSession) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateShaderCacheSession (ptr, pDesc, riid, _ppvSession);
			return hr;
		}
	}
	...
	public readonly int ShaderCacheControl (ShaderCacheKindFlags kinds, ShaderCacheControlFlags control) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->ShaderCacheControl (ptr, kinds, control);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateCommandQueue1 (CommandQueueDesc* pDesc, Guid creatorID, Guid riid, void** ppCommandQueue) {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateCommandQueue1 (ptr, pDesc, creatorID, riid, ppCommandQueue);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateCommandQueue1 (CommandQueueDesc* pDesc, Guid creatorID, Guid riid, out void* ppCommandQueue) {
		fixed (void** _ppCommandQueue = &ppCommandQueue) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateCommandQueue1 (ptr, pDesc, creatorID, riid, _ppCommandQueue);
			return hr;
		}
	}
	...
	public readonly int CreateCommittedResource3<T0> (HeapProperties* pHeapProperties, HeapFlags heapFlags, ResourceDesc1* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, T0* pProtectedSession, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riidResource, void** ppvResource) where T0 : unmanaged, IProtectedResourceSession {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateCommittedResource3 (ptr, pHeapProperties, heapFlags, pDesc, initialLayout, pOptimizedClearValue, pProtectedSession, numCastableFormats, pCastableFormats, riidResource, ppvResource);
		return hr;
	}
	...
	public readonly int CreateCommittedResource3<T0> (HeapProperties* pHeapProperties, HeapFlags heapFlags, ResourceDesc1* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, T0* pProtectedSession, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riidResource, out void* ppvResource) where T0 : unmanaged, IProtectedResourceSession {
		fixed (void** _ppvResource = &ppvResource) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateCommittedResource3 (ptr, pHeapProperties, heapFlags, pDesc, initialLayout, pOptimizedClearValue, pProtectedSession, numCastableFormats, pCastableFormats, riidResource, _ppvResource);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreatePlacedResource2<T0> (T0* pHeap, ulong heapOffset, ResourceDesc1* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riid, void** ppvResource) where T0 : unmanaged, IHeap {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreatePlacedResource2 (ptr, pHeap, heapOffset, pDesc, initialLayout, pOptimizedClearValue, numCastableFormats, pCastableFormats, riid, ppvResource);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreatePlacedResource2<T0> (T0* pHeap, ulong heapOffset, ResourceDesc1* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riid, out void* ppvResource) where T0 : unmanaged, IHeap {
		fixed (void** _ppvResource = &ppvResource) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreatePlacedResource2 (ptr, pHeap, heapOffset, pDesc, initialLayout, pOptimizedClearValue, numCastableFormats, pCastableFormats, riid, _ppvResource);
			return hr;
		}
	}
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateReservedResource2<T0> (ResourceDesc* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, T0* pProtectedSession, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riid, void** ppvResource) where T0 : unmanaged, IProtectedResourceSession {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->CreateReservedResource2 (ptr, pDesc, initialLayout, pOptimizedClearValue, pProtectedSession, numCastableFormats, pCastableFormats, riid, ppvResource);
		return hr;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int CreateReservedResource2<T0> (ResourceDesc* pDesc, BarrierLayout initialLayout, ClearValue* pOptimizedClearValue, T0* pProtectedSession, uint numCastableFormats, DXGI.Format* pCastableFormats, Guid riid, out void* ppvResource) where T0 : unmanaged, IProtectedResourceSession {
		fixed (void** _ppvResource = &ppvResource) {
			var ptr = GetCurrentPointer ();
			var hr = ((FunctionPointer*) ptr->_pointer)->CreateReservedResource2 (ptr, pDesc, initialLayout, pOptimizedClearValue, pProtectedSession, numCastableFormats, pCastableFormats, riid, _ppvResource);
			return hr;
		}
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 65
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, BackgroundProcessingMode, MeasurementsAction, IntPtr, uint*, int> SetBackgroundProcessingMode;
		/// <summary>
		/// OFFSET 66
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, StateObjectDesc*, void*, Guid, void**, int> AddToStateObject;
		/// <summary>
		/// OFFSET 67
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, ProtectedResourceSessionDesc1*, Guid, void**, int> CreateProtectedResourceSession1;
		/// <summary>
		/// OFFSET 68
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, uint, uint, ResourceDesc1*, ResourceAllocationInfo1*, ResourceAllocationInfo> GetResourceAllocationInfo2;
		/// <summary>
		/// OFFSET 69
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, HeapProperties*, HeapFlags, ResourceDesc1*, ResourceStates, ClearValue*, void*, Guid, void**, int> CreateCommittedResource2;
		/// <summary>
		/// OFFSET 70
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, ulong, ResourceDesc1*, ResourceStates, ClearValue*, Guid, void**, int> CreatePlacedResource1;
		/// <summary>
		/// OFFSET 71
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void*, CpuDescriptorHandle, void> CreateSamplerFeedbackUnorderedAccessView;
		/// <summary>
		/// OFFSET 72
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, ResourceDesc1*, uint, uint, ulong, PlacedSubresourceFootprint*, uint*, ulong*, ulong*, void> GetCopyableFootprints1;
		/// <summary>
		/// OFFSET 73
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, ShaderCacheSessionDesc*, Guid, void**, int> CreateShaderCacheSession;
		/// <summary>
		/// OFFSET 74
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, ShaderCacheKindFlags, ShaderCacheControlFlags, int> ShaderCacheControl;
		/// <summary>
		/// OFFSET 75
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, CommandQueueDesc*, Guid, Guid, void**, int> CreateCommandQueue1;
		/// <summary>
		/// OFFSET 76
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, HeapProperties*, HeapFlags, ResourceDesc1*, BarrierLayout, ClearValue*, void*, uint, DXGI.Format*, Guid, void**, int> CreateCommittedResource3;
		/// <summary>
		/// OFFSET 77
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, ulong, ResourceDesc1*, BarrierLayout, ClearValue*, uint, DXGI.Format*, Guid, void**, int> CreatePlacedResource2;
		/// <summary>
		/// OFFSET 78
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, ResourceDesc*, BarrierLayout, ClearValue*, void*, uint, DXGI.Format*, Guid, void**, int> CreateReservedResource2;
	}
