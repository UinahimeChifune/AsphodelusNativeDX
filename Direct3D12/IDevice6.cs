...
/// <summary>
/// INTERFACE <b>ID3D12Device6</b> : ID3D12Device5<br/>
/// D3D12.h
/// </summary>
unsafe public interface IDevice6 : IDevice5 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device6::SetBackgroundProcessingMode (D3D12_BACKGROUND_PROCESSING_MODE Mode, D3D12_MEASUREMENTS_ACTION MeasurementsAction, HANDLE hEventToSignalUponCompletion, BOOL* pbFurtherMeasurementsDesired)</b><br/>
	/// </summary>
	/// <param name="mode"><b>D3D12_BACKGROUND_PROCESSING_MODE Mode</b></param>
	/// <param name="measurementsAction"><b>D3D12_MEASUREMENTS_ACTION MeasurementsAction</b></param>
	/// <param name="hEventToSignalUponCompletion">_In_opt_ <b>HANDLE hEventToSignalUponCompletion</b></param>
	/// <param name="pbFurtherMeasurementsDesired">_Out_opt_ <b>BOOL* pbFurtherMeasurementsDesired</b></param>
	int SetBackgroundProcessingMode (BackgroundProcessingMode mode, MeasurementsAction measurementsAction, IntPtr hEventToSignalUponCompletion, uint* pbFurtherMeasurementsDesired);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device6::SetBackgroundProcessingMode (D3D12_BACKGROUND_PROCESSING_MODE Mode, D3D12_MEASUREMENTS_ACTION MeasurementsAction, HANDLE hEventToSignalUponCompletion, BOOL* pbFurtherMeasurementsDesired)</b><br/>
	/// </summary>
	/// <param name="mode"><b>D3D12_BACKGROUND_PROCESSING_MODE Mode</b></param>
	...
	/// <param name="hEventToSignalUponCompletion">_In_opt_ <b>HANDLE hEventToSignalUponCompletion</b></param>
	/// <param name="pbFurtherMeasurementsDesired">_Out_opt_ <b>BOOL* pbFurtherMeasurementsDesired</b></param>
	int SetBackgroundProcessingMode (BackgroundProcessingMode mode, MeasurementsAction measurementsAction, IntPtr hEventToSignalUponCompletion, out bool pbFurtherMeasurementsDesired);
}

/// <summary>
/// Instance of <b>ID3D12Device6</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct Device6 : IDevice6 {
	...
	static readonly Guid _guid = new (0xc70b221b, 0x40e4, 0x4a17, 0x89, 0xaf, 0x02, 0x5a, 0x07, 0x27, 0xa6, 0xdc);
