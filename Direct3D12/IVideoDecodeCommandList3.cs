...
/// <summary>
/// INTERFACE <b>ID3D12VideoDecodeCommandList3</b> : ID3D12VideoDecodeCommandList2<br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public interface IVideoDecodeCommandList3 : IVideoDecodeCommandList2 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12VideoDecodeCommandList3::Barrier (UINT32 NumBarrierGroups, D3D12_BARRIER_GROUP* pBarrierGroups)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>ID3D12VideoDecodeCommandList3</b><br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public readonly struct VideoDecodeCommandList3 : IVideoDecodeCommandList3 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly VideoDecodeCommandList3* GetCurrentPointer () => (VideoDecodeCommandList3*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x2aee8c37, 0x9562, 0x42da, 0x8a, 0xbf, 0x61, 0xef, 0xeb, 0x2e, 0x45, 0x13);
