...
/// <summary>
/// INTERFACE <b>ID3D12Device7</b> : ID3D12Device6<br/>
/// D3D12.h
/// </summary>
unsafe public interface IDevice7 : IDevice6 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device7::AddToStateObject (D3D12_STATE_OBJECT_DESC* pAddition, ID3D12StateObject* pStateObjectToGrowFrom, REFIID riid, void** ppNewStateObject)</b><br/>
	/// </summary>
	/// <param name="pAddition"><b>D3D12_STATE_OBJECT_DESC* pAddition</b></param>
	/// <param name="pStateObjectToGrowFrom"><b>ID3D12StateObject* pStateObjectToGrowFrom</b></param>
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppNewStateObject">_COM_Outptr_ <b>void** ppNewStateObject</b></param>
	int AddToStateObject<T0> (StateObjectDesc* pAddition, T0* pStateObjectToGrowFrom, Guid riid, void** ppNewStateObject) where T0 : unmanaged, IStateObject;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device7::AddToStateObject (D3D12_STATE_OBJECT_DESC* pAddition, ID3D12StateObject* pStateObjectToGrowFrom, REFIID riid, void** ppNewStateObject)</b><br/>
	/// </summary>
	/// <param name="pAddition"><b>D3D12_STATE_OBJECT_DESC* pAddition</b></param>
	...
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppNewStateObject">_COM_Outptr_ <b>void** ppNewStateObject</b></param>
	int AddToStateObject<T0> (StateObjectDesc* pAddition, T0* pStateObjectToGrowFrom, Guid riid, out void* ppNewStateObject) where T0 : unmanaged, IStateObject;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device7::CreateProtectedResourceSession1 (D3D12_PROTECTED_RESOURCE_SESSION_DESC1* pDesc, REFIID riid, void** ppSession)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_PROTECTED_RESOURCE_SESSION_DESC1* pDesc</b></param>
	/// <param name="riid">_In_ <b>REFIID riid</b></param>
	/// <param name="ppSession">_COM_Outptr_ <b>void** ppSession</b></param>
	int CreateProtectedResourceSession1 (ProtectedResourceSessionDesc1* pDesc, Guid riid, void** ppSession);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device7::CreateProtectedResourceSession1 (D3D12_PROTECTED_RESOURCE_SESSION_DESC1* pDesc, REFIID riid, void** ppSession)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_PROTECTED_RESOURCE_SESSION_DESC1* pDesc</b></param>
	/// <param name="riid">_In_ <b>REFIID riid</b></param>
	/// <param name="ppSession">_COM_Outptr_ <b>void** ppSession</b></param>
	int CreateProtectedResourceSession1 (ProtectedResourceSessionDesc1* pDesc, Guid riid, out void* ppSession);
}

/// <summary>
/// Instance of <b>ID3D12Device7</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct Device7 : IDevice7 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly Device7* GetCurrentPointer () => (Device7*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x5c014b53, 0x68a1, 0x4b9b, 0x8b, 0xd1, 0xdd, 0x60, 0x46, 0xb9, 0x35, 0x8b);
