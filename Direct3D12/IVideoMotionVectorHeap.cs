...
/// <summary>
/// INTERFACE <b>ID3D12VideoMotionVectorHeap</b> : ID3D12Pageable<br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public interface IVideoMotionVectorHeap : IPageable {
	/// <summary>
	/// STDMETHODCALLTYPE <b>D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC ID3D12VideoMotionVectorHeap::GetDesc ()</b><br/>
	/// </summary>
	VideoMotionVectorHeapDesc GetDesc ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12VideoMotionVectorHeap::GetProtectedResourceSession (REFIID riid, void** ppProtectedSession)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>ID3D12VideoMotionVectorHeap</b><br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public readonly struct VideoMotionVectorHeap : IVideoMotionVectorHeap {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly VideoMotionVectorHeap* GetCurrentPointer () => (VideoMotionVectorHeap*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x5be17987, 0x743a, 0x4061, 0x83, 0x4b, 0x23, 0xd2, 0x2d, 0xae, 0xa5, 0x05);
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 8
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, VideoMotionVectorHeapDesc> GetDesc;
		/// <summary>
		/// OFFSET 9
		/// </summary>
