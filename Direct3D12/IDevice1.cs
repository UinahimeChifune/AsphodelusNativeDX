...
/// <summary>
/// INTERFACE <b>ID3D12Device1</b> : ID3D12Device<br/>
/// D3D12.h
/// </summary>
unsafe public interface IDevice1 : IDevice {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device1::CreatePipelineLibrary (void* pLibraryBlob, SIZE_T BlobLength, REFIID riid, void** ppPipelineLibrary)</b><br/>
	/// </summary>
	/// <param name="pLibraryBlob">_In_reads_(BlobLength) <b>void* pLibraryBlob</b></param>
	/// <param name="blobLength"><b>SIZE_T BlobLength</b></param>
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppPipelineLibrary">_COM_Outptr_ <b>void** ppPipelineLibrary</b></param>
	int CreatePipelineLibrary (void* pLibraryBlob, nuint blobLength, Guid riid, void** ppPipelineLibrary);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device1::CreatePipelineLibrary (void* pLibraryBlob, SIZE_T BlobLength, REFIID riid, void** ppPipelineLibrary)</b><br/>
	/// </summary>
	/// <param name="pLibraryBlob">_In_reads_(BlobLength) <b>void* pLibraryBlob</b></param>
	...
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppPipelineLibrary">_COM_Outptr_ <b>void** ppPipelineLibrary</b></param>
	int CreatePipelineLibrary (void* pLibraryBlob, nuint blobLength, Guid riid, out void* ppPipelineLibrary);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device1::SetEventOnMultipleFenceCompletion (ID3D12Fence* ppFences, UINT64* pFenceValues, UINT NumFences, D3D12_MULTIPLE_FENCE_WAIT_FLAGS Flags, HANDLE hEvent)</b><br/>
	/// </summary>
	/// <param name="ppFences">_In_reads_(NumFences) <b>ID3D12Fence* ppFences</b></param>
	/// <param name="pFenceValues">_In_reads_(NumFences) <b>UINT64* pFenceValues</b></param>
	/// <param name="numFences"><b>UINT NumFences</b></param>
	/// <param name="flags"><b>D3D12_MULTIPLE_FENCE_WAIT_FLAGS Flags</b></param>
	/// <param name="hEvent"><b>HANDLE hEvent</b></param>
	int SetEventOnMultipleFenceCompletion<T0> (T0* ppFences, ulong* pFenceValues, uint numFences, MultipleFenceWaitFlags flags, IntPtr hEvent) where T0 : unmanaged, IFence;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device1::SetResidencyPriority (UINT NumObjects, ID3D12Pageable* ppObjects, D3D12_RESIDENCY_PRIORITY* pPriorities)</b><br/>
	/// </summary>
	...
	/// <param name="pPriorities">_In_reads_(NumObjects) <b>D3D12_RESIDENCY_PRIORITY* pPriorities</b></param>
	int SetResidencyPriority<T0> (uint numObjects, T0* ppObjects, ResidencyPriority* pPriorities) where T0 : unmanaged, IPageable;
}

/// <summary>
/// Instance of <b>ID3D12Device1</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct Device1 : IDevice1 {
	...
	static readonly Guid _guid = new (0x77acce80, 0x638e, 0x4e65, 0x88, 0x95, 0xc1, 0xf2, 0x33, 0x86, 0x86, 0x3e);
