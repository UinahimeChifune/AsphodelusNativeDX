...
/// <summary>
/// INTERFACE <b>ID3D12VideoDecoderHeap1</b> : ID3D12VideoDecoderHeap<br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public interface IVideoDecoderHeap1 : IVideoDecoderHeap {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12VideoDecoderHeap1::GetProtectedResourceSession (REFIID riid, void** ppProtectedSession)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>ID3D12VideoDecoderHeap1</b><br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public readonly struct VideoDecoderHeap1 : IVideoDecoderHeap1 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly VideoDecoderHeap1* GetCurrentPointer () => (VideoDecoderHeap1*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xda1d98c5, 0x539f, 0x41b2, 0xbf, 0x6b, 0x11, 0x98, 0xa0, 0x3b, 0x6d, 0x26);
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 8
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, VideoDecoderHeapDesc> GetDesc;
		/// <summary>
		/// OFFSET 9
		/// </summary>
