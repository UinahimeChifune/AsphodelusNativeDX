...
/// <summary>
/// INTERFACE <b>ID3D12Heap</b> : ID3D12Pageable<br/>
/// D3D12.h
/// </summary>
unsafe public interface IHeap : IPageable {
	/// <summary>
	/// STDMETHODCALLTYPE <b>D3D12_HEAP_DESC ID3D12Heap::GetDesc ()</b><br/>
	/// </summary>
	HeapDesc GetDesc ();
}

/// <summary>
/// Instance of <b>ID3D12Heap</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct Heap : IHeap {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly Heap* GetCurrentPointer () => (Heap*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x6b3b2502, 0x6e51, 0x45b3, 0x90, 0xee, 0x98, 0x84, 0x26, 0x5e, 0x8d, 0xf3);
