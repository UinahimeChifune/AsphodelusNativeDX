...
/// <summary>
/// INTERFACE <b>ID3D12CommandAllocator</b> : ID3D12Pageable<br/>
/// D3D12.h
/// </summary>
unsafe public interface ICommandAllocator : IPageable {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12CommandAllocator::Reset ()</b><br/>
	/// </summary>
	int Reset ();
}

/// <summary>
/// Instance of <b>ID3D12CommandAllocator</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct CommandAllocator : ICommandAllocator {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly CommandAllocator* GetCurrentPointer () => (CommandAllocator*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x6102dee4, 0xaf59, 0x4b09, 0xb9, 0x99, 0xb4, 0x4d, 0x73, 0xf0, 0x9b, 0x24);
