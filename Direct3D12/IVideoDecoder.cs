...
/// <summary>
/// INTERFACE <b>ID3D12VideoDecoder</b> : ID3D12Pageable<br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public interface IVideoDecoder : IPageable {
	/// <summary>
	/// STDMETHODCALLTYPE <b>D3D12_VIDEO_DECODER_DESC ID3D12VideoDecoder::GetDesc ()</b><br/>
	/// </summary>
	VideoDecoderDesc GetDesc ();
}

/// <summary>
/// Instance of <b>ID3D12VideoDecoder</b><br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public readonly struct VideoDecoder : IVideoDecoder {
	...
	static readonly Guid _guid = new (0xc59b6bdc, 0x7720, 0x4074, 0xa1, 0x36, 0x17, 0xa1, 0x56, 0x03, 0x74, 0x70);
