...
/// <summary>
/// INTERFACE <b>ID3D12Device9</b> : ID3D12Device8<br/>
/// D3D12.h
/// </summary>
unsafe public interface IDevice9 : IDevice8 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device9::CreateShaderCacheSession (D3D12_SHADER_CACHE_SESSION_DESC* pDesc, REFIID riid, void** ppvSession)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_SHADER_CACHE_SESSION_DESC* pDesc</b></param>
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvSession">_COM_Outptr_opt_ <b>void** ppvSession</b></param>
	int CreateShaderCacheSession (ShaderCacheSessionDesc* pDesc, Guid riid, void** ppvSession);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device9::CreateShaderCacheSession (D3D12_SHADER_CACHE_SESSION_DESC* pDesc, REFIID riid, void** ppvSession)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_SHADER_CACHE_SESSION_DESC* pDesc</b></param>
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvSession">_COM_Outptr_opt_ <b>void** ppvSession</b></param>
	int CreateShaderCacheSession (ShaderCacheSessionDesc* pDesc, Guid riid, out void* ppvSession);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device9::ShaderCacheControl (D3D12_SHADER_CACHE_KIND_FLAGS Kinds, D3D12_SHADER_CACHE_CONTROL_FLAGS Control)</b><br/>
	/// </summary>
	/// <param name="kinds"><b>D3D12_SHADER_CACHE_KIND_FLAGS Kinds</b></param>
	/// <param name="control"><b>D3D12_SHADER_CACHE_CONTROL_FLAGS Control</b></param>
	int ShaderCacheControl (ShaderCacheKindFlags kinds, ShaderCacheControlFlags control);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device9::CreateCommandQueue1 (D3D12_COMMAND_QUEUE_DESC* pDesc, REFIID CreatorID, REFIID riid, void** ppCommandQueue)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_COMMAND_QUEUE_DESC* pDesc</b></param>
	/// <param name="creatorID"><b>REFIID CreatorID</b></param>
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppCommandQueue">_COM_Outptr_ <b>void** ppCommandQueue</b></param>
	int CreateCommandQueue1 (CommandQueueDesc* pDesc, Guid creatorID, Guid riid, void** ppCommandQueue);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device9::CreateCommandQueue1 (D3D12_COMMAND_QUEUE_DESC* pDesc, REFIID CreatorID, REFIID riid, void** ppCommandQueue)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_COMMAND_QUEUE_DESC* pDesc</b></param>
	...
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppCommandQueue">_COM_Outptr_ <b>void** ppCommandQueue</b></param>
	int CreateCommandQueue1 (CommandQueueDesc* pDesc, Guid creatorID, Guid riid, out void* ppCommandQueue);
}

/// <summary>
/// Instance of <b>ID3D12Device9</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct Device9 : IDevice9 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly Device9* GetCurrentPointer () => (Device9*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x4c80e962, 0xf032, 0x4f60, 0xbc, 0x9e, 0xeb, 0xc2, 0xcf, 0xa1, 0xd8, 0x3c);
