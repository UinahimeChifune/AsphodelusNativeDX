...
/// <summary>
/// INTERFACE <b>ID3D12Device3</b> : ID3D12Device2<br/>
/// D3D12.h
/// </summary>
unsafe public interface IDevice3 : IDevice2 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device3::OpenExistingHeapFromAddress (void* pAddress, REFIID riid, void** ppvHeap)</b><br/>
	/// </summary>
	/// <param name="pAddress">_In_ <b>void* pAddress</b></param>
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvHeap">_COM_Outptr_ <b>void** ppvHeap</b></param>
	int OpenExistingHeapFromAddress (void* pAddress, Guid riid, void** ppvHeap);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device3::OpenExistingHeapFromAddress (void* pAddress, REFIID riid, void** ppvHeap)</b><br/>
	/// </summary>
	/// <param name="pAddress">_In_ <b>void* pAddress</b></param>
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvHeap">_COM_Outptr_ <b>void** ppvHeap</b></param>
	int OpenExistingHeapFromAddress (void* pAddress, Guid riid, out void* ppvHeap);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device3::OpenExistingHeapFromFileMapping (HANDLE hFileMapping, REFIID riid, void** ppvHeap)</b><br/>
	/// </summary>
	/// <param name="hFileMapping">_In_ <b>HANDLE hFileMapping</b></param>
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvHeap">_COM_Outptr_ <b>void** ppvHeap</b></param>
	int OpenExistingHeapFromFileMapping (IntPtr hFileMapping, Guid riid, void** ppvHeap);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device3::OpenExistingHeapFromFileMapping (HANDLE hFileMapping, REFIID riid, void** ppvHeap)</b><br/>
	/// </summary>
	/// <param name="hFileMapping">_In_ <b>HANDLE hFileMapping</b></param>
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvHeap">_COM_Outptr_ <b>void** ppvHeap</b></param>
	int OpenExistingHeapFromFileMapping (IntPtr hFileMapping, Guid riid, out void* ppvHeap);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device3::EnqueueMakeResident (D3D12_RESIDENCY_FLAGS Flags, UINT NumObjects, ID3D12Pageable* ppObjects, ID3D12Fence* pFenceToSignal, UINT64 FenceValueToSignal)</b><br/>
	/// </summary>
	/// <param name="flags"><b>D3D12_RESIDENCY_FLAGS Flags</b></param>
	...
	/// <param name="pFenceToSignal">_In_ <b>ID3D12Fence* pFenceToSignal</b></param>
	/// <param name="fenceValueToSignal"><b>UINT64 FenceValueToSignal</b></param>
	int EnqueueMakeResident<T0, T1> (ResidencyFlags flags, uint numObjects, T0* ppObjects, T1* pFenceToSignal, ulong fenceValueToSignal) where T0 : unmanaged, IPageable where T1 : unmanaged, IFence;
}

/// <summary>
/// Instance of <b>ID3D12Device3</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct Device3 : IDevice3 {
	...
	static readonly Guid _guid = new (0x81dadc15, 0x2bad, 0x4392, 0x93, 0xc5, 0x10, 0x13, 0x45, 0xc4, 0xaa, 0x98);
