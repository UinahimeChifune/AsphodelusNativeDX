...
/// <summary>
/// INTERFACE <b>ID3D12StateObject</b> : ID3D12Pageable<br/>
/// D3D12.h
/// </summary>
unsafe public interface IStateObject : IPageable {
}

/// <summary>
/// Instance of <b>ID3D12StateObject</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct StateObject : IStateObject {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly StateObject* GetCurrentPointer () => (StateObject*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x47016943, 0xfca8, 0x4594, 0x93, 0xea, 0xaf, 0x25, 0x8b, 0x55, 0x34, 0x6d);
