...
/// <summary>
/// INTERFACE <b>ID3D12GraphicsCommandList2</b> : ID3D12GraphicsCommandList1<br/>
/// D3D12.h
/// </summary>
unsafe public interface IGraphicsCommandList2 : IGraphicsCommandList1 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList2::WriteBufferImmediate (UINT Count, D3D12_WRITEBUFFERIMMEDIATE_PARAMETER* pParams, D3D12_WRITEBUFFERIMMEDIATE_MODE* pModes)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>ID3D12GraphicsCommandList2</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct GraphicsCommandList2 : IGraphicsCommandList2 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly GraphicsCommandList2* GetCurrentPointer () => (GraphicsCommandList2*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x38c3e585, 0xff17, 0x412c, 0x91, 0x50, 0x4f, 0xc6, 0xf9, 0xd7, 0x2a, 0x28);
