...
/// <summary>
/// INTERFACE <b>ID3D12GraphicsCommandList4</b> : ID3D12GraphicsCommandList3<br/>
/// D3D12.h
/// </summary>
unsafe public interface IGraphicsCommandList4 : IGraphicsCommandList3 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList4::BeginRenderPass (UINT NumRenderTargets, D3D12_RENDER_PASS_RENDER_TARGET_DESC* pRenderTargets, D3D12_RENDER_PASS_DEPTH_STENCIL_DESC* pDepthStencil, D3D12_RENDER_PASS_FLAGS Flags)</b><br/>
	/// </summary>
	/// <param name="numRenderTargets">_In_ <b>UINT NumRenderTargets</b></param>
	/// <param name="pRenderTargets">_In_reads_opt_(NumRenderTargets) <b>D3D12_RENDER_PASS_RENDER_TARGET_DESC* pRenderTargets</b></param>
	/// <param name="pDepthStencil">_In_opt_ <b>D3D12_RENDER_PASS_DEPTH_STENCIL_DESC* pDepthStencil</b></param>
	/// <param name="flags"><b>D3D12_RENDER_PASS_FLAGS Flags</b></param>
	void BeginRenderPass (uint numRenderTargets, RenderPassRenderTargetDesc* pRenderTargets, RenderPassDepthStencilDesc* pDepthStencil, RenderPassFlags flags);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList4::EndRenderPass ()</b><br/>
	/// </summary>
	void EndRenderPass ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList4::InitializeMetaCommand (ID3D12MetaCommand* pMetaCommand, void* pInitializationParametersData, SIZE_T InitializationParametersDataSizeInBytes)</b><br/>
	/// </summary>
	/// <param name="pMetaCommand">_In_ <b>ID3D12MetaCommand* pMetaCommand</b></param>
	/// <param name="pInitializationParametersData">_In_reads_bytes_opt_(InitializationParametersDataSizeInBytes) <b>void* pInitializationParametersData</b></param>
	/// <param name="initializationParametersDataSizeInBytes">_In_ <b>SIZE_T InitializationParametersDataSizeInBytes</b></param>
	void InitializeMetaCommand<T0> (T0* pMetaCommand, void* pInitializationParametersData, nuint initializationParametersDataSizeInBytes) where T0 : unmanaged, IMetaCommand;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList4::ExecuteMetaCommand (ID3D12MetaCommand* pMetaCommand, void* pExecutionParametersData, SIZE_T ExecutionParametersDataSizeInBytes)</b><br/>
	/// </summary>
	/// <param name="pMetaCommand">_In_ <b>ID3D12MetaCommand* pMetaCommand</b></param>
	/// <param name="pExecutionParametersData">_In_reads_bytes_opt_(ExecutionParametersDataSizeInBytes) <b>void* pExecutionParametersData</b></param>
	/// <param name="executionParametersDataSizeInBytes">_In_ <b>SIZE_T ExecutionParametersDataSizeInBytes</b></param>
	void ExecuteMetaCommand<T0> (T0* pMetaCommand, void* pExecutionParametersData, nuint executionParametersDataSizeInBytes) where T0 : unmanaged, IMetaCommand;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList4::BuildRaytracingAccelerationStructure (D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC* pDesc, UINT NumPostbuildInfoDescs, D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC* pPostbuildInfoDescs)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC* pDesc</b></param>
	/// <param name="numPostbuildInfoDescs">_In_ <b>UINT NumPostbuildInfoDescs</b></param>
	/// <param name="pPostbuildInfoDescs">_In_reads_opt_(NumPostbuildInfoDescs) <b>D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC* pPostbuildInfoDescs</b></param>
	void BuildRaytracingAccelerationStructure (BuildRaytracingAccelerationStructureDesc* pDesc, uint numPostbuildInfoDescs, RaytracingAccelerationStructurePostbuildInfoDesc* pPostbuildInfoDescs);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList4::EmitRaytracingAccelerationStructurePostbuildInfo (D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC* pDesc, UINT NumSourceAccelerationStructures, D3D12_GPU_VIRTUAL_ADDRESS* pSourceAccelerationStructureData)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC* pDesc</b></param>
	/// <param name="numSourceAccelerationStructures">_In_ <b>UINT NumSourceAccelerationStructures</b></param>
	/// <param name="pSourceAccelerationStructureData">_In_reads_( NumSourceAccelerationStructures ) <b>D3D12_GPU_VIRTUAL_ADDRESS* pSourceAccelerationStructureData</b></param>
	void EmitRaytracingAccelerationStructurePostbuildInfo (RaytracingAccelerationStructurePostbuildInfoDesc* pDesc, uint numSourceAccelerationStructures, ulong* pSourceAccelerationStructureData);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList4::CopyRaytracingAccelerationStructure (D3D12_GPU_VIRTUAL_ADDRESS DestAccelerationStructureData, D3D12_GPU_VIRTUAL_ADDRESS SourceAccelerationStructureData, D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE Mode)</b><br/>
	/// </summary>
	/// <param name="destAccelerationStructureData">_In_ <b>D3D12_GPU_VIRTUAL_ADDRESS DestAccelerationStructureData</b></param>
	/// <param name="sourceAccelerationStructureData">_In_ <b>D3D12_GPU_VIRTUAL_ADDRESS SourceAccelerationStructureData</b></param>
	/// <param name="mode">_In_ <b>D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE Mode</b></param>
	...
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList4::SetPipelineState1 (ID3D12StateObject* pStateObject)</b><br/>
	/// </summary>
	/// <param name="pStateObject">_In_ <b>ID3D12StateObject* pStateObject</b></param>
	void SetPipelineState1<T0> (T0* pStateObject) where T0 : unmanaged, IStateObject;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList4::DispatchRays (D3D12_DISPATCH_RAYS_DESC* pDesc)</b><br/>
	/// </summary>
	/// <param name="pDesc">_In_ <b>D3D12_DISPATCH_RAYS_DESC* pDesc</b></param>
	void DispatchRays (DispatchRaysDesc* pDesc);
}

/// <summary>
/// Instance of <b>ID3D12GraphicsCommandList4</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct GraphicsCommandList4 : IGraphicsCommandList4 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly GraphicsCommandList4* GetCurrentPointer () => (GraphicsCommandList4*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x8754318e, 0xd3a9, 0x4541, 0x98, 0xcf, 0x64, 0x5b, 0x50, 0xdc, 0x48, 0x74);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void BeginRenderPass (uint numRenderTargets, RenderPassRenderTargetDesc* pRenderTargets, RenderPassDepthStencilDesc* pDepthStencil, RenderPassFlags flags) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->BeginRenderPass (ptr, numRenderTargets, pRenderTargets, pDepthStencil, flags);
		return;
	}
	...
	public readonly void EndRenderPass () {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->EndRenderPass (ptr);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void InitializeMetaCommand<T0> (T0* pMetaCommand, void* pInitializationParametersData, nuint initializationParametersDataSizeInBytes) where T0 : unmanaged, IMetaCommand {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->InitializeMetaCommand (ptr, pMetaCommand, pInitializationParametersData, initializationParametersDataSizeInBytes);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void ExecuteMetaCommand<T0> (T0* pMetaCommand, void* pExecutionParametersData, nuint executionParametersDataSizeInBytes) where T0 : unmanaged, IMetaCommand {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->ExecuteMetaCommand (ptr, pMetaCommand, pExecutionParametersData, executionParametersDataSizeInBytes);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void BuildRaytracingAccelerationStructure (BuildRaytracingAccelerationStructureDesc* pDesc, uint numPostbuildInfoDescs, RaytracingAccelerationStructurePostbuildInfoDesc* pPostbuildInfoDescs) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->BuildRaytracingAccelerationStructure (ptr, pDesc, numPostbuildInfoDescs, pPostbuildInfoDescs);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void EmitRaytracingAccelerationStructurePostbuildInfo (RaytracingAccelerationStructurePostbuildInfoDesc* pDesc, uint numSourceAccelerationStructures, ulong* pSourceAccelerationStructureData) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->EmitRaytracingAccelerationStructurePostbuildInfo (ptr, pDesc, numSourceAccelerationStructures, pSourceAccelerationStructureData);
		return;
	}
	...
	public readonly void CopyRaytracingAccelerationStructure (ulong destAccelerationStructureData, ulong sourceAccelerationStructureData, RaytracingAccelerationStructureCopyMode mode) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->CopyRaytracingAccelerationStructure (ptr, destAccelerationStructureData, sourceAccelerationStructureData, mode);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void SetPipelineState1<T0> (T0* pStateObject) where T0 : unmanaged, IStateObject {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->SetPipelineState1 (ptr, pStateObject);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void DispatchRays (DispatchRaysDesc* pDesc) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->DispatchRays (ptr, pDesc);
		return;
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 68
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, uint, RenderPassRenderTargetDesc*, RenderPassDepthStencilDesc*, RenderPassFlags, void> BeginRenderPass;
		/// <summary>
		/// OFFSET 69
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void> EndRenderPass;
		/// <summary>
		/// OFFSET 70
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void*, nuint, void> InitializeMetaCommand;
		/// <summary>
		/// OFFSET 71
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void*, nuint, void> ExecuteMetaCommand;
		/// <summary>
		/// OFFSET 72
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, BuildRaytracingAccelerationStructureDesc*, uint, RaytracingAccelerationStructurePostbuildInfoDesc*, void> BuildRaytracingAccelerationStructure;
		/// <summary>
		/// OFFSET 73
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, RaytracingAccelerationStructurePostbuildInfoDesc*, uint, ulong*, void> EmitRaytracingAccelerationStructurePostbuildInfo;
		/// <summary>
		/// OFFSET 74
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, ulong, ulong, RaytracingAccelerationStructureCopyMode, void> CopyRaytracingAccelerationStructure;
		/// <summary>
		/// OFFSET 75
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void> SetPipelineState1;
		/// <summary>
		/// OFFSET 76
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, DispatchRaysDesc*, void> DispatchRays;
	}
