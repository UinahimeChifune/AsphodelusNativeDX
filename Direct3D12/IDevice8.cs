...
/// <summary>
/// INTERFACE <b>ID3D12Device8</b> : ID3D12Device7<br/>
/// D3D12.h
/// </summary>
unsafe public interface IDevice8 : IDevice7 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>D3D12_RESOURCE_ALLOCATION_INFO ID3D12Device8::GetResourceAllocationInfo2 (UINT visibleMask, UINT numResourceDescs, D3D12_RESOURCE_DESC1* pResourceDescs, D3D12_RESOURCE_ALLOCATION_INFO1* pResourceAllocationInfo1)</b><br/>
	/// </summary>
	/// <param name="visibleMask"><b>UINT visibleMask</b></param>
	/// <param name="numResourceDescs"><b>UINT numResourceDescs</b></param>
	/// <param name="pResourceDescs">_In_reads_(numResourceDescs) <b>D3D12_RESOURCE_DESC1* pResourceDescs</b></param>
	...
	ResourceAllocationInfo GetResourceAllocationInfo2 (uint visibleMask, uint numResourceDescs, ResourceDesc1* pResourceDescs, ResourceAllocationInfo1* pResourceAllocationInfo1);
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device8::CreateCommittedResource2 (D3D12_HEAP_PROPERTIES* pHeapProperties, D3D12_HEAP_FLAGS HeapFlags, D3D12_RESOURCE_DESC1* pDesc, D3D12_RESOURCE_STATES InitialResourceState, D3D12_CLEAR_VALUE* pOptimizedClearValue, ID3D12ProtectedResourceSession* pProtectedSession, REFIID riidResource, void** ppvResource)</b><br/>
	/// </summary>
	...
	int CreateCommittedResource2<T0> (HeapProperties* pHeapProperties, HeapFlags heapFlags, ResourceDesc1* pDesc, ResourceStates initialResourceState, ClearValue* pOptimizedClearValue, T0* pProtectedSession, Guid riidResource, void** ppvResource) where T0 : unmanaged, IProtectedResourceSession;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device8::CreateCommittedResource2 (D3D12_HEAP_PROPERTIES* pHeapProperties, D3D12_HEAP_FLAGS HeapFlags, D3D12_RESOURCE_DESC1* pDesc, D3D12_RESOURCE_STATES InitialResourceState, D3D12_CLEAR_VALUE* pOptimizedClearValue, ID3D12ProtectedResourceSession* pProtectedSession, REFIID riidResource, void** ppvResource)</b><br/>
	/// </summary>
	/// <param name="pHeapProperties">_In_ <b>D3D12_HEAP_PROPERTIES* pHeapProperties</b></param>
	...
	/// <param name="riidResource"><b>REFIID riidResource</b></param>
	/// <param name="ppvResource">_COM_Outptr_opt_ <b>void** ppvResource</b></param>
	int CreateCommittedResource2<T0> (HeapProperties* pHeapProperties, HeapFlags heapFlags, ResourceDesc1* pDesc, ResourceStates initialResourceState, ClearValue* pOptimizedClearValue, T0* pProtectedSession, Guid riidResource, out void* ppvResource) where T0 : unmanaged, IProtectedResourceSession;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device8::CreatePlacedResource1 (ID3D12Heap* pHeap, UINT64 HeapOffset, D3D12_RESOURCE_DESC1* pDesc, D3D12_RESOURCE_STATES InitialState, D3D12_CLEAR_VALUE* pOptimizedClearValue, REFIID riid, void** ppvResource)</b><br/>
	/// </summary>
	...
	/// <param name="ppvResource">_COM_Outptr_opt_ <b>void** ppvResource</b></param>
	int CreatePlacedResource1<T0> (T0* pHeap, ulong heapOffset, ResourceDesc1* pDesc, ResourceStates initialState, ClearValue* pOptimizedClearValue, Guid riid, void** ppvResource) where T0 : unmanaged, IHeap;
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12Device8::CreatePlacedResource1 (ID3D12Heap* pHeap, UINT64 HeapOffset, D3D12_RESOURCE_DESC1* pDesc, D3D12_RESOURCE_STATES InitialState, D3D12_CLEAR_VALUE* pOptimizedClearValue, REFIID riid, void** ppvResource)</b><br/>
	/// </summary>
	/// <param name="pHeap">_In_ <b>ID3D12Heap* pHeap</b></param>
	...
	/// <param name="riid"><b>REFIID riid</b></param>
	/// <param name="ppvResource">_COM_Outptr_opt_ <b>void** ppvResource</b></param>
	int CreatePlacedResource1<T0> (T0* pHeap, ulong heapOffset, ResourceDesc1* pDesc, ResourceStates initialState, ClearValue* pOptimizedClearValue, Guid riid, out void* ppvResource) where T0 : unmanaged, IHeap;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12Device8::CreateSamplerFeedbackUnorderedAccessView (ID3D12Resource* pTargetedResource, ID3D12Resource* pFeedbackResource, D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor)</b><br/>
	/// </summary>
	/// <param name="pTargetedResource">_In_opt_ <b>ID3D12Resource* pTargetedResource</b></param>
	/// <param name="pFeedbackResource">_In_opt_ <b>ID3D12Resource* pFeedbackResource</b></param>
	/// <param name="destDescriptor">_In_ <b>D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor</b></param>
	void CreateSamplerFeedbackUnorderedAccessView<T0, T1> (T0* pTargetedResource, T1* pFeedbackResource, CpuDescriptorHandle destDescriptor) where T0 : unmanaged, IResource where T1 : unmanaged, IResource;
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12Device8::GetCopyableFootprints1 (D3D12_RESOURCE_DESC1* pResourceDesc, UINT FirstSubresource, UINT NumSubresources, UINT64 BaseOffset, D3D12_PLACED_SUBRESOURCE_FOOTPRINT* pLayouts, UINT* pNumRows, UINT64* pRowSizeInBytes, UINT64* pTotalBytes)</b><br/>
	/// </summary>
	/// <param name="pResourceDesc">_In_ <b>D3D12_RESOURCE_DESC1* pResourceDesc</b></param>
	...
	void GetCopyableFootprints1 (ResourceDesc1* pResourceDesc, uint firstSubresource, uint numSubresources, ulong baseOffset, PlacedSubresourceFootprint* pLayouts, uint* pNumRows, ulong* pRowSizeInBytes, ulong* pTotalBytes);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12Device8::GetCopyableFootprints1 (D3D12_RESOURCE_DESC1* pResourceDesc, UINT FirstSubresource, UINT NumSubresources, UINT64 BaseOffset, D3D12_PLACED_SUBRESOURCE_FOOTPRINT* pLayouts, UINT* pNumRows, UINT64* pRowSizeInBytes, UINT64* pTotalBytes)</b><br/>
	/// </summary>
	/// <param name="pResourceDesc">_In_ <b>D3D12_RESOURCE_DESC1* pResourceDesc</b></param>
	...
	/// <param name="pRowSizeInBytes">_Out_writes_opt_(NumSubresources) <b>UINT64* pRowSizeInBytes</b></param>
	/// <param name="pTotalBytes">_Out_opt_ <b>UINT64* pTotalBytes</b></param>
	void GetCopyableFootprints1 (ResourceDesc1* pResourceDesc, uint firstSubresource, uint numSubresources, ulong baseOffset, PlacedSubresourceFootprint* pLayouts, uint* pNumRows, ulong* pRowSizeInBytes, out ulong pTotalBytes);
}

/// <summary>
/// Instance of <b>ID3D12Device8</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct Device8 : IDevice8 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly Device8* GetCurrentPointer () => (Device8*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x9218e6bb, 0xf944, 0x4f7e, 0xa7, 0x5c, 0xb1, 0xb2, 0xc7, 0xb7, 0x01, 0xf3);
