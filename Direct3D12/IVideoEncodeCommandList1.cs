...
/// <summary>
/// INTERFACE <b>ID3D12VideoEncodeCommandList1</b> : ID3D12VideoEncodeCommandList<br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public interface IVideoEncodeCommandList1 : IVideoEncodeCommandList {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12VideoEncodeCommandList1::InitializeExtensionCommand (ID3D12VideoExtensionCommand* pExtensionCommand, void* pInitializationParameters, SIZE_T InitializationParametersSizeInBytes)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12VideoEncodeCommandList1::ExecuteExtensionCommand (ID3D12VideoExtensionCommand* pExtensionCommand, void* pExecutionParameters, SIZE_T ExecutionParametersSizeInBytes)</b><br/>
	/// </summary>
	/// <param name="pExtensionCommand">_In_ <b>ID3D12VideoExtensionCommand* pExtensionCommand</b></param>
...
/// <summary>
/// Instance of <b>ID3D12VideoEncodeCommandList1</b><br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public readonly struct VideoEncodeCommandList1 : IVideoEncodeCommandList1 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly VideoEncodeCommandList1* GetCurrentPointer () => (VideoEncodeCommandList1*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x94971eca, 0x2bdb, 0x4769, 0x88, 0xcf, 0x36, 0x75, 0xea, 0x75, 0x7e, 0xbc);
