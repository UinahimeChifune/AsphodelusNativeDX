...
/// <summary>
/// INTERFACE <b>ID3D12VideoExtensionCommand</b> : ID3D12Pageable<br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public interface IVideoExtensionCommand : IPageable {
	/// <summary>
	/// STDMETHODCALLTYPE <b>D3D12_VIDEO_EXTENSION_COMMAND_DESC ID3D12VideoExtensionCommand::GetDesc ()</b><br/>
	/// </summary>
	VideoExtensionCommandDesc GetDesc ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12VideoExtensionCommand::GetProtectedResourceSession (REFIID riid, void** ppProtectedSession)</b><br/>
	/// </summary>
...
/// <summary>
/// Instance of <b>ID3D12VideoExtensionCommand</b><br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public readonly struct VideoExtensionCommand : IVideoExtensionCommand {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly VideoExtensionCommand* GetCurrentPointer () => (VideoExtensionCommand*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x554e41e8, 0xae8e, 0x4a8c, 0xb7, 0xd2, 0x5b, 0x4f, 0x27, 0x4a, 0x30, 0xe4);
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 8
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, VideoExtensionCommandDesc> GetDesc;
		/// <summary>
		/// OFFSET 9
		/// </summary>
