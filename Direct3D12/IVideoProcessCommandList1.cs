...
/// <summary>
/// INTERFACE <b>ID3D12VideoProcessCommandList1</b> : ID3D12VideoProcessCommandList<br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public interface IVideoProcessCommandList1 : IVideoProcessCommandList {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12VideoProcessCommandList1::ProcessFrames1 (ID3D12VideoProcessor* pVideoProcessor, D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTS* pOutputArguments, UINT NumInputStreams, D3D12_VIDEO_PROCESS_INPUT_STREAM_ARGUMENTS1* pInputArguments)</b><br/>
	/// </summary>
	...
	/// <param name="pInputArguments">_In_reads_(NumInputStreams) <b>D3D12_VIDEO_PROCESS_INPUT_STREAM_ARGUMENTS1* pInputArguments</b></param>
	void ProcessFrames1<T0> (T0* pVideoProcessor, VideoProcessOutputStreamArguments* pOutputArguments, uint numInputStreams, VideoProcessInputStreamArguments1* pInputArguments) where T0 : unmanaged, IVideoProcessor;
}

/// <summary>
/// Instance of <b>ID3D12VideoProcessCommandList1</b><br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public readonly struct VideoProcessCommandList1 : IVideoProcessCommandList1 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly VideoProcessCommandList1* GetCurrentPointer () => (VideoProcessCommandList1*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x542c5c4d, 0x7596, 0x434f, 0x8c, 0x93, 0x4e, 0xfa, 0x67, 0x66, 0xf2, 0x67);
