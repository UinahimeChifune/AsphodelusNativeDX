...
/// <summary>
/// INTERFACE <b>ID3D12DebugCommandList2</b> : ID3D12DebugCommandList<br/>
/// D3D12SDKLAYERS.h
/// </summary>
unsafe public interface IDebugCommandList2 : IDebugCommandList {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12DebugCommandList2::SetDebugParameter (D3D12_DEBUG_COMMAND_LIST_PARAMETER_TYPE Type, void* pData, UINT DataSize)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12DebugCommandList2::GetDebugParameter (D3D12_DEBUG_COMMAND_LIST_PARAMETER_TYPE Type, void* pData, UINT DataSize)</b><br/>
	/// </summary>
	/// <param name="type"><b>D3D12_DEBUG_COMMAND_LIST_PARAMETER_TYPE Type</b></param>
...
/// <summary>
/// Instance of <b>ID3D12DebugCommandList2</b><br/>
/// D3D12SDKLAYERS.h
/// </summary>
unsafe public readonly struct DebugCommandList2 : IDebugCommandList2 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly DebugCommandList2* GetCurrentPointer () => (DebugCommandList2*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xaeb575cf, 0x4e06, 0x48be, 0xba, 0x3b, 0xc4, 0x50, 0xfc, 0x96, 0x65, 0x2e);
