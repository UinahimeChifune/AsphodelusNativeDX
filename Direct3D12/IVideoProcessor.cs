...
/// <summary>
/// INTERFACE <b>ID3D12VideoProcessor</b> : ID3D12Pageable<br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public interface IVideoProcessor : IPageable {
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT ID3D12VideoProcessor::GetNodeMask ()</b><br/>
	/// </summary>
	uint GetNodeMask ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>UINT ID3D12VideoProcessor::GetNumInputStreamDescs ()</b><br/>
	/// </summary>
	uint GetNumInputStreamDescs ();
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT ID3D12VideoProcessor::GetInputStreamDescs (UINT NumInputStreamDescs, D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC* pInputStreamDescs)</b><br/>
	/// </summary>
	/// <param name="numInputStreamDescs"><b>UINT NumInputStreamDescs</b></param>
	/// <param name="pInputStreamDescs">_Out_writes_(NumInputStreamDescs) <b>D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC* pInputStreamDescs</b></param>
	int GetInputStreamDescs (uint numInputStreamDescs, VideoProcessInputStreamDesc* pInputStreamDescs);
	/// <summary>
	/// STDMETHODCALLTYPE <b>D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC ID3D12VideoProcessor::GetOutputStreamDesc ()</b><br/>
	/// </summary>
	VideoProcessOutputStreamDesc GetOutputStreamDesc ();
}

/// <summary>
/// Instance of <b>ID3D12VideoProcessor</b><br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public readonly struct VideoProcessor : IVideoProcessor {
	...
	static readonly Guid _guid = new (0x304fdb32, 0xbede, 0x410a, 0x85, 0x45, 0x94, 0x3a, 0xc6, 0xa4, 0x61, 0x38);
