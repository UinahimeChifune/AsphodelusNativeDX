...
/// <summary>
/// INTERFACE <b>ID3D12CommandList</b> : ID3D12DeviceChild<br/>
/// D3D12.h
/// </summary>
unsafe public interface ICommandList : IDeviceChild {
	/// <summary>
	/// STDMETHODCALLTYPE <b>D3D12_COMMAND_LIST_TYPE ID3D12CommandList::GetType ()</b><br/>
	/// </summary>
	CommandListType GetCommandListType ();
}

/// <summary>
/// Instance of <b>ID3D12CommandList</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct CommandList : ICommandList {
	...
	static readonly Guid _guid = new (0x7116d91c, 0xe7e4, 0x47ce, 0xb8, 0xc6, 0xec, 0x81, 0x68, 0xf4, 0x37, 0xe5);
