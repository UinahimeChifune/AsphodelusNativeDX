...
/// <summary>
/// INTERFACE <b>ID3D12GraphicsCommandList5</b> : ID3D12GraphicsCommandList4<br/>
/// D3D12.h
/// </summary>
unsafe public interface IGraphicsCommandList5 : IGraphicsCommandList4 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList5::RSSetShadingRate (D3D12_SHADING_RATE baseShadingRate, D3D12_SHADING_RATE_COMBINER* combiners)</b><br/>
	/// </summary>
	/// <param name="baseShadingRate">_In_ <b>D3D12_SHADING_RATE baseShadingRate</b></param>
	/// <param name="combiners">_In_reads_opt_(D3D12_RS_SET_SHADING_RATE_COMBINER_COUNT) <b>D3D12_SHADING_RATE_COMBINER* combiners</b></param>
	void RSSetShadingRate (ShadingRate baseShadingRate, ShadingRateCombiner* combiners);
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12GraphicsCommandList5::RSSetShadingRateImage (ID3D12Resource* shadingRateImage)</b><br/>
	/// </summary>
	/// <param name="shadingRateImage">_In_opt_ <b>ID3D12Resource* shadingRateImage</b></param>
	void RSSetShadingRateImage<T0> (T0* shadingRateImage) where T0 : unmanaged, IResource;
}

/// <summary>
/// Instance of <b>ID3D12GraphicsCommandList5</b><br/>
/// D3D12.h
/// </summary>
unsafe public readonly struct GraphicsCommandList5 : IGraphicsCommandList5 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly GraphicsCommandList5* GetCurrentPointer () => (GraphicsCommandList5*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x55050859, 0x4024, 0x474c, 0x87, 0xf5, 0x64, 0x72, 0xea, 0xee, 0x44, 0xea);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void RSSetShadingRate (ShadingRate baseShadingRate, ShadingRateCombiner* combiners) {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->RSSetShadingRate (ptr, baseShadingRate, combiners);
		return;
	}

	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly void RSSetShadingRateImage<T0> (T0* shadingRateImage) where T0 : unmanaged, IResource {
		var ptr = GetCurrentPointer ();
		((FunctionPointer*) ptr->_pointer)->RSSetShadingRateImage (ptr, shadingRateImage);
		return;
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 77
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, ShadingRate, ShadingRateCombiner*, void> RSSetShadingRate;
		/// <summary>
		/// OFFSET 78
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, void> RSSetShadingRateImage;
	}
