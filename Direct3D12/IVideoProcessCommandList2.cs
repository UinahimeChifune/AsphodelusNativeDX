...
/// <summary>
/// INTERFACE <b>ID3D12VideoProcessCommandList2</b> : ID3D12VideoProcessCommandList1<br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public interface IVideoProcessCommandList2 : IVideoProcessCommandList1 {
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12VideoProcessCommandList2::SetProtectedResourceSession (ID3D12ProtectedResourceSession* pProtectedResourceSession)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12VideoProcessCommandList2::InitializeExtensionCommand (ID3D12VideoExtensionCommand* pExtensionCommand, void* pInitializationParameters, SIZE_T InitializationParametersSizeInBytes)</b><br/>
	/// </summary>
	...
	/// <summary>
	/// STDMETHODCALLTYPE <b>void ID3D12VideoProcessCommandList2::ExecuteExtensionCommand (ID3D12VideoExtensionCommand* pExtensionCommand, void* pExecutionParameters, SIZE_T ExecutionParametersSizeInBytes)</b><br/>
	/// </summary>
	/// <param name="pExtensionCommand">_In_ <b>ID3D12VideoExtensionCommand* pExtensionCommand</b></param>
...
/// <summary>
/// Instance of <b>ID3D12VideoProcessCommandList2</b><br/>
/// D3D12VIDEO.h
/// </summary>
unsafe public readonly struct VideoProcessCommandList2 : IVideoProcessCommandList2 {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly VideoProcessCommandList2* GetCurrentPointer () => (VideoProcessCommandList2*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0xdb525ae4, 0x6ad6, 0x473c, 0xba, 0xa7, 0x59, 0xb2, 0xe3, 0x70, 0x82, 0xe4);
