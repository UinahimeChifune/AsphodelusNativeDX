...
/// <summary>
/// INTERFACE <b>IWICBitmapScaler</b> : IWICBitmapSource<br/>
/// WINCODEC.h
/// </summary>
unsafe public interface IBitmapScaler : IBitmapSource {
	/// <summary>
	/// STDMETHODCALLTYPE <b>HRESULT IWICBitmapScaler::Initialize (IWICBitmapSource* pISource, UINT uiWidth, UINT uiHeight, WICBitmapInterpolationMode mode)</b><br/>
	/// </summary>
	...
	/// <param name="mode"><b>WICBitmapInterpolationMode mode</b></param>
	int Initialize<T0> (T0* pISource, uint uiWidth, uint uiHeight, BitmapInterpolationMode mode) where T0 : unmanaged, IBitmapSource;
}

/// <summary>
/// Instance of <b>IWICBitmapScaler</b><br/>
/// WINCODEC.h
/// </summary>
unsafe public readonly struct BitmapScaler : IBitmapScaler {
//unsafe public readonly struct IBitmapScalerObj : IBitmapScaler {

	readonly void** _pointer;

	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	readonly BitmapScaler* GetCurrentPointer () => (BitmapScaler*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));
	//readonly IBitmapScalerObj* GetCurrentPointer () => (IBitmapScalerObj*) Unsafe.AsPointer (ref Unsafe.AsRef (in this));

	/// <inheritdoc />
	public static Guid GUID { get => _guid; }
	static readonly Guid _guid = new (0x00000302, 0xa8f2, 0x4877, 0xba, 0x0a, 0xfd, 0x2b, 0x66, 0x45, 0xfb, 0x94);
	...
	/// <inheritdoc />
	[MethodImpl (MethodImplOptions.AggressiveInlining)]
	public readonly int Initialize<T0> (T0* pISource, uint uiWidth, uint uiHeight, BitmapInterpolationMode mode) where T0 : unmanaged, IBitmapSource {
		var ptr = GetCurrentPointer ();
		var hr = ((FunctionPointer*) ptr->_pointer)->Initialize (ptr, pISource, uiWidth, uiHeight, mode);
		return hr;
	}
	...
	readonly struct FunctionPointer {
		...
		/// OFFSET 8
		/// </summary>
		public readonly delegate* unmanaged[Stdcall]<void*, void*, uint, uint, BitmapInterpolationMode, int> Initialize;
	}
